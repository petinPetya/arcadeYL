...
from yookassa.domain.request import (
...
class PersonalData:
    ...
    def create(cls, params, idempotency_key=None):
        ...
        elif isinstance(params, SbpPayoutRecipientPersonalDataRequest) or isinstance(
            params, PayoutStatementRecipientPersonalDataRequest
        ):
        ...
        response = instance.client.request(
            HttpVerb.POST, path, None, headers, params_object
        )
        return PersonalDataResponse(response)
