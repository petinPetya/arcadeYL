...
class ReceiverBankAccount(Receiver):
    ...
    def account_number(self, value):
        ...
        if value is not None and len(value) > 20:
            raise ValueError(
                "Invalid value for `account_number`, length must be less than or equal to `20`"
            )  # noqa: E501
        if value is not None and not re.search(r"^\d{20}$", value):  # noqa: E501
            raise ValueError(
                r"Invalid value for `account_number`, must be a follow pattern or equal to `/\d{20}/`"
            )  # noqa: E501
    ...
    def bic(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `bic`, must not be `None`"
            )  # noqa: E501
        if value is not None and len(value) > 9:
            raise ValueError(
                "Invalid value for `bic`, length must be less than or equal to `9`"
            )  # noqa: E501
        if value is not None and not re.search(r"^\d{9}$", value):  # noqa: E501
            raise ValueError(
                r"Invalid value for `bic`, must be a follow pattern or equal to `/\d{9}/`"
            )  # noqa: E501
        self.__bic = value
