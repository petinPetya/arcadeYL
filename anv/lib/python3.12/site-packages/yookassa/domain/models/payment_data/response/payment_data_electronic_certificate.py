...
from yookassa.domain.models.payment_data.electronic_certificate.electronic_certificate import (
            ...
            for articlesData in value:
                if isinstance(articlesData, dict):
                    articles_array.append(
                        ElectronicCertificateApprovedPaymentArticle(articlesData)
                    )
                elif isinstance(
                    articlesData, ElectronicCertificateApprovedPaymentArticle
                ):
                    articles_array.append(articlesData)
                else:
                    raise TypeError(
                        "Invalid articles data type in PaymentDataElectronicCertificate.articles"
                    )
