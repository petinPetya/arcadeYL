...
from yookassa.domain.models.payment_data.statement.delivery_method.delivery_method import (
    DeliveryMethod,
)
from yookassa.domain.models.payment_data.statement.delivery_method.delivery_method_factory import (
...
class StatementPaymentOverview(Statement):
    ...
    def delivery_method(self, value):
        ...
        if isinstance(value, dict):
            self.__delivery_method = DeliveryMethodFactory().create(
                value, self.context()
            )
            ...
            raise TypeError(
                "Invalid delivery_method data type in StatementPaymentOverview.delivery_method"
            )
