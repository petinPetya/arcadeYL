        ...
        if isinstance(value, list):
            ...
            for certificatesData in value:
                if isinstance(certificatesData, dict):
                    ...
                    raise TypeError(
                        "Invalid certificates data type in ElectronicCertificateApprovedPaymentArticle.certificates"
                    )

            self.__certificates = certificates_array
        else:
            raise TypeError(
                "Invalid certificates value type in ElectronicCertificateApprovedPaymentArticle"
            )
