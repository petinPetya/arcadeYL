...
class PaymentDataElectronicCertificate(PaymentDataBankCard):
    ...
    def electronic_certificate(self, value):
        ...
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid electronic_certificate data type in PaymentMethodDataElectronicCertificate.electronic_certificate"
            )
        ...
        if isinstance(value, list):
            ...
            for articlesData in value:
                if isinstance(articlesData, dict):
                    ...
                    raise TypeError(
                        "Invalid articles data type in PaymentMethodDataElectronicCertificate.articles"
                    )

            self.__articles = articles_array
        else:
            raise TypeError(
                "Invalid articles value type in PaymentMethodDataElectronicCertificate"
            )
