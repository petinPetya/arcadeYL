...
class ElectronicCertificate(BaseObject):
    ...
    def certificate_id(self, value):
        ...
        if value is not None and len(value) > 30:
            raise ValueError(
                "Invalid value for `certificate_id`, length must be less than or equal to `30`"
            )  # noqa: E501
        if value is not None and len(value) < 20:
            raise ValueError(
                "Invalid value for `certificate_id`, length must be greater than or equal to `20`"
            )  # noqa: E501
    ...
    def tru_quantity(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `tru_quantity`, must not be `None`"
            )  # noqa: E501
    ...
    def available_compensation(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `available_compensation`, must not be `None`"
            )  # noqa: E501
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid available_compensation data type in ElectronicCertificate.available_compensation"
            )
    ...
    def applied_compensation(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `applied_compensation`, must not be `None`"
            )  # noqa: E501
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid applied_compensation data type in ElectronicCertificate.applied_compensation"
            )
