...
from yookassa.domain.models.payment_data.payment_order.payment_order_recipient_utilities import (
    PaymentOrderRecipientUtilities,
)
from yookassa.domain.models.payment_data.payment_order.payment_order_type import (
    PaymentOrderType,
)
from yookassa.domain.models.payment_data.payment_order.payment_period import (
    PaymentPeriod,
)
...
class PaymentOrderUtilities(PaymentOrder):
    ...
    def recipient(self, value):
        ...
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid recipient data type in PaymentOrderUtilities.recipient"
            )
    ...
    def kbk(self, value):
        ...
        if value is not None and len(value) > 20:
            raise ValueError(
                "Invalid value for `kbk`, length must be less than or equal to `20`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `kbk`, length must be greater than or equal to `1`"
            )  # noqa: E501
        if value is not None and not re.search(r"^(\d{20})|(0)$", value):  # noqa: E501
            raise ValueError(
                r"Invalid value for `kbk`, must be a follow pattern or equal to `/(\d{20})|(0)/`"
            )  # noqa: E501
        self.__kbk = value
    ...
    def oktmo(self, value):
        ...
        if value is not None and len(value) > 8:
            raise ValueError(
                "Invalid value for `oktmo`, length must be less than or equal to `8`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `oktmo`, length must be greater than or equal to `1`"
            )  # noqa: E501
        if value is not None and not re.search(r"^(\d{8})|(0)$", value):  # noqa: E501
            raise ValueError(
                r"Invalid value for `oktmo`, must be a follow pattern or equal to `/(\d{8})|(0)/`"
            )  # noqa: E501
        self.__oktmo = value
    ...
    def payment_period(self, value):
        ...
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid payment_period data type in PaymentOrderUtilities.payment_period"
            )
    ...
    def payment_document_id(self, value):
        ...
        if value is not None and len(value) > 18:
            raise ValueError(
                "Invalid value for `payment_document_id`, length must be less than or equal to `18`"
            )  # noqa: E501
        if value is not None and len(value) < 18:
            raise ValueError(
                "Invalid value for `payment_document_id`, length must be greater than or equal to `18`"
            )  # noqa: E501
    ...
    def payment_document_number(self, value):
        ...
        if value is not None and len(value) > 30:
            raise ValueError(
                "Invalid value for `payment_document_number`, length must be less than or equal to `30`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `payment_document_number`, length must be greater than or equal to `1`"
            )  # noqa: E501
        if value is not None and not re.search(
            r"^(.*)([0-9а-яА-Яa-zA-Z]+)(.*)$", value
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `payment_document_number`, must be a follow pattern or equal to `/(.*)([0-9а-яА-Яa-zA-Z]+)(.*)/`"
            )  # noqa: E501
    ...
    def account_number(self, value):
        ...
        if value is not None and len(value) > 30:
            raise ValueError(
                "Invalid value for `account_number`, length must be less than or equal to `30`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `account_number`, length must be greater than or equal to `1`"
            )  # noqa: E501
        if value is not None and not re.search(
            r"^(.*)([0-9а-яА-Яa-zA-Z]+)(.*)$", value
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `account_number`, must be a follow pattern or equal to `/(.*)([0-9а-яА-Яa-zA-Z]+)(.*)/`"
            )  # noqa: E501
    ...
    def unified_account_number(self, value):
        ...
        if value is not None and len(value) > 10:
            raise ValueError(
                "Invalid value for `unified_account_number`, length must be less than or equal to `10`"
            )  # noqa: E501
        if value is not None and len(value) < 10:
            raise ValueError(
                "Invalid value for `unified_account_number`, length must be greater than or equal to `10`"
            )  # noqa: E501
    ...
    def service_id(self, value):
        ...
        if value is not None and len(value) > 13:
            raise ValueError(
                "Invalid value for `service_id`, length must be less than or equal to `13`"
            )  # noqa: E501
        if value is not None and len(value) < 13:
            raise ValueError(
                "Invalid value for `service_id`, length must be greater than or equal to `13`"
            )  # noqa: E501
