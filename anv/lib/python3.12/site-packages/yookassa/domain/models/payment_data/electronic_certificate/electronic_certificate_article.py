...
class ElectronicCertificateArticle(BaseObject):
    ...
    def article_number(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `article_number`, must not be `None`"
            )  # noqa: E501
        if value is not None and value > 999:  # noqa: E501
            raise ValueError(
                "Invalid value for `article_number`, must be a value less than or equal to `999`"
            )  # noqa: E501
        if value is not None and value < 1:  # noqa: E501
            raise ValueError(
                "Invalid value for `article_number`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def tru_code(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `tru_code`, must not be `None`"
            )  # noqa: E501
        if value is not None and len(value) > 30:
            raise ValueError(
                "Invalid value for `tru_code`, length must be less than or equal to `30`"
            )  # noqa: E501
        if value is not None and len(value) < 30:
            raise ValueError(
                "Invalid value for `tru_code`, length must be greater than or equal to `30`"
            )  # noqa: E501
    ...
    def article_code(self, value):
        ...
        if value is not None and len(value) > 128:
            raise ValueError(
                "Invalid value for `article_code`, length must be less than or equal to `128`"
            )  # noqa: E501
    ...
    def article_name(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `article_name`, must not be `None`"
            )  # noqa: E501
        if value is not None and len(value) > 128:
            raise ValueError(
                "Invalid value for `article_name`, length must be less than or equal to `128`"
            )  # noqa: E501
    ...
    def price(self, value):
        ...
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid price data type in ElectronicCertificateArticle.price"
            )
