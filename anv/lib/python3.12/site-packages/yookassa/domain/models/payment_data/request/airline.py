...
class Airline(BaseObject):
    ...
    def passengers(self, value):
        ...
        if isinstance(value, list):
            if len(value) > 500:
                raise ValueError(
                    "Invalid value for `passengers`, number of items must be less than or equal to `500`"
                )  # noqa: E501
            ...
            for passengerData in value:
                if isinstance(passengerData, dict):
                    ...
                    raise TypeError(
                        "Invalid passengers data type in airline.passengers"
                    )
    ...
    def legs(self, value):
        ...
        if isinstance(value, list):
            if len(value) > 4:
                raise ValueError(
                    "Invalid value for `legs`, number of items must be less than or equal to `4`"
                )  # noqa: E501
