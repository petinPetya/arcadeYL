...
from yookassa.domain.models.payment_data.request.merchant_customer_bank_account import (
    MerchantCustomerBankAccount,
)
...
class FraudData(BaseObject):
    ...
    def topped_up_phone(self, value):
        ...
        if value is not None and not re.search(r"^[0-9]{4,15}$", value):  # noqa: E501
            raise ValueError(
                r"Invalid value for `topped_up_phone`, must be a follow pattern or equal to `/[0-9]{4,15}/`"
            )  # noqa: E501
    ...
    def merchant_customer_bank_account(self, value):
        ...
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid merchant_customer_bank_account data type in FraudData.merchant_customer_bank_account"
            )  # noqa: E501
