...
from yookassa.domain.models.payment_data.payment_order.payment_order_recipient_bank_utilities import (
    PaymentOrderRecipientBankUtilities,
)
...
class PaymentOrderRecipientUtilities(BaseObject):
    ...
    def inn(self, value):
        ...
        if value is not None and not re.search(r"^[0-9]{10}$", value):  # noqa: E501
            raise ValueError(
                r"Invalid value for `inn`, must be a follow pattern or equal to `/[0-9]{10}/`"
            )  # noqa: E501
        self.__inn = value
    ...
    def kpp(self, value):
        ...
        if value is not None and not re.search(r"^[0-9]{9}$", value):  # noqa: E501
            raise ValueError(
                r"Invalid value for `kpp`, must be a follow pattern or equal to `/[0-9]{9}/`"
            )  # noqa: E501
        self.__kpp = value
