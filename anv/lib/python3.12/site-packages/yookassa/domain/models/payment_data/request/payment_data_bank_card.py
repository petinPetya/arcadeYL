...
class PaymentDataBankCard(PaymentData):
    ...
    def card(self):
        """
        Возвращает card модели PaymentDataBankCard.

        :return: card модели PaymentDataBankCard.
        :rtype: CreditCard
        """
        return self.__card
    ...
    def card(self, value):
        """
        Устанавливает card модели PaymentDataBankCard.

        :param value: card модели PaymentDataBankCard.
