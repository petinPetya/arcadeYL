...
from yookassa.domain.models.cancellation_details import (
    CancellationDetails,
    CancellationDetailsPartyCode,
    CancellationDetailsReasonCode,
    PayoutCancellationDetailsReasonCode,
    RefundCancellationDetailsReasonCode,
)
...
from yookassa.domain.models.payment_data.response.authorization_details import (
...
from yookassa.domain.models.settlement import (
    Settlement,
    SettlementType,
    SettlementPayoutType,
)
from yookassa.domain.models.transfer import Transfer
from yookassa.domain.models.deal import (
    DealStatus,
    DealType,
    FeeMoment,
    PaymentDealInfo,
