...
class MarkQuantity(BaseObject):
    ...
    def numerator(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `numerator`, must not be `None`"
            )  # noqa: E501
        if value is not None and value < 1:  # noqa: E501
            raise ValueError(
                "Invalid value for `numerator`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def denominator(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `denominator`, must not be `None`"
            )  # noqa: E501
        if value is not None and value < 1:  # noqa: E501
            raise ValueError(
                "Invalid value for `denominator`, must be a value greater than or equal to `1`"
            )  # noqa: E501
