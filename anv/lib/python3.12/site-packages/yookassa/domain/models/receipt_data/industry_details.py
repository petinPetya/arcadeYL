...
class IndustryDetails(BaseObject):
    ...
    def federal_id(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `federal_id`, must not be `None`"
            )  # noqa: E501
        if value is not None and not re.search(
            r"(^00[1-9]{1}$)|(^0[1-6]{1}[0-9]{1}$)|(^07[0-3]{1}$)", value
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `federal_id`, must be a follow pattern or equal to `/(^00[1-9]{1}$)|(^0[1-6]{1}[0-9]{1}$)|(^07[0-3]{1}$)/`"
            )  # noqa: E501
    ...
    def document_date(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `document_date`, must not be `None`"
            )  # noqa: E501
    ...
    def document_number(self, value):
        ...
        if value is None:  # noqa: E501
            raise ValueError(
                "Invalid value for `document_number`, must not be `None`"
            )  # noqa: E501
        if value is not None and len(value) > 32:
            raise ValueError(
                "Invalid value for `document_number`, length must be less than or equal to `32`"
            )  # noqa: E501
    ...
    def value(self, value):
        ...
        if value is not None and len(value) > 256:
            raise ValueError(
                "Invalid value for `value`, length must be less than or equal to `256`"
            )  # noqa: E501
        self.__value = value
