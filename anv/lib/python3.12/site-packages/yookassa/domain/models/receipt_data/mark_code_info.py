...
class MarkCodeInfo(BaseObject):
    ...
    def unknown(self, value):
        ...
        if value is not None and len(value) > 32:
            raise ValueError(
                "Invalid value for `unknown`, length must be less than or equal to `32`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `unknown`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def ean_8(self, value):
        ...
        if value is not None and len(value) > 8:
            raise ValueError(
                "Invalid value for `ean_8`, length must be less than or equal to `8`"
            )  # noqa: E501
        if value is not None and len(value) < 8:
            raise ValueError(
                "Invalid value for `ean_8`, length must be greater than or equal to `8`"
            )  # noqa: E501
        self.__ean_8 = value
    ...
    def ean_13(self, value):
        ...
        if value is not None and len(value) > 13:
            raise ValueError(
                "Invalid value for `ean_13`, length must be less than or equal to `13`"
            )  # noqa: E501
        if value is not None and len(value) < 13:
            raise ValueError(
                "Invalid value for `ean_13`, length must be greater than or equal to `13`"
            )  # noqa: E501
        self.__ean_13 = value
    ...
    def itf_14(self, value):
        ...
        if value is not None and len(value) > 14:
            raise ValueError(
                "Invalid value for `itf_14`, length must be less than or equal to `14`"
            )  # noqa: E501
        if value is not None and len(value) < 14:
            raise ValueError(
                "Invalid value for `itf_14`, length must be greater than or equal to `14`"
            )  # noqa: E501
        self.__itf_14 = value
    ...
    def gs_10(self, value):
        ...
        if value is not None and len(value) > 38:
            raise ValueError(
                "Invalid value for `gs_10`, length must be less than or equal to `38`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `gs_10`, length must be greater than or equal to `1`"
            )  # noqa: E501
        self.__gs_10 = value
    ...
    def gs_1m(self, value):
        ...
        if value is not None and len(value) > 200:
            raise ValueError(
                "Invalid value for `gs_1m`, length must be less than or equal to `200`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `gs_1m`, length must be greater than or equal to `1`"
            )  # noqa: E501
        self.__gs_1m = value
    ...
    def short(self, value):
        ...
        if value is not None and len(value) > 38:
            raise ValueError(
                "Invalid value for `short`, length must be less than or equal to `38`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `short`, length must be greater than or equal to `1`"
            )  # noqa: E501
        self.__short = value
    ...
    def fur(self, value):
        ...
        if value is not None and len(value) > 20:
            raise ValueError(
                "Invalid value for `fur`, length must be less than or equal to `20`"
            )  # noqa: E501
        if value is not None and len(value) < 20:
            raise ValueError(
                "Invalid value for `fur`, length must be greater than or equal to `20`"
            )  # noqa: E501
        self.__fur = value
    ...
    def egais_20(self, value):
        ...
        if value is not None and len(value) > 33:
            raise ValueError(
                "Invalid value for `egais_20`, length must be less than or equal to `33`"
            )  # noqa: E501
        if value is not None and len(value) < 33:
            raise ValueError(
                "Invalid value for `egais_20`, length must be greater than or equal to `33`"
            )  # noqa: E501
    ...
    def egais_30(self, value):
        ...
        if value is not None and len(value) > 14:
            raise ValueError(
                "Invalid value for `egais_30`, length must be less than or equal to `14`"
            )  # noqa: E501
        if value is not None and len(value) < 14:
            raise ValueError(
                "Invalid value for `egais_30`, length must be greater than or equal to `14`"
            )  # noqa: E501
