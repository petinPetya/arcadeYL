...
class Receipt(BaseObject):
        ...
        if isinstance(value, list):
            ...
            for item in value:
                if isinstance(item, dict):
                    ...
                    raise TypeError(
                        "Invalid receipt_industry_details data type in ReceiptData.receipt_industry_details"
                    )
            self.__receipt_industry_details = items
        else:
            raise TypeError(
                "Invalid receipt_industry_details value type in ReceiptData"
            )
    ...
    def receipt_operational_details(self, value):
        ...
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid receipt_operational_details data type in ReceiptData.receipt_operational_details"
            )
