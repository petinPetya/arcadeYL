...
from yookassa.domain.models.confirmation.request.confirmation_request import (
    ConfirmationRequest,
)
from yookassa.domain.models.payment_data.request.credit_card import CreditCard
from yookassa.domain.models.payment_method.payment_method_confirmation_factory import (
    PaymentMethodConfirmationFactory,
)
from yookassa.domain.models.payment_method.request.payment_method_holder import (
    PaymentMethodHolder,
)
...
class PaymentMethodRequest(RequestObject):
    ...
    def confirmation(self, value):
        ...
        """
        if isinstance(value, dict):
            self.__confirmation = PaymentMethodConfirmationFactory().create(
                value, self.context()
            )
            ...
            raise TypeError(
                "Invalid confirmation data type in PaymentMethodRequest.confirmation"
            )
