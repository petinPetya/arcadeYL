...
class PayoutStatementRecipientPersonalDataRequest(RequestObject):
    ...
    def last_name(self, value):
        ...
        if value is not None and len(value) > 200:
            raise ValueError(
                "Invalid value for `last_name`, length must be less than or equal to `200`"
            )  # noqa: E501
        ...
        if value is not None and not re.search(
            r"^[—–‐\-a-zA-Zа-яёА-ЯЁ ]*$", value
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `last_name`, must be a follow pattern or equal to `/^[—–‐\-a-zA-Zа-яёА-ЯЁ ]*$/`"
            )  # noqa: E501
    ...
    def first_name(self, value):
        ...
        if value is not None and not re.search(
            ...
            raise ValueError(
                r"Invalid value for `first_name`, must be a follow pattern or equal to `/^[—–‐\-a-zA-Zа-яёА-ЯЁ ]*$/`"
            )  # noqa: E501
    ...
    def middle_name(self, value):
        ...
        if value is not None and len(value) > 200:
            raise ValueError(
                "Invalid value for `middle_name`, length must be less than or equal to `200`"
            )  # noqa: E501
        if value is not None and len(value) < 1:
            raise ValueError(
                "Invalid value for `middle_name`, length must be greater than or equal to `1`"
            )  # noqa: E501
        if value is not None and not re.search(
            r"^[—–‐\-a-zA-Zа-яёА-ЯЁ ]*$", value
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `middle_name`, must be a follow pattern or equal to `/^[—–‐\-a-zA-Zа-яёА-ЯЁ ]*$/`"
            )  # noqa: E501
    ...
    def validate(self):
        ...
        if (
            ...
            self.__set_validation_error(
                "Type, last_name, first_name and birthdate values cannot be empty in PayoutStatementRecipientPersonalDataRequest"
            )  # noqa: E501
...
class SbpPayoutRecipientPersonalDataRequest(RequestObject):
    ...
    def validate(self):
        ...
        if self.type is None or self.last_name is None or self.first_name is None:
            self.__set_validation_error(
                "Type, last_name and first_name values cannot be empty in SbpPayoutRecipientPersonalDataRequest"
            )  # noqa: E501
