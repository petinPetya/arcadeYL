...
from yookassa.domain.models.receipt_data.receipt_item_supplier import (
    ReceiptItemSupplier,
)
...
class ReceiptItemRequest(BaseObject):
    ...
    def mark_quantity(self, value):
        ...
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid mark_quantity data type in ReceiptItemRequest.mark_quantity"
            )
    ...
    def planned_status(self, value):
        ...
        if value is not None and value > 6:  # noqa: E501
            raise ValueError(
                "Invalid value for `planned_status`, must be a value less than or equal to `6`"
            )  # noqa: E501
        if value is not None and value < 1:  # noqa: E501
            raise ValueError(
                "Invalid value for `planned_status`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def mark_code_info(self, value):
        ...
        if isinstance(value, dict):
            ...
            raise TypeError(
                "Invalid mark_code_info data type in ReceiptItemRequest.mark_code_info"
            )
    ...
    def mark_mode(self, value):
        ...
        if value is not None and not re.search(r"^[0]{1}$", value):  # noqa: E501
            raise ValueError(
                r"Invalid value for `mark_mode`, must be a follow pattern or equal to `/^[0]{1}$/`"
            )  # noqa: E501
        ...
        if isinstance(value, list):
            ...
            for item in value:
                if isinstance(item, dict):
                    ...
                    raise TypeError(
                        "Invalid payment_subject_industry_details data type in ReceiptItemRequest.payment_subject_industry_details"
                    )
            self.__payment_subject_industry_details = items
        else:
            raise TypeError(
                "Invalid payment_subject_industry_details value type in ReceiptItem"
            )
    ...
    def additional_payment_subject_props(self, value):
        ...
        if value is not None and len(value) > 64:
            raise ValueError(
                "Invalid value for `additional_payment_subject_props`, length must be less than or equal to `64`"
            )  # noqa: E501
