...
from yookassa.domain.request.personal_data_request import (
...
from yookassa.domain.request.self_employed_request_builder import (
    SelfEmployedRequestBuilder,
)
from yookassa.domain.request.payment_method_request import PaymentMethodRequest
from yookassa.domain.request.payment_method_request_builder import (
