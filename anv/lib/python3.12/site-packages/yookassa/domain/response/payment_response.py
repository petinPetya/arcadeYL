...
from yookassa.domain.models import (
    Amount,
...
from yookassa.domain.models.payment_data.payment_data_class_map import (
    PaymentDataClassMap,
)
from yookassa.domain.models.payment_data.payment_data_factory import PaymentDataFactory
from yookassa.domain.models.payment_data.payment_invoice_details import (
...
class PaymentResponse(ResponseObject):
    ...
    def payment_method(self, value):
        ...
        if (
            ...
            and "type" in value
            and value["type"] not in PaymentDataClassMap().response
        ):
