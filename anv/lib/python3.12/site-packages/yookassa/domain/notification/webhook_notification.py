    ...
    def create(self, data):
        ...
        if isinstance(data, dict):
            if "type" in data and "event" in data:
                ...
                raise ValueError(
                    'Parameter "data" should contain "type" and "event" fields'
                )
        else:
    ...
    def __get_class_object(data):
        ...
        if data["type"] == WebhookNotificationType.NOTIFICATION:
            if data["event"] == WebhookNotificationEventType.REFUND_SUCCEEDED:
                ...
                data["event"] == WebhookNotificationEventType.PAYOUT_SUCCEEDED
                or data["event"] == WebhookNotificationEventType.PAYOUT_CANCELED
            ):
