...
class Deal:
    ...
    def find_one(cls, deal_id):
        ...
        :return: DealResponse Объект ответа, возвращаемого API при запросе сделки
        """
        instance = cls()
    ...
    def list(cls, params=None):
        ...
        :param params: Данные передаваемые в API
        :return: DealListResponse Объект ответа, возвращаемого API при запросе списка сделок
        """
        if params is None:
            params = {}
        instance = cls()
