...
def main():
    ...
    parser_info = subparsers.add_parser(
        "info", help="Display information about an IP network"
    )
    ...
    try:
        ...
        def shell(namespace, banner, exit_msg):
            InteractiveShellEmbed(
                banner1=banner, exit_msg=exit_msg, user_ns=SHELL_NAMESPACE
            )()

    except ImportError:
        notice = (
            "Using built-in Python REPL. You can install IPython for better experience."
        )
        print()
        import code
