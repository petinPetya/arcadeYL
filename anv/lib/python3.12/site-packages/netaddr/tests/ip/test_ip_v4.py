...
def test_ipaddress_binary_operations_v4():
    assert IPAddress("192.0.2.15") & IPAddress("255.255.255.0") == IPAddress(
        "192.0.2.0"
    )
    assert IPAddress("255.255.0.0") | IPAddress("0.0.255.255") == IPAddress(
        "255.255.255.255"
    )
...
def test_ipaddress_constructor_zero_filled_octets_v4():
    ...
    assert IPAddress("010.000.000.001", flags=INET_ATON | ZEROFILL) == IPAddress(
        "10.0.0.1"
    )
    ...
    assert IPAddress("010.000.000.001", flags=INET_PTON | ZEROFILL) == IPAddress(
        "10.0.0.1"
    )
...
def test_ipnetwork_nohost():
    assert IPNetwork(IPNetwork("192.168.0.1/24"), flags=NOHOST).ip == IPAddress(
        "192.168.0.0"
    )
