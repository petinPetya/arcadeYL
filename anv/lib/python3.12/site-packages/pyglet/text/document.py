...
class AbstractDocument(event.EventDispatcher):
    ...
    def get_paragraph_start(self, pos: int) -> int:
        ...
        m: re.Match[str] | None = self._previous_paragraph_re.search(
            self._text, 0, pos + 1
        )
        if not m:
            return 0
    ...
    def insert_text(
        self, start: int, text: str, attributes: dict[str, Any] | None = None
    ) -> None:  # noqa: D417
    ...
    def _insert_text(
        self, start: int, text: str, attributes: dict[str, Any] | None
    ) -> None:  # noqa: ARG002
    ...
    def set_style(
        self, start: int, end: int, attributes: dict[str, Any]
    ) -> None:  # noqa: D417
    ...
    if _is_pyglet_doc_run:
        ...
        def on_style_text(
            self, start: int, end: int, attributes: dict[str, Any] | None
        ) -> None:  # noqa: D417
...
class UnformattedDocument(AbstractDocument):
    ...
    def get_style(
        self, attribute: str, position: int | None = None
    ) -> Any:  # noqa: ARG002
    ...
    def get_font(
        self, position: int | None = None, dpi: int | None = None
    ) -> Font:  # noqa: ARG002
        ...
        return font.load(
            font_name, font_size, weight=weight, italic=italic, stretch=stretch, dpi=dpi
        )
...
class FormattedDocument(AbstractDocument):
    ...
    def get_style_runs(
        self, attribute: str
    ) -> runlist.RunIterator | _NoStyleRangeIterator:
        try:
...
def _iter_elements(
    elements: list[InlineElement], length: int
) -> Generator[tuple[int, int, InlineElement | None], None, None]:
    last = 0
...
class _FontStyleRunsRangeIterator(runlist.RunIterator):
    ...
    def __init__(
        ...
        font_sizes: runlist.RunIterator,
        weights: runlist.RunIterator,
        italics: runlist.RunIterator,
        stretch: runlist.RunIterator,
        dpi: int | None,
    ) -> None:
        self.zip_iter = runlist.ZipRunIterator(
            (font_names, font_sizes, weights, italics, stretch)
        )
        self.dpi = dpi

    def ranges(
        self, start: int, end: int
    ) -> Generator[tuple[int, int, Font], None, None]:
        from pyglet import font
