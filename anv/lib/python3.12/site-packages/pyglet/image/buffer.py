...
class Renderbuffer:
    ...
    def __init__(
        self, width: int, height: int, internal_format: int, samples: int = 1
    ) -> None:
...
class Framebuffer:
    ...
    def get_status() -> str:
        ...
        """
        states = {
            GL_FRAMEBUFFER_UNSUPPORTED: "Framebuffer unsupported. Try another format.",
