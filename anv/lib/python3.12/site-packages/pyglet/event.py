...
class EventDispatcher:
            ...
            if inspect.isroutine(obj):
                ...
                for name in dir(obj):
                    if name in self.event_types:
                        ...
                        yield name, WeakMethod(
                            meth, partial(self._remove_handler, name)
                        )
    ...
    def dispatch_event(self, event_type: str, *args: Any) -> bool | None:
        ...
        try:
            ...
            self._raise_dispatch_exception(
                event_type, args, getattr(self, event_type), exception
            )
        else:
            invoked = True
    ...
    def _raise_dispatch_exception(
        self, event_type: str, args: Any, handler: Callable, exception: Exception
    ) -> None:
        ...
        if handler_defaults and n_handler_args > n_args >= n_handler_args - len(
            handler_defaults
        ):
        ...
        if n_handler_args != n_args:
            ...
            msg = (
                f"The '{caller_name}' event was dispatched with {n_args} arguments:  {list(args)},\n"
