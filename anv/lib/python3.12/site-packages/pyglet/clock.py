...
class Clock:
    ...
    def schedule_once(
        self, func: Callable, delay: float, *args: Any, **kwargs: Any
    ) -> None:
    ...
    def schedule_interval(
        self, func: Callable, interval: float, *args: Any, **kwargs: Any
    ) -> None:
    ...
    def schedule_interval_for_duration(
        self,
        func: Callable,
        interval: float,
        duration: float,
...
def schedule_interval(
    func: Callable, interval: float, *args: Any, **kwargs: Any
) -> None:
...
def schedule_interval_for_duration(
    func: Callable, interval: float, duration: float, *args, **kwargs
) -> None:
