...
# GL/glxext.h:406
glXGetRefreshRateSGI = _link_function(
    "glXGetRefreshRateSGI", c_int, [POINTER(c_uint)], "SGI_video_sync"
)
...
# GL/glxext.h:670
glXAllocateMemoryNV = _link_function(
    "glXAllocateMemoryNV",
    POINTER(c_void),
...
glXReleaseVideoImageNV = _link_function(
    "glXReleaseVideoImageNV", c_int, [POINTER(Display), GLXPbuffer], "NV_video_out"
)
...
# GL/glxext.h:784
glXReleaseTextImageEXT = _link_function(
