...
# GL/glxext.h:594
glXCreateContextAttribsARB = _link_function(
    "glXCreateContextAttribsARB",
    GLXContext,
    [POINTER(Display), GLXFBConfig, GLXContext, c_int, POINTER(c_int)],
    "ARB_create_context",
)

PFNGLXCREATECONTEXTATTRIBSARBPROC = CFUNCTYPE(
    GLXContext, POINTER(Display), GLXFBConfig, GLXContext, c_int, POINTER(c_int)
)  # GL/glxext.h:596
...
PFNGLXWAITVIDEOSYNCSGIPROC = CFUNCTYPE(
    c_int, c_int, c_int, POINTER(c_uint)
)  # GL/glxext.h:630
# SGI_make_current_read (GL/glxext.h:633)
GLX_SGI_make_current_read = 1  # GL/glxext.h:634
# GL/glxext.h:636
glXMakeCurrentReadSGI = _link_function(
    "glXMakeCurrentReadSGI",
    c_int,
    [POINTER(Display), GLXDrawable, GLXDrawable, GLXContext],
    "SGI_make_current_read",
)

# GL/glxext.h:637
glXGetCurrentReadDrawableSGI = _link_function(
    "glXGetCurrentReadDrawableSGI", GLXDrawable, [], "SGI_make_current_read"
)

PFNGLXMAKECURRENTREADSGIPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable, GLXDrawable, GLXContext
)  # GL/glxext.h:639
...
glXGetCurrentDisplayEXT = _link_function(
    "glXGetCurrentDisplayEXT", POINTER(Display), [], "EXT_import_context"
)

# GL/glxext.h:663
glXQueryContextInfoEXT = _link_function(
    "glXQueryContextInfoEXT",
    c_int,
    [POINTER(Display), GLXContext, c_int, POINTER(c_int)],
    "EXT_import_context",
)
...
# GL/glxext.h:665
glXImportContextEXT = _link_function(
    "glXImportContextEXT",
    GLXContext,
    [POINTER(Display), GLXContextID],
    "EXT_import_context",
)
...
PFNGLXQUERYCONTEXTINFOEXTPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXContext, c_int, POINTER(c_int)
)  # GL/glxext.h:669
PFNGLXGETCONTEXTIDEXTPROC = CFUNCTYPE(GLXContextID, GLXContext)  # GL/glxext.h:670
PFNGLXIMPORTCONTEXTEXTPROC = CFUNCTYPE(
    GLXContext, POINTER(Display), GLXContextID
)  # GL/glxext.h:671
PFNGLXFREECONTEXTEXTPROC = CFUNCTYPE(
    None, POINTER(Display), GLXContext
)  # GL/glxext.h:672
# SGIX_fbconfig (GL/glxext.h:675)
GLX_SGIX_fbconfig = 1  # GL/glxext.h:676
# GL/glxext.h:678
glXGetFBConfigAttribSGIX = _link_function(
    "glXGetFBConfigAttribSGIX",
    c_int,
    [POINTER(Display), GLXFBConfigSGIX, c_int, POINTER(c_int)],
    "SGIX_fbconfig",
)

# GL/glxext.h:679
glXChooseFBConfigSGIX = _link_function(
    "glXChooseFBConfigSGIX",
    POINTER(GLXFBConfigSGIX),
...
# GL/glxext.h:680
glXCreateGLXPixmapWithConfigSGIX = _link_function(
    "glXCreateGLXPixmapWithConfigSGIX",
    GLXPixmap,
    [POINTER(Display), GLXFBConfigSGIX, Pixmap],
    "SGIX_fbconfig",
)

# GL/glxext.h:681
glXCreateContextWithConfigSGIX = _link_function(
    "glXCreateContextWithConfigSGIX",
    GLXContext,
    [POINTER(Display), GLXFBConfigSGIX, c_int, GLXContext, c_int],
    "SGIX_fbconfig",
)

XVisualInfo = pyglet.libs.x11.xlib.XVisualInfo
# GL/glxext.h:682
glXGetVisualFromFBConfigSGIX = _link_function(
    "glXGetVisualFromFBConfigSGIX",
    POINTER(XVisualInfo),
    [POINTER(Display), GLXFBConfigSGIX],
    "SGIX_fbconfig",
)

# GL/glxext.h:683
glXGetFBConfigFromVisualSGIX = _link_function(
...
PFNGLXGETFBCONFIGATTRIBSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXFBConfigSGIX, c_int, POINTER(c_int)
)  # GL/glxext.h:685
PFNGLXCHOOSEFBCONFIGSGIXPROC = CFUNCTYPE(
    POINTER(GLXFBConfigSGIX), POINTER(Display), c_int, POINTER(c_int), POINTER(c_int)
)  # GL/glxext.h:686
PFNGLXCREATEGLXPIXMAPWITHCONFIGSGIXPROC = CFUNCTYPE(
    GLXPixmap, POINTER(Display), GLXFBConfigSGIX, Pixmap
)  # GL/glxext.h:687
PFNGLXCREATECONTEXTWITHCONFIGSGIXPROC = CFUNCTYPE(
    GLXContext, POINTER(Display), GLXFBConfigSGIX, c_int, GLXContext, c_int
)  # GL/glxext.h:688
PFNGLXGETVISUALFROMFBCONFIGSGIXPROC = CFUNCTYPE(
    POINTER(XVisualInfo), POINTER(Display), GLXFBConfigSGIX
)  # GL/glxext.h:689
PFNGLXGETFBCONFIGFROMVISUALSGIXPROC = CFUNCTYPE(
    GLXFBConfigSGIX, POINTER(Display), POINTER(XVisualInfo)
)  # GL/glxext.h:690
# SGIX_pbuffer (GL/glxext.h:693)
GLX_SGIX_pbuffer = 1  # GL/glxext.h:694
# GL/glxext.h:696
glXCreateGLXPbufferSGIX = _link_function(
    "glXCreateGLXPbufferSGIX",
    GLXPbufferSGIX,
    [POINTER(Display), GLXFBConfigSGIX, c_uint, c_uint, POINTER(c_int)],
    "SGIX_pbuffer",
)
...
# GL/glxext.h:698
glXQueryGLXPbufferSGIX = _link_function(
    "glXQueryGLXPbufferSGIX",
    c_int,
    [POINTER(Display), GLXPbufferSGIX, c_int, POINTER(c_uint)],
    "SGIX_pbuffer",
)
...
# GL/glxext.h:700
glXGetSelectedEventSGIX = _link_function(
    "glXGetSelectedEventSGIX",
    None,
    [POINTER(Display), GLXDrawable, POINTER(c_ulong)],
    "SGIX_pbuffer",
)

PFNGLXCREATEGLXPBUFFERSGIXPROC = CFUNCTYPE(
    GLXPbufferSGIX, POINTER(Display), GLXFBConfigSGIX, c_uint, c_uint, POINTER(c_int)
)  # GL/glxext.h:702
PFNGLXDESTROYGLXPBUFFERSGIXPROC = CFUNCTYPE(
    None, POINTER(Display), GLXPbufferSGIX
)  # GL/glxext.h:703
PFNGLXQUERYGLXPBUFFERSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXPbufferSGIX, c_int, POINTER(c_uint)
)  # GL/glxext.h:704
PFNGLXSELECTEVENTSGIXPROC = CFUNCTYPE(
    None, POINTER(Display), GLXDrawable, c_ulong
)  # GL/glxext.h:705
...
PFNGLXCUSHIONSGIPROC = CFUNCTYPE(
    None, POINTER(Display), Window, c_float
)  # GL/glxext.h:714
# SGIX_video_resize (GL/glxext.h:717)
GLX_SGIX_video_resize = 1  # GL/glxext.h:718
# GL/glxext.h:720
glXBindChannelToWindowSGIX = _link_function(
    "glXBindChannelToWindowSGIX",
    c_int,
    [POINTER(Display), c_int, c_int, Window],
    "SGIX_video_resize",
)

# GL/glxext.h:721
glXChannelRectSGIX = _link_function(
    "glXChannelRectSGIX",
    c_int,
    [POINTER(Display), c_int, c_int, c_int, c_int, c_int, c_int],
    "SGIX_video_resize",
)

# GL/glxext.h:722
glXQueryChannelRectSGIX = _link_function(
...
# GL/glxext.h:723
glXQueryChannelDeltasSGIX = _link_function(
...
# GL/glxext.h:724
glXChannelRectSyncSGIX = _link_function(
    "glXChannelRectSyncSGIX",
    c_int,
    [POINTER(Display), c_int, c_int, GLenum],
    "SGIX_video_resize",
)

PFNGLXBINDCHANNELTOWINDOWSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, c_int, Window
)  # GL/glxext.h:726
PFNGLXCHANNELRECTSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, c_int, c_int, c_int, c_int, c_int
)  # GL/glxext.h:727
PFNGLXQUERYCHANNELRECTSGIXPROC = CFUNCTYPE(
    c_int,
    POINTER(Display),
    c_int,
    c_int,
...
PFNGLXQUERYCHANNELDELTASSGIXPROC = CFUNCTYPE(
    c_int,
    POINTER(Display),
    c_int,
    c_int,
...
PFNGLXCHANNELRECTSYNCSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, c_int, GLenum
)  # GL/glxext.h:730
...
# GL/glxext.h:746
glXJoinSwapGroupSGIX = _link_function(
    "glXJoinSwapGroupSGIX",
    None,
    [POINTER(Display), GLXDrawable, GLXDrawable],
    "SGIX_swap_group",
)

PFNGLXJOINSWAPGROUPSGIXPROC = CFUNCTYPE(
    None, POINTER(Display), GLXDrawable, GLXDrawable
)  # GL/glxext.h:748
# SGIX_swap_barrier (GL/glxext.h:751)
GLX_SGIX_swap_barrier = 1  # GL/glxext.h:752
# GL/glxext.h:754
glXBindSwapBarrierSGIX = _link_function(
    "glXBindSwapBarrierSGIX",
    None,
    [POINTER(Display), GLXDrawable, c_int],
    "SGIX_swap_barrier",
)

# GL/glxext.h:755
glXQueryMaxSwapBarriersSGIX = _link_function(
...
PFNGLXBINDSWAPBARRIERSGIXPROC = CFUNCTYPE(
    None, POINTER(Display), GLXDrawable, c_int
)  # GL/glxext.h:757
PFNGLXQUERYMAXSWAPBARRIERSSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, POINTER(c_int)
)  # GL/glxext.h:758
# SUN_get_transparent_index (GL/glxext.h:761)
GLX_SUN_get_transparent_index = 1  # GL/glxext.h:762
# GL/glxext.h:764
glXGetTransparentIndexSUN = _link_function(
    "glXGetTransparentIndexSUN",
    c_int,
    [POINTER(Display), Window, Window, POINTER(c_long)],
    "SUN_get_transparent_index",
)

PFNGLXGETTRANSPARENTINDEXSUNPROC = CFUNCTYPE(
    c_int, POINTER(Display), Window, Window, POINTER(c_long)
)  # GL/glxext.h:766
# MESA_copy_sub_buffer (GL/glxext.h:769)
GLX_MESA_copy_sub_buffer = 1  # GL/glxext.h:770
# GL/glxext.h:772
glXCopySubBufferMESA = _link_function(
    "glXCopySubBufferMESA",
    None,
    [POINTER(Display), GLXDrawable, c_int, c_int, c_int, c_int],
    "MESA_copy_sub_buffer",
)

PFNGLXCOPYSUBBUFFERMESAPROC = CFUNCTYPE(
    None, POINTER(Display), GLXDrawable, c_int, c_int, c_int, c_int
)  # GL/glxext.h:774
# MESA_pixmap_colormap (GL/glxext.h:777)
GLX_MESA_pixmap_colormap = 1  # GL/glxext.h:778
Colormap = pyglet.libs.x11.xlib.Colormap
# GL/glxext.h:780
glXCreateGLXPixmapMESA = _link_function(
    "glXCreateGLXPixmapMESA",
    GLXPixmap,
    [POINTER(Display), POINTER(XVisualInfo), Pixmap, Colormap],
    "MESA_pixmap_colormap",
)

PFNGLXCREATEGLXPIXMAPMESAPROC = CFUNCTYPE(
...
# GL/glxext.h:788
glXReleaseBuffersMESA = _link_function(
...
PFNGLXRELEASEBUFFERSMESAPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable
)  # GL/glxext.h:790
...
# GL/glxext.h:812
glXGetSyncValuesOML = _link_function(
    "glXGetSyncValuesOML",
    c_int,
    [
        POINTER(Display),
...
# GL/glxext.h:813
glXGetMscRateOML = _link_function(
    "glXGetMscRateOML",
    c_int,
    [POINTER(Display), GLXDrawable, POINTER(c_int32), POINTER(c_int32)],
    "OML_sync_control",
)

# GL/glxext.h:814
glXSwapBuffersMscOML = _link_function(
    "glXSwapBuffersMscOML",
    c_int64,
    [POINTER(Display), GLXDrawable, c_int64, c_int64, c_int64],
    "OML_sync_control",
)

# GL/glxext.h:815
glXWaitForMscOML = _link_function(
    "glXWaitForMscOML",
    c_int,
    [
        POINTER(Display),
...
# GL/glxext.h:816
glXWaitForSbcOML = _link_function(
    "glXWaitForSbcOML",
    c_int,
    [
        POINTER(Display),
...
PFNGLXGETSYNCVALUESOMLPROC = CFUNCTYPE(
    c_int,
    POINTER(Display),
    GLXDrawable,
    POINTER(c_int64),
...
PFNGLXGETMSCRATEOMLPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable, POINTER(c_int32), POINTER(c_int32)
)  # GL/glxext.h:819
PFNGLXSWAPBUFFERSMSCOMLPROC = CFUNCTYPE(
    c_int64, POINTER(Display), GLXDrawable, c_int64, c_int64, c_int64
)  # GL/glxext.h:820
PFNGLXWAITFORMSCOMLPROC = CFUNCTYPE(
    c_int,
    POINTER(Display),
    GLXDrawable,
    c_int64,
...
PFNGLXWAITFORSBCOMLPROC = CFUNCTYPE(
    c_int,
    POINTER(Display),
    GLXDrawable,
    c_int64,
...
# GL/glxext.h:857
glXQueryHyperpipeNetworkSGIX = _link_function(
    "glXQueryHyperpipeNetworkSGIX",
    POINTER(GLXHyperpipeNetworkSGIX),
    [POINTER(Display), POINTER(c_int)],
    "SGIX_hyperpipe",
)

# GL/glxext.h:858
glXHyperpipeConfigSGIX = _link_function(
    "glXHyperpipeConfigSGIX",
    c_int,
    [POINTER(Display), c_int, c_int, POINTER(GLXHyperpipeConfigSGIX), POINTER(c_int)],
    "SGIX_hyperpipe",
)

# GL/glxext.h:859
glXQueryHyperpipeConfigSGIX = _link_function(
    "glXQueryHyperpipeConfigSGIX",
    POINTER(GLXHyperpipeConfigSGIX),
    [POINTER(Display), c_int, POINTER(c_int)],
    "SGIX_hyperpipe",
)
...
# GL/glxext.h:862
glXQueryHyperpipeBestAttribSGIX = _link_function(
    "glXQueryHyperpipeBestAttribSGIX",
    c_int,
    [POINTER(Display), c_int, c_int, c_int, POINTER(None), POINTER(None)],
    "SGIX_hyperpipe",
)

# GL/glxext.h:863
glXHyperpipeAttribSGIX = _link_function(
    "glXHyperpipeAttribSGIX",
    c_int,
    [POINTER(Display), c_int, c_int, c_int, POINTER(None)],
    "SGIX_hyperpipe",
)

# GL/glxext.h:864
glXQueryHyperpipeAttribSGIX = _link_function(
...
PFNGLXQUERYHYPERPIPENETWORKSGIXPROC = CFUNCTYPE(
    POINTER(GLXHyperpipeNetworkSGIX), POINTER(Display), POINTER(c_int)
)  # GL/glxext.h:866
PFNGLXHYPERPIPECONFIGSGIXPROC = CFUNCTYPE(
    c_int,
    POINTER(Display),
    c_int,
    c_int,
...
PFNGLXQUERYHYPERPIPECONFIGSGIXPROC = CFUNCTYPE(
    POINTER(GLXHyperpipeConfigSGIX), POINTER(Display), c_int, POINTER(c_int)
)  # GL/glxext.h:868
PFNGLXDESTROYHYPERPIPECONFIGSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int
)  # GL/glxext.h:869
PFNGLXBINDHYPERPIPESGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int
)  # GL/glxext.h:870
PFNGLXQUERYHYPERPIPEBESTATTRIBSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, c_int, c_int, POINTER(None), POINTER(None)
)  # GL/glxext.h:871
PFNGLXHYPERPIPEATTRIBSGIXPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, c_int, c_int, POINTER(None)
)  # GL/glxext.h:872
...
# GL/glxext.h:895
glXBindTexImageEXT = _link_function(
    "glXBindTexImageEXT",
    None,
    [POINTER(Display), GLXDrawable, c_int, POINTER(c_int)],
    "EXT_texture_from_pixmap",
)

# GL/glxext.h:896
glXReleaseTexImageEXT = _link_function(
...
PFNGLXBINDTEXIMAGEEXTPROC = CFUNCTYPE(
    None, POINTER(Display), GLXDrawable, c_int, POINTER(c_int)
)  # GL/glxext.h:898
...
# GL/glxext.h:905
glXEnumerateVideoDevicesNV = _link_function(
...
# GL/glxext.h:906
glXBindVideoDeviceNV = _link_function(
    "glXBindVideoDeviceNV",
    c_int,
    [POINTER(Display), c_uint, c_uint, POINTER(c_int)],
    "NV_present_video",
)

PFNGLXENUMERATEVIDEODEVICESNVPROC = CFUNCTYPE(
    POINTER(c_uint), POINTER(Display), c_int, POINTER(c_int)
)  # GL/glxext.h:908
PFNGLXBINDVIDEODEVICENVPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_uint, c_uint, POINTER(c_int)
)  # GL/glxext.h:909
# NV_video_output (GL/glxext.h:912)
GLX_NV_video_output = 1  # GL/glxext.h:913
# GL/glxext.h:915
glXGetVideoDeviceNV = _link_function(
    "glXGetVideoDeviceNV",
    c_int,
    [POINTER(Display), c_int, c_int, POINTER(GLXVideoDeviceNV)],
    "NV_video_output",
)

# GL/glxext.h:916
glXReleaseVideoDeviceNV = _link_function(
    "glXReleaseVideoDeviceNV",
    c_int,
    [POINTER(Display), c_int, GLXVideoDeviceNV],
    "NV_video_output",
)

GLXPbuffer = pyglet.gl.glx.GLXPbuffer
# GL/glxext.h:917
glXBindVideoImageNV = _link_function(
    "glXBindVideoImageNV",
    c_int,
    [POINTER(Display), GLXVideoDeviceNV, GLXPbuffer, c_int],
    "NV_video_output",
)
...
# GL/glxext.h:919
glXSendPbufferToVideoNV = _link_function(
    "glXSendPbufferToVideoNV",
    c_int,
    [POINTER(Display), GLXPbuffer, c_int, POINTER(c_ulong), GLboolean],
    "NV_video_output",
)

# GL/glxext.h:920
glXGetVideoInfoNV = _link_function(
    "glXGetVideoInfoNV",
    c_int,
    [POINTER(Display), c_int, GLXVideoDeviceNV, POINTER(c_ulong), POINTER(c_ulong)],
    "NV_video_output",
)

PFNGLXGETVIDEODEVICENVPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, c_int, POINTER(GLXVideoDeviceNV)
)  # GL/glxext.h:922
PFNGLXRELEASEVIDEODEVICENVPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, GLXVideoDeviceNV
)  # GL/glxext.h:923
PFNGLXBINDVIDEOIMAGENVPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXVideoDeviceNV, GLXPbuffer, c_int
)  # GL/glxext.h:924
PFNGLXRELEASEVIDEOIMAGENVPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXPbuffer
)  # GL/glxext.h:925
PFNGLXSENDPBUFFERTOVIDEONVPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXPbuffer, c_int, POINTER(c_ulong), GLboolean
)  # GL/glxext.h:926
PFNGLXGETVIDEOINFONVPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, GLXVideoDeviceNV, POINTER(c_ulong), POINTER(c_ulong)
)  # GL/glxext.h:927
# NV_swap_group (GL/glxext.h:930)
GLX_NV_swap_group = 1  # GL/glxext.h:931
GLuint = c_uint  # /usr/include/GL/gl.h:162
# GL/glxext.h:933
glXJoinSwapGroupNV = _link_function(
    "glXJoinSwapGroupNV",
    c_int,
    [POINTER(Display), GLXDrawable, GLuint],
    "NV_swap_group",
)
...
# GL/glxext.h:935
glXQuerySwapGroupNV = _link_function(
    "glXQuerySwapGroupNV",
    c_int,
    [POINTER(Display), GLXDrawable, POINTER(GLuint), POINTER(GLuint)],
    "NV_swap_group",
)

# GL/glxext.h:936
glXQueryMaxSwapGroupsNV = _link_function(
    "glXQueryMaxSwapGroupsNV",
    c_int,
    [POINTER(Display), c_int, POINTER(GLuint), POINTER(GLuint)],
    "NV_swap_group",
)

# GL/glxext.h:937
glXQueryFrameCountNV = _link_function(
    "glXQueryFrameCountNV",
    c_int,
    [POINTER(Display), c_int, POINTER(GLuint)],
    "NV_swap_group",
)
...
PFNGLXJOINSWAPGROUPNVPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable, GLuint
)  # GL/glxext.h:940
PFNGLXBINDSWAPBARRIERNVPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLuint, GLuint
)  # GL/glxext.h:941
PFNGLXQUERYSWAPGROUPNVPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable, POINTER(GLuint), POINTER(GLuint)
)  # GL/glxext.h:942
PFNGLXQUERYMAXSWAPGROUPSNVPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, POINTER(GLuint), POINTER(GLuint)
)  # GL/glxext.h:943
PFNGLXQUERYFRAMECOUNTNVPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_int, POINTER(GLuint)
)  # GL/glxext.h:944
...
# GL/glxext.h:951
glXBindVideoCaptureDeviceNV = _link_function(
    "glXBindVideoCaptureDeviceNV",
    c_int,
    [POINTER(Display), c_uint, GLXVideoCaptureDeviceNV],
    "NV_video_capture",
)

# GL/glxext.h:952
glXEnumerateVideoCaptureDevicesNV = _link_function(
    "glXEnumerateVideoCaptureDevicesNV",
    POINTER(GLXVideoCaptureDeviceNV),
    [POINTER(Display), c_int, POINTER(c_int)],
    "NV_video_capture",
)

# GL/glxext.h:953
glXLockVideoCaptureDeviceNV = _link_function(
    "glXLockVideoCaptureDeviceNV",
    None,
    [POINTER(Display), GLXVideoCaptureDeviceNV],
    "NV_video_capture",
)

# GL/glxext.h:954
glXQueryVideoCaptureDeviceNV = _link_function(
    "glXQueryVideoCaptureDeviceNV",
    c_int,
    [POINTER(Display), GLXVideoCaptureDeviceNV, c_int, POINTER(c_int)],
    "NV_video_capture",
)

# GL/glxext.h:955
glXReleaseVideoCaptureDeviceNV = _link_function(
...
PFNGLXBINDVIDEOCAPTUREDEVICENVPROC = CFUNCTYPE(
    c_int, POINTER(Display), c_uint, GLXVideoCaptureDeviceNV
)  # GL/glxext.h:957
PFNGLXENUMERATEVIDEOCAPTUREDEVICESNVPROC = CFUNCTYPE(
    POINTER(GLXVideoCaptureDeviceNV), POINTER(Display), c_int, POINTER(c_int)
)  # GL/glxext.h:958
PFNGLXLOCKVIDEOCAPTUREDEVICENVPROC = CFUNCTYPE(
    None, POINTER(Display), GLXVideoCaptureDeviceNV
)  # GL/glxext.h:959
PFNGLXQUERYVIDEOCAPTUREDEVICENVPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXVideoCaptureDeviceNV, c_int, POINTER(c_int)
)  # GL/glxext.h:960
...
# GL/glxext.h:967
glXSwapIntervalEXT = _link_function(
    "glXSwapIntervalEXT",
    c_int,
    [POINTER(Display), GLXDrawable, c_int],
    "EXT_swap_control",
...
PFNGLXSWAPINTERVALEXTPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable, c_int
)  # GL/glxext.h:969
...
# GL/glxext.h:975
glXCopyImageSubDataNV = _link_function(
...
PFNGLXCOPYIMAGESUBDATANVPROC = CFUNCTYPE(
    None,
    POINTER(Display),
    GLXContext,
    GLuint,
