...
glXCreateContext = _link_function(
    "glXCreateContext",
    GLXContext,
    [POINTER(Display), POINTER(XVisualInfo), GLXContext, c_int],
    "H",
)
...
glXCreateGLXPixmap = _link_function(
    "glXCreateGLXPixmap",
    GLXPixmap,
    [POINTER(Display), POINTER(XVisualInfo), Pixmap],
    "H",
)
...
glXGetConfig = _link_function(
    "glXGetConfig",
    c_int,
    [POINTER(Display), POINTER(XVisualInfo), c_int, POINTER(c_int)],
    "H",
)
...
glXChooseFBConfig = _link_function(
    "glXChooseFBConfig",
    POINTER(GLXFBConfig),
...
glXGetFBConfigAttrib = _link_function(
    "glXGetFBConfigAttrib",
    c_int,
    [POINTER(Display), GLXFBConfig, c_int, POINTER(c_int)],
    "H",
)

# /usr/include/GL/glx.h:251
glXGetFBConfigs = _link_function(
    "glXGetFBConfigs",
    POINTER(GLXFBConfig),
    [POINTER(Display), c_int, POINTER(c_int)],
    "H",
...
glXGetVisualFromFBConfig = _link_function(
...
glXCreateWindow = _link_function(
    "glXCreateWindow",
    GLXWindow,
    [POINTER(Display), GLXFBConfig, Window, POINTER(c_int)],
    "H",
)
...
glXCreatePixmap = _link_function(
    "glXCreatePixmap",
    GLXPixmap,
    [POINTER(Display), GLXFBConfig, Pixmap, POINTER(c_int)],
    "H",
)
...
glXCreatePbuffer = _link_function(
    "glXCreatePbuffer", GLXPbuffer, [POINTER(Display), GLXFBConfig, POINTER(c_int)], "H"
)
...
glXQueryDrawable = _link_function(
    "glXQueryDrawable",
    None,
    [POINTER(Display), GLXDrawable, c_int, POINTER(c_uint)],
    "H",
)

# /usr/include/GL/glx.h:275
glXCreateNewContext = _link_function(
    "glXCreateNewContext",
    GLXContext,
    [POINTER(Display), GLXFBConfig, c_int, GLXContext, c_int],
    "H",
)

# /usr/include/GL/glx.h:279
glXMakeContextCurrent = _link_function(
...
glXGetCurrentReadDrawable = _link_function(
    "glXGetCurrentReadDrawable", GLXDrawable, [], "H"
)

# /usr/include/GL/glx.h:284
glXQueryContext = _link_function(
    "glXQueryContext", c_int, [POINTER(Display), GLXContext, c_int, POINTER(c_int)], "H"
)
...
PFNGLXGETFBCONFIGSPROC = CFUNCTYPE(
    POINTER(GLXFBConfig), POINTER(Display), c_int, POINTER(c_int)
)  # /usr/include/GL/glx.h:294
PFNGLXCHOOSEFBCONFIGPROC = CFUNCTYPE(
    POINTER(GLXFBConfig), POINTER(Display), c_int, POINTER(c_int), POINTER(c_int)
)  # /usr/include/GL/glx.h:295
PFNGLXGETFBCONFIGATTRIBPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXFBConfig, c_int, POINTER(c_int)
)  # /usr/include/GL/glx.h:296
PFNGLXGETVISUALFROMFBCONFIGPROC = CFUNCTYPE(
    POINTER(XVisualInfo), POINTER(Display), GLXFBConfig
)  # /usr/include/GL/glx.h:297
PFNGLXCREATEWINDOWPROC = CFUNCTYPE(
    GLXWindow, POINTER(Display), GLXFBConfig, Window, POINTER(c_int)
)  # /usr/include/GL/glx.h:298
PFNGLXDESTROYWINDOWPROC = CFUNCTYPE(
    None, POINTER(Display), GLXWindow
)  # /usr/include/GL/glx.h:299
PFNGLXCREATEPIXMAPPROC = CFUNCTYPE(
    GLXPixmap, POINTER(Display), GLXFBConfig, Pixmap, POINTER(c_int)
)  # /usr/include/GL/glx.h:300
PFNGLXDESTROYPIXMAPPROC = CFUNCTYPE(
    None, POINTER(Display), GLXPixmap
)  # /usr/include/GL/glx.h:301
PFNGLXCREATEPBUFFERPROC = CFUNCTYPE(
    GLXPbuffer, POINTER(Display), GLXFBConfig, POINTER(c_int)
)  # /usr/include/GL/glx.h:302
PFNGLXDESTROYPBUFFERPROC = CFUNCTYPE(
    None, POINTER(Display), GLXPbuffer
)  # /usr/include/GL/glx.h:303
PFNGLXQUERYDRAWABLEPROC = CFUNCTYPE(
    None, POINTER(Display), GLXDrawable, c_int, POINTER(c_uint)
)  # /usr/include/GL/glx.h:304
PFNGLXCREATENEWCONTEXTPROC = CFUNCTYPE(
    GLXContext, POINTER(Display), GLXFBConfig, c_int, GLXContext, c_int
)  # /usr/include/GL/glx.h:305
PFNGLXMAKECONTEXTCURRENTPROC = CFUNCTYPE(
...
glXGetProcAddress = _link_function(
    "glXGetProcAddress",
...
PFNGLXGETPROCADDRESSPROC = CFUNCTYPE(
    __GLXextFuncPtr, POINTER(GLubyte)
)  # /usr/include/GL/glx.h:331
...
glXAllocateMemoryMESA = _link_function(
    "glXAllocateMemoryMESA",
    POINTER(c_void),
    [POINTER(Display), c_int, c_size_t, c_float, c_float, c_float],
    "MESA_allocate_memory",
)

# /usr/include/GL/glx.h:367
glXFreeMemoryMESA = _link_function(
    "glXFreeMemoryMESA",
    None,
    [POINTER(Display), c_int, POINTER(None)],
    "MESA_allocate_memory",
)

GLuint = c_uint  # /usr/include/GL/gl.h:162
# /usr/include/GL/glx.h:368
glXGetMemoryOffsetMESA = _link_function(
...
PFNGLXALLOCATEMEMORYMESAPROC = CFUNCTYPE(
    POINTER(c_void), POINTER(Display), c_int, c_size_t, c_float, c_float, c_float
)  # /usr/include/GL/glx.h:369
PFNGLXFREEMEMORYMESAPROC = CFUNCTYPE(
    None, POINTER(Display), c_int, POINTER(None)
)  # /usr/include/GL/glx.h:370
PFNGLXGETMEMORYOFFSETMESAPROC = CFUNCTYPE(
    GLuint, POINTER(Display), c_int, POINTER(None)
)  # /usr/include/GL/glx.h:371
# ARB_render_texture (/usr/include/GL/glx.h:380)
GLX_ARB_render_texture = 1  # /usr/include/GL/glx.h:381
# /usr/include/GL/glx.h:383
glXBindTexImageARB = _link_function(
    "glXBindTexImageARB",
    c_int,
    [POINTER(Display), GLXPbuffer, c_int],
    "ARB_render_texture",
)

# /usr/include/GL/glx.h:384
glXReleaseTexImageARB = _link_function(
...
glXDrawableAttribARB = _link_function(
    "glXDrawableAttribARB",
    c_int,
    [POINTER(Display), GLXDrawable, POINTER(c_int)],
    "ARB_render_texture",
)
...
glXGetFrameUsageMESA = _link_function(
    "glXGetFrameUsageMESA",
    c_int,
    [POINTER(Display), GLXDrawable, POINTER(c_float)],
    "MESA_swap_frame_usage",
)

# /usr/include/GL/glx.h:409
glXBeginFrameTrackingMESA = _link_function(
...
glXEndFrameTrackingMESA = _link_function(
...
glXQueryFrameTrackingMESA = _link_function(
...
PFNGLXGETFRAMEUSAGEMESAPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable, POINTER(c_float)
)  # /usr/include/GL/glx.h:413
PFNGLXBEGINFRAMETRACKINGMESAPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable
)  # /usr/include/GL/glx.h:414
PFNGLXENDFRAMETRACKINGMESAPROC = CFUNCTYPE(
    c_int, POINTER(Display), GLXDrawable
)  # /usr/include/GL/glx.h:415
PFNGLXQUERYFRAMETRACKINGMESAPROC = CFUNCTYPE(
    c_int,
    POINTER(Display),
    GLXDrawable,
    POINTER(c_int64),
...
glXGetSwapIntervalMESA = _link_function(
    "glXGetSwapIntervalMESA", c_int, [], "MESA_swap_control"
)
