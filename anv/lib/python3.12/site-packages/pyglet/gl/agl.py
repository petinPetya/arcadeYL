...
struct_GDevice._fields_ = [("_opaque_struct", c_int)]
...
GDPtr = POINTER(
    GDevice
)  # /System/Library/Frameworks/ApplicationServices.framework/Frameworks/QD.framework/Headers/Quickdraw.h:1348
GDHandle = POINTER(
    GDPtr
)  # /System/Library/Frameworks/ApplicationServices.framework/Frameworks/QD.framework/Headers/Quickdraw.h:1349
...
struct_OpaqueGrafPtr._fields_ = [("_opaque_struct", c_int)]

GrafPtr = POINTER(
    struct_OpaqueGrafPtr
)  # /System/Library/Frameworks/ApplicationServices.framework/Frameworks/QD.framework/Headers/Quickdraw.h:1009
...
struct___AGLRendererInfoRec._fields_ = [("_opaque_struct", c_int)]

AGLRendererInfo = POINTER(
    struct___AGLRendererInfoRec
)  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:56
...
struct___AGLPixelFormatRec._fields_ = [("_opaque_struct", c_int)]

AGLPixelFormat = POINTER(
    struct___AGLPixelFormatRec
)  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:57
...
struct___AGLContextRec._fields_ = [("_opaque_struct", c_int)]

AGLContext = POINTER(
    struct___AGLContextRec
)  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:58
...
struct___AGLPBufferRec._fields_ = [("_opaque_struct", c_int)]

AGLPbuffer = POINTER(
    struct___AGLPBufferRec
)  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:59
...
AGL_COLORMAP_TRACKING = (
    210  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:153
)
...
AGL_ORDER_CONTEXT_TO_FRONT = (
    232  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:159
)
AGL_CONTEXT_SURFACE_ID = (
    233  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:160
)
AGL_CONTEXT_DISPLAY_ID = (
    234  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:161
)
...
AGL_FS_CAPTURE_SINGLE = (
    255  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:165
)
AGL_SURFACE_BACKING_SIZE = (
    304  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:166
)
AGL_ENABLE_SURFACE_BACKING_SIZE = (
    305  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:167
)
AGL_SURFACE_VOLATILE = 306  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:168
AGL_FORMAT_CACHE_SIZE = (
    501  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:172
)
AGL_CLEAR_FORMAT_CACHE = (
    502  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:173
)
...
AGL_ARGB2101010_BIT = (
    262144  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:220
)
AGL_RGB101010_A8_BIT = (
    524288  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:221
)
AGL_RGB121212_BIT = (
    1048576  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:222
)
AGL_ARGB12121212_BIT = (
    2097152  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:223
)
AGL_RGB161616_BIT = (
    4194304  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:224
)
AGL_ARGB16161616_BIT = (
    8388608  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:225
)
AGL_INDEX8_BIT = 536870912  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:226
AGL_INDEX16_BIT = (
    1073741824  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:227
)
AGL_RGBFLOAT64_BIT = (
    16777216  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:228
)
AGL_RGBAFLOAT64_BIT = (
    33554432  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:229
)
AGL_RGBFLOAT128_BIT = (
    67108864  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:230
)
AGL_RGBAFLOAT128_BIT = (
    134217728  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:231
)
AGL_RGBFLOAT256_BIT = (
    268435456  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:232
)
AGL_RGBAFLOAT256_BIT = (
    536870912  # /System/Library/Frameworks/AGL.framework/Headers/agl.h:233
)
...
aglChoosePixelFormat = _link_function(
    ...
    AGLPixelFormat,
    [POINTER(AGLDevice), GLint, POINTER(GLint)],
    None,
)
...
aglDevicesOfPixelFormat = _link_function(
    "aglDevicesOfPixelFormat",
    POINTER(AGLDevice),
    [AGLPixelFormat, POINTER(GLint)],
    None,
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:273
aglQueryRendererInfo = _link_function(
    "aglQueryRendererInfo", AGLRendererInfo, [POINTER(AGLDevice), GLint], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:274
aglDestroyRendererInfo = _link_function(
    "aglDestroyRendererInfo", None, [AGLRendererInfo], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:275
aglNextRendererInfo = _link_function(
    "aglNextRendererInfo", AGLRendererInfo, [AGLRendererInfo], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:276
aglDescribeRenderer = _link_function(
    "aglDescribeRenderer", GLboolean, [AGLRendererInfo, GLint, POINTER(GLint)], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:281
aglCreateContext = _link_function(
    "aglCreateContext", AGLContext, [AGLPixelFormat, AGLContext], None
)
...
aglCopyContext = _link_function(
    "aglCopyContext", GLboolean, [AGLContext, AGLContext, GLuint], None
)
...
aglSetCurrentContext = _link_function(
    "aglSetCurrentContext", GLboolean, [AGLContext], None
)
...
aglSetDrawable = _link_function(
    "aglSetDrawable", GLboolean, [AGLContext, AGLDrawable], None
)
...
aglSetOffScreen = _link_function(
    "aglSetOffScreen",
    GLboolean,
    [AGLContext, GLsizei, GLsizei, GLsizei, POINTER(GLvoid)],
    None,
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:297
aglSetFullScreen = _link_function(
    "aglSetFullScreen", GLboolean, [AGLContext, GLsizei, GLsizei, GLsizei, GLint], None
)
...
aglSetVirtualScreen = _link_function(
    "aglSetVirtualScreen", GLboolean, [AGLContext, GLint], None
)
...
aglGetVersion = _link_function(
    "aglGetVersion", None, [POINTER(GLint), POINTER(GLint)], None
)
...
aglSetInteger = _link_function(
    "aglSetInteger", GLboolean, [AGLContext, GLenum, POINTER(GLint)], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:328
aglGetInteger = _link_function(
    "aglGetInteger", GLboolean, [AGLContext, GLenum, POINTER(GLint)], None
)
...
aglUseFont = _link_function(
    "aglUseFont",
    GLboolean,
    [AGLContext, GLint, Style, GLint, GLint, GLint, GLint],
    None,
)
...
aglSurfaceTexture = _link_function(
    "aglSurfaceTexture", None, [AGLContext, GLenum, GLenum, AGLContext], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:354
aglCreatePBuffer = _link_function(
    "aglCreatePBuffer",
    GLboolean,
    [GLint, GLint, GLenum, GLenum, c_long, POINTER(AGLPbuffer)],
    None,
)
...
aglDescribePBuffer = _link_function(
    "aglDescribePBuffer",
    GLboolean,
    [
        AGLPbuffer,
...
aglTexImagePBuffer = _link_function(
    "aglTexImagePBuffer", GLboolean, [AGLContext, AGLPbuffer, GLint], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:362
aglSetPBuffer = _link_function(
    "aglSetPBuffer", GLboolean, [AGLContext, AGLPbuffer, GLint, GLint, GLint], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:363
aglGetPBuffer = _link_function(
    "aglGetPBuffer",
    GLboolean,
    [AGLContext, POINTER(AGLPbuffer), POINTER(GLint), POINTER(GLint), POINTER(GLint)],
    None,
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:368
aglGetCGLContext = _link_function(
    "aglGetCGLContext", GLboolean, [AGLContext, POINTER(POINTER(None))], None
)

# /System/Library/Frameworks/AGL.framework/Headers/agl.h:369
aglGetCGLPixelFormat = _link_function(
    "aglGetCGLPixelFormat", GLboolean, [AGLPixelFormat, POINTER(POINTER(None))], None
)
