...
def glAreTexturesResident(
    n: GLsizei | int,
    textures: _Pointer[GLuint] | Any,
    residences: _Pointer[GLboolean] | Any,
) -> int: ...
...
def glBeginQueryIndexed(
    target: GLenum | int, index: GLuint | int, id: GLuint | int
) -> None: ...
def glBeginTransformFeedback(primitiveMode: GLenum | int) -> None: ...
def glBindAttribLocation(
    program: GLuint | int, index: GLuint | int, name: _Pointer[GLchar] | Any
) -> None: ...
def glBindBuffer(target: GLenum | int, buffer: GLuint | int) -> None: ...
def glBindBufferBase(
    target: GLenum | int, index: GLuint | int, buffer: GLuint | int
) -> None: ...
...
def glBindBuffersRange(
    ...
    count: GLsizei | int,
    buffers: _Pointer[GLuint] | Any,
    offsets: _Pointer[GLintptr] | Any,
    sizes: _Pointer[GLsizeiptr] | Any,
) -> None: ...
def glBindFragDataLocation(
    program: GLuint | int, color: GLuint | int, name: _Pointer[GLchar] | Any
) -> None: ...
def glBindFragDataLocationIndexed(
    program: GLuint | int,
    colorNumber: GLuint | int,
    index: GLuint | int,
    name: _Pointer[GLchar] | Any,
) -> None: ...
...
def glBindImageTexture(
    ...
    texture: GLuint | int,
    level: GLint | int,
    layered: GLboolean | int,
    layer: GLint | int,
    access: GLenum | int,
    format: GLenum | int,
) -> None: ...
def glBindImageTextures(
    first: GLuint | int, count: GLsizei | int, textures: _Pointer[GLuint] | Any
) -> None: ...
...
def glBindSamplers(
    first: GLuint | int, count: GLsizei | int, samplers: _Pointer[GLuint] | Any
) -> None: ...
...
def glBlendEquationSeparatei(
    buf: GLuint | int, modeRGB: GLenum | int, modeAlpha: GLenum | int
) -> None: ...
...
def glBlendFuncSeparate(
    sfactorRGB: GLenum | int,
    dfactorRGB: GLenum | int,
    sfactorAlpha: GLenum | int,
    dfactorAlpha: GLenum | int,
) -> None: ...
...
def glBlitNamedFramebuffer(
    readFramebuffer: GLuint | int,
    drawFramebuffer: GLuint | int,
    srcX0: GLint | int,
    srcY0: GLint | int,
    srcX1: GLint | int,
    srcY1: GLint | int,
...
def glCallLists(
    n: GLsizei | int, type: GLenum | int, lists: _Pointer[GLvoid] | Any
) -> None: ...
...
def glCheckNamedFramebufferStatus(
    framebuffer: GLuint | int, target: GLenum | int
) -> int: ...
...
def glClearBufferfi(
    buffer: GLenum | int,
    drawbuffer: GLint | int,
    depth: GLfloat | float,
    stencil: GLint | int,
) -> None: ...
def glClearBufferfv(
    buffer: GLenum | int, drawbuffer: GLint | int, value: _Pointer[GLfloat] | Any
) -> None: ...
def glClearBufferiv(
    buffer: GLenum | int, drawbuffer: GLint | int, value: _Pointer[GLint] | Any
) -> None: ...
def glClearBufferuiv(
    buffer: GLenum | int, drawbuffer: GLint | int, value: _Pointer[GLuint] | Any
) -> None: ...
def glClearColor(
    red: GLfloat | float,
    green: GLfloat | float,
...
def glClearNamedFramebufferfv(
    ...
    buffer: GLenum | int,
    drawbuffer: GLint | int,
    value: _Pointer[GLfloat] | Any,
) -> None: ...
def glClearNamedFramebufferiv(
    framebuffer: GLuint | int,
    buffer: GLenum | int,
    drawbuffer: GLint | int,
    value: _Pointer[GLint] | Any,
) -> None: ...
def glClearNamedFramebufferuiv(
    framebuffer: GLuint | int,
    buffer: GLenum | int,
    drawbuffer: GLint | int,
    value: _Pointer[GLuint] | Any,
) -> None: ...
...
def glClientWaitSync(
    sync: GLsync, flags: GLbitfield | int, timeout: GLuint64 | int
) -> int: ...
...
def glColor3b(
    red: GLbyte | bytes, green: GLbyte | bytes, blue: GLbyte | bytes
) -> None: ...
def glColor3bv(v: _Pointer[GLbyte] | Any) -> None: ...
def glColor3d(
    red: GLdouble | float, green: GLdouble | float, blue: GLdouble | float
) -> None: ...
def glColor3dv(v: _Pointer[GLdouble] | Any) -> None: ...
def glColor3f(
    red: GLfloat | float, green: GLfloat | float, blue: GLfloat | float
) -> None: ...
...
def glColor3s(
    red: GLshort | int, green: GLshort | int, blue: GLshort | int
) -> None: ...
def glColor3sv(v: _Pointer[GLshort] | Any) -> None: ...
def glColor3ub(
    red: GLubyte | int, green: GLubyte | int, blue: GLubyte | int
) -> None: ...
...
def glColor3us(
    red: GLushort | int, green: GLushort | int, blue: GLushort | int
) -> None: ...
...
def glColor4d(
    red: GLdouble | float,
    green: GLdouble | float,
    blue: GLdouble | float,
    alpha: GLdouble | float,
) -> None: ...
...
def glColor4i(
    red: GLint | int, green: GLint | int, blue: GLint | int, alpha: GLint | int
) -> None: ...
def glColor4iv(v: _Pointer[GLint] | Any) -> None: ...
def glColor4s(
    red: GLshort | int, green: GLshort | int, blue: GLshort | int, alpha: GLshort | int
) -> None: ...
def glColor4sv(v: _Pointer[GLshort] | Any) -> None: ...
def glColor4ub(
    red: GLubyte | int, green: GLubyte | int, blue: GLubyte | int, alpha: GLubyte | int
) -> None: ...
def glColor4ubv(v: _Pointer[GLubyte] | Any) -> None: ...
def glColor4ui(
    red: GLuint | int, green: GLuint | int, blue: GLuint | int, alpha: GLuint | int
) -> None: ...
...
def glCopyBufferSubData(
    readTarget: GLenum | int,
    writeTarget: GLenum | int,
    readOffset: GLintptr,
...
def glCopyImageSubData(
    srcName: GLuint | int,
    srcTarget: GLenum | int,
    srcLevel: GLint | int,
    srcX: GLint | int,
    srcY: GLint | int,
    srcZ: GLint | int,
    dstName: GLuint | int,
    dstTarget: GLenum | int,
    dstLevel: GLint | int,
    dstX: GLint | int,
    dstY: GLint | int,
    dstZ: GLint | int,
    srcWidth: GLsizei | int,
    srcHeight: GLsizei | int,
    srcDepth: GLsizei | int,
) -> None: ...
def glCopyNamedBufferSubData(
    readBuffer: GLuint | int,
    writeBuffer: GLuint | int,
    readOffset: GLintptr,
    writeOffset: GLintptr,
    size: GLsizeiptr,
) -> None: ...
...
def glCreateFramebuffers(
    n: GLsizei | int, framebuffers: _Pointer[GLuint] | Any
) -> None: ...
def glCreateProgram() -> int: ...
def glCreateProgramPipelines(
    n: GLsizei | int, pipelines: _Pointer[GLuint] | Any
) -> None: ...
def glCreateQueries(
    target: GLenum | int, n: GLsizei | int, ids: _Pointer[GLuint] | Any
) -> None: ...
def glCreateRenderbuffers(
    n: GLsizei | int, renderbuffers: _Pointer[GLuint] | Any
) -> None: ...
...
def glCreateShaderProgramv(
    type: GLenum | int, count: GLsizei | int, strings: _Pointer[_Pointer[GLchar]] | Any
) -> int: ...
def glCreateTextures(
    target: GLenum | int, n: GLsizei | int, textures: _Pointer[GLuint] | Any
) -> None: ...
def glCreateTransformFeedbacks(
    n: GLsizei | int, ids: _Pointer[GLuint] | Any
) -> None: ...
...
def glDebugMessageCallback(
    callback: GLDEBUGPROC, userParam: _Pointer[GLvoid] | Any
) -> None: ...
def glDebugMessageControl(
    ...
    severity: GLenum | int,
    count: GLsizei | int,
    ids: _Pointer[GLuint] | Any,
    enabled: GLboolean | int,
) -> None: ...
...
def glDeleteRenderbuffersEXT(
    n: GLsizei | int, renderbuffers: _Pointer[GLuint] | Any
) -> None: ...
def glDeleteSamplers(
    count: GLsizei | int, samplers: _Pointer[GLuint] | Any
) -> None: ...
...
def glDepthRangeArrayv(
    first: GLuint | int, count: GLsizei | int, v: _Pointer[GLdouble] | Any
) -> None: ...
def glDepthRangeIndexed(
    index: GLuint | int, n: GLdouble | float, f: GLdouble | float
) -> None: ...
...
def glDispatchCompute(
    num_groups_x: GLuint | int, num_groups_y: GLuint | int, num_groups_z: GLuint | int
) -> None: ...
def glDispatchComputeIndirect(indirect: GLintptr) -> None: ...
def glDrawArrays(
    mode: GLenum | int, first: GLint | int, count: GLsizei | int
) -> None: ...
def glDrawArraysIndirect(
    mode: GLenum | int, indirect: _Pointer[GLvoid] | Any
) -> None: ...
def glDrawArraysInstanced(
    mode: GLenum | int,
    first: GLint | int,
    count: GLsizei | int,
    instancecount: GLsizei | int,
) -> None: ...
...
def glDrawElementsBaseVertex(
    ...
    type: GLenum | int,
    indices: _Pointer[GLvoid] | Any,
    basevertex: GLint | int,
) -> None: ...
def glDrawElementsIndirect(
    mode: GLenum | int, type: GLenum | int, indirect: _Pointer[GLvoid] | Any
) -> None: ...
...
def glDrawTransformFeedbackInstanced(
    mode: GLenum | int, id: GLuint | int, instancecount: GLsizei | int
) -> None: ...
def glDrawTransformFeedbackStream(
    mode: GLenum | int, id: GLuint | int, stream: GLuint | int
) -> None: ...
...
def glEdgeFlagPointer(
    stride: GLsizei | int, pointer: _Pointer[GLvoid] | Any
) -> None: ...
...
def glFeedbackBuffer(
    size: GLsizei | int, type: GLenum | int, buffer: _Pointer[GLfloat] | Any
) -> None: ...
def glFenceSync(condition: GLenum | int, flags: GLbitfield | int) -> GLsync: ...
def glFinish() -> None: ...
def glFlush() -> None: ...
def glFlushMappedBufferRange(
    target: GLenum | int, offset: GLintptr, length: GLsizeiptr
) -> None: ...
def glFlushMappedNamedBufferRange(
    buffer: GLuint | int, offset: GLintptr, length: GLsizeiptr
) -> None: ...
def glFogCoordPointer(
    type: GLenum | int, stride: GLsizei | int, pointer: _Pointer[GLvoid] | Any
) -> None: ...
...
def glFramebufferParameteri(
    target: GLenum | int, pname: GLenum | int, param: GLint | int
) -> None: ...
def glFramebufferRenderbuffer(
    target: GLenum | int,
    attachment: GLenum | int,
    renderbuffertarget: GLenum | int,
    renderbuffer: GLuint | int,
) -> None: ...
...
def glFrustum(
    left: GLdouble | float,
    right: GLdouble | float,
    bottom: GLdouble | float,
    top: GLdouble | float,
    zNear: GLdouble | float,
    zFar: GLdouble | float,
) -> None: ...
...
def glGetActiveAtomicCounterBufferiv(
    program: GLuint | int,
    bufferIndex: GLuint | int,
    pname: GLenum | int,
    params: _Pointer[GLint] | Any,
) -> None: ...
def glGetActiveAttrib(
    program: GLuint | int,
    index: GLuint | int,
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    size: _Pointer[GLint] | Any,
    type: _Pointer[GLenum] | Any,
    name: _Pointer[GLchar] | Any,
) -> None: ...
def glGetActiveSubroutineName(
    program: GLuint | int,
    shadertype: GLenum | int,
    index: GLuint | int,
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    name: _Pointer[GLchar] | Any,
...
def glGetActiveUniformBlockName(
    program: GLuint | int,
    uniformBlockIndex: GLuint | int,
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    uniformBlockName: _Pointer[GLchar] | Any,
) -> None: ...
...
def glGetActiveUniformName(
    program: GLuint | int,
    uniformIndex: GLuint | int,
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    uniformName: _Pointer[GLchar] | Any,
) -> None: ...
def glGetActiveUniformsiv(
    program: GLuint | int,
    uniformCount: GLsizei | int,
    uniformIndices: _Pointer[GLuint] | Any,
    pname: GLenum | int,
    params: _Pointer[GLint] | Any,
) -> None: ...
def glGetAttachedShaders(
    program: GLuint | int,
    maxCount: GLsizei | int,
    count: _Pointer[GLsizei] | Any,
    shaders: _Pointer[GLuint] | Any,
) -> None: ...
def glGetAttribLocation(program: GLuint | int, name: _Pointer[GLchar] | Any) -> int: ...
def glGetBooleani_v(
    target: GLenum | int, index: GLuint | int, data: _Pointer[GLboolean] | Any
) -> None: ...
def glGetBooleanv(pname: GLenum | int, data: _Pointer[GLboolean] | Any) -> None: ...
def glGetBufferParameteri64v(
    target: GLenum | int, pname: GLenum | int, params: _Pointer[GLint64] | Any
) -> None: ...
def glGetBufferParameteriv(
    target: GLenum | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetBufferPointerv(
    target: GLenum | int, pname: GLenum | int, params: _Pointer[GLvoid] | Any
) -> None: ...
...
def glGetCompressedTexImage(
    target: GLenum | int, level: GLint | int, img: _Pointer[GLvoid] | Any
) -> None: ...
...
def glGetDebugMessageLog(
    count: GLuint | int,
    bufSize: GLsizei | int,
    sources: _Pointer[GLenum] | Any,
    types: _Pointer[GLenum] | Any,
    ids: _Pointer[GLuint] | Any,
    severities: _Pointer[GLenum] | Any,
    lengths: _Pointer[GLsizei] | Any,
    messageLog: _Pointer[GLchar] | Any,
) -> int: ...
def glGetDoublei_v(
    target: GLenum | int, index: GLuint | int, data: _Pointer[GLdouble] | Any
) -> None: ...
def glGetDoublev(pname: GLenum | int, data: _Pointer[GLdouble] | Any) -> None: ...
def glGetError() -> int: ...
def glGetFloati_v(
    target: GLenum | int, index: GLuint | int, data: _Pointer[GLfloat] | Any
) -> None: ...
...
def glGetFragDataLocation(
    program: GLuint | int, name: _Pointer[GLchar] | Any
) -> int: ...
...
def glGetInteger64i_v(
    target: GLenum | int, index: GLuint | int, data: _Pointer[GLint64] | Any
) -> None: ...
def glGetInteger64v(pname: GLenum | int, data: _Pointer[GLint64] | Any) -> None: ...
def glGetIntegeri_v(
    target: GLenum | int, index: GLuint | int, data: _Pointer[GLint] | Any
) -> None: ...
...
def glGetLightfv(
    light: GLenum | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
def glGetLightiv(
    light: GLenum | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetMapdv(
    target: GLenum | int, query: GLenum | int, v: _Pointer[GLdouble] | Any
) -> None: ...
def glGetMapfv(
    target: GLenum | int, query: GLenum | int, v: _Pointer[GLfloat] | Any
) -> None: ...
def glGetMapiv(
    target: GLenum | int, query: GLenum | int, v: _Pointer[GLint] | Any
) -> None: ...
def glGetMaterialfv(
    face: GLenum | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
def glGetMaterialiv(
    face: GLenum | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetMultisamplefv(
    pname: GLenum | int, index: GLuint | int, val: _Pointer[GLfloat] | Any
) -> None: ...
def glGetNamedBufferParameteri64v(
    buffer: GLuint | int, pname: GLenum | int, params: _Pointer[GLint64] | Any
) -> None: ...
def glGetNamedBufferParameteriv(
    buffer: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetNamedBufferPointerv(
    buffer: GLuint | int, pname: GLenum | int, params: _Pointer[GLvoid] | Any
) -> None: ...
...
def glGetNamedFramebufferParameteriv(
    framebuffer: GLuint | int, pname: GLenum | int, param: _Pointer[GLint] | Any
) -> None: ...
def glGetNamedRenderbufferParameteriv(
    renderbuffer: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetObjectLabel(
    identifier: GLenum | int,
    name: GLuint | int,
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    label: _Pointer[GLchar] | Any,
) -> None: ...
def glGetObjectPtrLabel(
    ptr: _Pointer[GLvoid] | Any,
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    label: _Pointer[GLchar] | Any,
) -> None: ...
...
def glGetProgramBinary(
    ...
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    binaryFormat: _Pointer[GLenum] | Any,
    binary: _Pointer[GLvoid] | Any,
) -> None: ...
def glGetProgramInfoLog(
    program: GLuint | int,
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    infoLog: _Pointer[GLchar] | Any,
) -> None: ...
def glGetProgramInterfaceiv(
    program: GLuint | int,
    programInterface: GLenum | int,
    pname: GLenum | int,
    params: _Pointer[GLint] | Any,
) -> None: ...
...
def glGetProgramPipelineiv(
    pipeline: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetProgramResourceIndex(
    program: GLuint | int, programInterface: GLenum | int, name: _Pointer[GLchar] | Any
) -> int: ...
...
def glGetProgramResourceiv(
    ...
    programInterface: GLenum | int,
    index: GLuint | int,
    propCount: GLsizei | int,
    props: _Pointer[GLenum] | Any,
    count: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    params: _Pointer[GLint] | Any,
) -> None: ...
...
def glGetProgramiv(
    program: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetQueryBufferObjecti64v(
    id: GLuint | int, buffer: GLuint | int, pname: GLenum | int, offset: GLintptr
) -> None: ...
...
def glGetQueryObjecti64v(
    id: GLuint | int, pname: GLenum | int, params: _Pointer[GLint64] | Any
) -> None: ...
def glGetQueryObjectiv(
    id: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetQueryObjectui64v(
    id: GLuint | int, pname: GLenum | int, params: _Pointer[GLuint64] | Any
) -> None: ...
def glGetQueryObjectuiv(
    id: GLuint | int, pname: GLenum | int, params: _Pointer[GLuint] | Any
) -> None: ...
def glGetQueryiv(
    target: GLenum | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
...
def glGetSamplerParameterIiv(
    sampler: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetSamplerParameterIuiv(
    sampler: GLuint | int, pname: GLenum | int, params: _Pointer[GLuint] | Any
) -> None: ...
def glGetSamplerParameterfv(
    sampler: GLuint | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
...
def glGetShaderPrecisionFormat(
    shadertype: GLenum | int,
    precisiontype: GLenum | int,
    range: _Pointer[GLint] | Any,
    precision: _Pointer[GLint] | Any,
) -> None: ...
def glGetShaderSource(
    shader: GLuint | int,
    bufSize: GLsizei | int,
    length: _Pointer[GLsizei] | Any,
    source: _Pointer[GLchar] | Any,
) -> None: ...
def glGetShaderiv(
    shader: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
...
def glGetSubroutineIndex(
    program: GLuint | int, shadertype: GLenum | int, name: _Pointer[GLchar] | Any
) -> int: ...
...
def glGetTexEnvfv(
    target: GLenum | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
def glGetTexEnviv(
    target: GLenum | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetTexGendv(
    coord: GLenum | int, pname: GLenum | int, params: _Pointer[GLdouble] | Any
) -> None: ...
def glGetTexGenfv(
    coord: GLenum | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
def glGetTexGeniv(
    coord: GLenum | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetTexImage(
    target: GLenum | int,
    level: GLint | int,
...
def glGetTexParameterIuiv(
    target: GLenum | int, pname: GLenum | int, params: _Pointer[GLuint] | Any
) -> None: ...
...
def glGetTextureParameterIiv(
    texture: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetTextureParameterIuiv(
    texture: GLuint | int, pname: GLenum | int, params: _Pointer[GLuint] | Any
) -> None: ...
def glGetTextureParameterfv(
    texture: GLuint | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
def glGetTextureParameteriv(
    texture: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetTextureSamplerHandleARB(
    texture: GLuint | int, sampler: GLuint | int
) -> int: ...
...
def glGetTransformFeedbacki64_v(
    ...
    pname: GLenum | int,
    index: GLuint | int,
    param: _Pointer[GLint64] | Any,
) -> None: ...
def glGetTransformFeedbacki_v(
    xfb: GLuint | int,
    pname: GLenum | int,
    index: GLuint | int,
    param: _Pointer[GLint] | Any,
) -> None: ...
def glGetTransformFeedbackiv(
    xfb: GLuint | int, pname: GLenum | int, param: _Pointer[GLint] | Any
) -> None: ...
def glGetUniformBlockIndex(
    program: GLuint | int, uniformBlockName: _Pointer[GLchar] | Any
) -> int: ...
def glGetUniformIndices(
    program: GLuint | int,
    uniformCount: GLsizei | int,
    uniformNames: _Pointer[_Pointer[GLchar]] | Any,
    uniformIndices: _Pointer[GLuint] | Any,
) -> None: ...
...
def glGetUniformSubroutineuiv(
    shadertype: GLenum | int, location: GLint | int, params: _Pointer[GLuint] | Any
) -> None: ...
def glGetUniformdv(
    program: GLuint | int, location: GLint | int, params: _Pointer[GLdouble] | Any
) -> None: ...
def glGetUniformfv(
    program: GLuint | int, location: GLint | int, params: _Pointer[GLfloat] | Any
) -> None: ...
def glGetUniformi64vARB(
    program: GLuint | int, location: GLint | int, params: _Pointer[GLint64] | Any
) -> None: ...
def glGetUniformiv(
    program: GLuint | int, location: GLint | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetUniformui64vARB(
    program: GLuint | int, location: GLint | int, params: _Pointer[GLuint64] | Any
) -> None: ...
def glGetUniformuiv(
    program: GLuint | int, location: GLint | int, params: _Pointer[GLuint] | Any
) -> None: ...
...
def glGetVertexArrayiv(
    vaobj: GLuint | int, pname: GLenum | int, param: _Pointer[GLint] | Any
) -> None: ...
def glGetVertexAttribIiv(
    index: GLuint | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
def glGetVertexAttribIuiv(
    index: GLuint | int, pname: GLenum | int, params: _Pointer[GLuint] | Any
) -> None: ...
def glGetVertexAttribLdv(
    index: GLuint | int, pname: GLenum | int, params: _Pointer[GLdouble] | Any
) -> None: ...
def glGetVertexAttribLui64vARB(
    index: GLuint | int, pname: GLenum | int, params: _Pointer[GLuint64EXT] | Any
) -> None: ...
def glGetVertexAttribPointerv(
    index: GLuint | int, pname: GLenum | int, pointer: _Pointer[GLvoid] | Any
) -> None: ...
def glGetVertexAttribdv(
    index: GLuint | int, pname: GLenum | int, params: _Pointer[GLdouble] | Any
) -> None: ...
def glGetVertexAttribfv(
    index: GLuint | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
...
def glGetnHistogram(
    ...
    type: GLenum | int,
    bufSize: GLsizei | int,
    values: _Pointer[GLvoid] | Any,
) -> None: ...
def glGetnMapdv(
    target: GLenum | int,
    query: GLenum | int,
    bufSize: GLsizei | int,
    v: _Pointer[GLdouble] | Any,
) -> None: ...
def glGetnMapfv(
    target: GLenum | int,
    query: GLenum | int,
    bufSize: GLsizei | int,
    v: _Pointer[GLfloat] | Any,
) -> None: ...
def glGetnMapiv(
    target: GLenum | int,
    query: GLenum | int,
    bufSize: GLsizei | int,
    v: _Pointer[GLint] | Any,
) -> None: ...
def glGetnMinmax(
    target: GLenum | int,
    reset: GLboolean | int,
...
def glGetnPixelMapfv(
    map: GLenum | int, bufSize: GLsizei | int, values: _Pointer[GLfloat] | Any
) -> None: ...
def glGetnPixelMapuiv(
    map: GLenum | int, bufSize: GLsizei | int, values: _Pointer[GLuint] | Any
) -> None: ...
def glGetnPixelMapusv(
    map: GLenum | int, bufSize: GLsizei | int, values: _Pointer[GLushort] | Any
) -> None: ...
def glGetnPolygonStipple(
    bufSize: GLsizei | int, pattern: _Pointer[GLubyte] | Any
) -> None: ...
def glGetnSeparableFilter(
    target: GLenum | int,
    format: GLenum | int,
    type: GLenum | int,
    rowBufSize: GLsizei | int,
    row: _Pointer[GLvoid] | Any,
    columnBufSize: GLsizei | int,
    column: _Pointer[GLvoid] | Any,
    span: _Pointer[GLvoid] | Any,
) -> None: ...
def glGetnTexImage(
    target: GLenum | int,
    level: GLint | int,
...
def glGetnUniformui64vARB(
    program: GLuint | int,
    location: GLint | int,
    bufSize: GLsizei | int,
    params: _Pointer[GLuint64] | Any,
) -> None: ...
def glGetnUniformuiv(
    program: GLuint | int,
    location: GLint | int,
    bufSize: GLsizei | int,
    params: _Pointer[GLuint] | Any,
) -> None: ...
...
def glInterleavedArrays(
    format: GLenum | int, stride: GLsizei | int, pointer: _Pointer[GLvoid] | Any
) -> None: ...
...
def glInvalidateFramebuffer(
    target: GLenum | int,
    numAttachments: GLsizei | int,
    attachments: _Pointer[GLenum] | Any,
) -> None: ...
...
def glLightf(
    light: GLenum | int, pname: GLenum | int, param: GLfloat | float
) -> None: ...
def glLightfv(
    light: GLenum | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
...
def glMakeImageHandleResidentARB(
    handle: GLuint64 | int, access: GLenum | int
) -> None: ...
...
def glMapBufferRange(
    target: GLenum | int, offset: GLintptr, length: GLsizeiptr, access: GLbitfield | int
) -> _Pointer[None]: ...
def glMapGrid1d(
    un: GLint | int, u1: GLdouble | float, u2: GLdouble | float
) -> None: ...
...
def glMapNamedBufferRange(
    buffer: GLuint | int, offset: GLintptr, length: GLsizeiptr, access: GLbitfield | int
) -> _Pointer[None]: ...
def glMaterialf(
    face: GLenum | int, pname: GLenum | int, param: GLfloat | float
) -> None: ...
def glMaterialfv(
    face: GLenum | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
def glMateriali(
    face: GLenum | int, pname: GLenum | int, param: GLint | int
) -> None: ...
def glMaterialiv(
    face: GLenum | int, pname: GLenum | int, params: _Pointer[GLint] | Any
) -> None: ...
...
def glMultiDrawArrays(
    mode: GLenum | int,
    first: _Pointer[GLint] | Any,
    count: _Pointer[GLsizei] | Any,
    drawcount: GLsizei | int,
) -> None: ...
def glMultiDrawArraysIndirect(
    mode: GLenum | int,
    indirect: _Pointer[GLvoid] | Any,
    drawcount: GLsizei | int,
    stride: GLsizei | int,
) -> None: ...
...
def glMultiDrawMeshTasksIndirectCountNV(
    indirect: GLintptr,
    drawcount: GLintptr,
    maxdrawcount: GLsizei | int,
    stride: GLsizei | int,
) -> None: ...
def glMultiDrawMeshTasksIndirectNV(
    indirect: GLintptr, drawcount: GLsizei | int, stride: GLsizei | int
) -> None: ...
...
def glMultiTexCoord2d(
    target: GLenum | int, s: GLdouble | float, t: GLdouble | float
) -> None: ...
def glMultiTexCoord2dv(target: GLenum | int, v: _Pointer[GLdouble] | Any) -> None: ...
def glMultiTexCoord2f(
    target: GLenum | int, s: GLfloat | float, t: GLfloat | float
) -> None: ...
...
def glMultiTexCoord4i(
    target: GLenum | int, s: GLint | int, t: GLint | int, r: GLint | int, q: GLint | int
) -> None: ...
...
def glMultiTexCoordP1ui(
    texture: GLenum | int, type: GLenum | int, coords: GLuint | int
) -> None: ...
def glMultiTexCoordP1uiv(
    texture: GLenum | int, type: GLenum | int, coords: _Pointer[GLuint] | Any
) -> None: ...
...
def glNamedFramebufferDrawBuffer(
    framebuffer: GLuint | int, buf: GLenum | int
) -> None: ...
def glNamedFramebufferDrawBuffers(
    framebuffer: GLuint | int, n: GLsizei | int, bufs: _Pointer[GLenum] | Any
) -> None: ...
def glNamedFramebufferParameteri(
    framebuffer: GLuint | int, pname: GLenum | int, param: GLint | int
) -> None: ...
def glNamedFramebufferReadBuffer(
    framebuffer: GLuint | int, src: GLenum | int
) -> None: ...
...
def glNormal3d(
    nx: GLdouble | float, ny: GLdouble | float, nz: GLdouble | float
) -> None: ...
def glNormal3dv(v: _Pointer[GLdouble] | Any) -> None: ...
def glNormal3f(
    nx: GLfloat | float, ny: GLfloat | float, nz: GLfloat | float
) -> None: ...
...
def glObjectPtrLabel(
    ptr: _Pointer[GLvoid] | Any, length: GLsizei | int, label: _Pointer[GLchar] | Any
) -> None: ...
def glOrtho(
    left: GLdouble | float,
    right: GLdouble | float,
...
def glPatchParameterfv(
    pname: GLenum | int, values: _Pointer[GLfloat] | Any
) -> None: ...
def glPatchParameteri(pname: GLenum | int, value: GLint | int) -> None: ...
def glPauseTransformFeedback() -> None: ...
def glPixelMapfv(
    map: GLenum | int, mapsize: GLsizei | int, values: _Pointer[GLfloat] | Any
) -> None: ...
def glPixelMapuiv(
    map: GLenum | int, mapsize: GLsizei | int, values: _Pointer[GLuint] | Any
) -> None: ...
def glPixelMapusv(
    map: GLenum | int, mapsize: GLsizei | int, values: _Pointer[GLushort] | Any
) -> None: ...
...
def glPointParameterfv(
    pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
...
def glPolygonOffsetClamp(
    factor: GLfloat | float, units: GLfloat | float, clamp: GLfloat | float
) -> None: ...
...
def glPrioritizeTextures(
    n: GLsizei | int,
    textures: _Pointer[GLuint] | Any,
    priorities: _Pointer[GLfloat] | Any,
) -> None: ...
def glProgramBinary(
    program: GLuint | int,
    binaryFormat: GLenum | int,
    binary: _Pointer[GLvoid] | Any,
    length: GLsizei | int,
) -> None: ...
def glProgramParameteri(
    program: GLuint | int, pname: GLenum | int, value: GLint | int
) -> None: ...
def glProgramUniform1d(
    program: GLuint | int, location: GLint | int, v0: GLdouble | float
) -> None: ...
def glProgramUniform1dv(
    program: GLuint | int,
    location: GLint | int,
    count: GLsizei | int,
    value: _Pointer[GLdouble] | Any,
) -> None: ...
def glProgramUniform1f(
    program: GLuint | int, location: GLint | int, v0: GLfloat | float
) -> None: ...
...
def glProgramUniform1i(
    program: GLuint | int, location: GLint | int, v0: GLint | int
) -> None: ...
def glProgramUniform1i64ARB(
    program: GLuint | int, location: GLint | int, x: GLint64 | int
) -> None: ...
def glProgramUniform1i64vARB(
    program: GLuint | int,
    location: GLint | int,
    count: GLsizei | int,
    value: _Pointer[GLint64] | Any,
) -> None: ...
...
def glProgramUniform1ui(
    program: GLuint | int, location: GLint | int, v0: GLuint | int
) -> None: ...
def glProgramUniform1ui64ARB(
    program: GLuint | int, location: GLint | int, x: GLuint64 | int
) -> None: ...
def glProgramUniform1ui64vARB(
    program: GLuint | int,
    location: GLint | int,
    count: GLsizei | int,
    value: _Pointer[GLuint64] | Any,
) -> None: ...
...
def glProgramUniform2i(
    program: GLuint | int, location: GLint | int, v0: GLint | int, v1: GLint | int
) -> None: ...
def glProgramUniform2i64ARB(
    program: GLuint | int, location: GLint | int, x: GLint64 | int, y: GLint64 | int
) -> None: ...
...
def glProgramUniform2ui(
    program: GLuint | int, location: GLint | int, v0: GLuint | int, v1: GLuint | int
) -> None: ...
def glProgramUniform2ui64ARB(
    program: GLuint | int, location: GLint | int, x: GLuint64 | int, y: GLuint64 | int
) -> None: ...
def glProgramUniform2ui64vARB(
    program: GLuint | int,
    location: GLint | int,
    count: GLsizei | int,
    value: _Pointer[GLuint64] | Any,
...
def glProgramUniformHandleui64ARB(
    program: GLuint | int, location: GLint | int, value: GLuint64 | int
) -> None: ...
def glProgramUniformHandleui64vARB(
    program: GLuint | int,
    location: GLint | int,
    count: GLsizei | int,
    values: _Pointer[GLuint64] | Any,
) -> None: ...
def glProgramUniformMatrix2dv(
    program: GLuint | int,
    location: GLint | int,
    count: GLsizei | int,
    transpose: GLboolean | int,
    value: _Pointer[GLdouble] | Any,
) -> None: ...
...
def glRasterPos3d(
    x: GLdouble | float, y: GLdouble | float, z: GLdouble | float
) -> None: ...
def glRasterPos3dv(v: _Pointer[GLdouble] | Any) -> None: ...
def glRasterPos3f(
    x: GLfloat | float, y: GLfloat | float, z: GLfloat | float
) -> None: ...
...
def glRasterPos4d(
    x: GLdouble | float, y: GLdouble | float, z: GLdouble | float, w: GLdouble | float
) -> None: ...
def glRasterPos4dv(v: _Pointer[GLdouble] | Any) -> None: ...
def glRasterPos4f(
    x: GLfloat | float, y: GLfloat | float, z: GLfloat | float, w: GLfloat | float
) -> None: ...
def glRasterPos4fv(v: _Pointer[GLfloat] | Any) -> None: ...
def glRasterPos4i(
    x: GLint | int, y: GLint | int, z: GLint | int, w: GLint | int
) -> None: ...
def glRasterPos4iv(v: _Pointer[GLint] | Any) -> None: ...
def glRasterPos4s(
    x: GLshort | int, y: GLshort | int, z: GLshort | int, w: GLshort | int
) -> None: ...
...
def glRectf(
    x1: GLfloat | float, y1: GLfloat | float, x2: GLfloat | float, y2: GLfloat | float
) -> None: ...
def glRectfv(v1: _Pointer[GLfloat] | Any, v2: _Pointer[GLfloat] | Any) -> None: ...
def glRecti(
    x1: GLint | int, y1: GLint | int, x2: GLint | int, y2: GLint | int
) -> None: ...
def glRectiv(v1: _Pointer[GLint] | Any, v2: _Pointer[GLint] | Any) -> None: ...
def glRects(
    x1: GLshort | int, y1: GLshort | int, x2: GLshort | int, y2: GLshort | int
) -> None: ...
...
def glRotated(
    angle: GLdouble | float,
    x: GLdouble | float,
    y: GLdouble | float,
    z: GLdouble | float,
) -> None: ...
def glRotatef(
    angle: GLfloat | float, x: GLfloat | float, y: GLfloat | float, z: GLfloat | float
) -> None: ...
...
def glSamplerParameterIiv(
    sampler: GLuint | int, pname: GLenum | int, param: _Pointer[GLint] | Any
) -> None: ...
def glSamplerParameterIuiv(
    sampler: GLuint | int, pname: GLenum | int, param: _Pointer[GLuint] | Any
) -> None: ...
def glSamplerParameterf(
    sampler: GLuint | int, pname: GLenum | int, param: GLfloat | float
) -> None: ...
def glSamplerParameterfv(
    sampler: GLuint | int, pname: GLenum | int, param: _Pointer[GLfloat] | Any
) -> None: ...
def glSamplerParameteri(
    sampler: GLuint | int, pname: GLenum | int, param: GLint | int
) -> None: ...
...
def glScissor(
    x: GLint | int, y: GLint | int, width: GLsizei | int, height: GLsizei | int
) -> None: ...
def glScissorArrayv(
    first: GLuint | int, count: GLsizei | int, v: _Pointer[GLint] | Any
) -> None: ...
...
def glSecondaryColor3i(
    red: GLint | int, green: GLint | int, blue: GLint | int
) -> None: ...
def glSecondaryColor3iv(v: _Pointer[GLint] | Any) -> None: ...
def glSecondaryColor3s(
    red: GLshort | int, green: GLshort | int, blue: GLshort | int
) -> None: ...
def glSecondaryColor3sv(v: _Pointer[GLshort] | Any) -> None: ...
def glSecondaryColor3ub(
    red: GLubyte | int, green: GLubyte | int, blue: GLubyte | int
) -> None: ...
def glSecondaryColor3ubv(v: _Pointer[GLubyte] | Any) -> None: ...
def glSecondaryColor3ui(
    red: GLuint | int, green: GLuint | int, blue: GLuint | int
) -> None: ...
...
def glSecondaryColorP3uiv(
    type: GLenum | int, color: _Pointer[GLuint] | Any
) -> None: ...
...
def glShaderSource(
    shader: GLuint | int,
    count: GLsizei | int,
    string: _Pointer[_Pointer[GLchar]] | Any,
    length: _Pointer[GLint] | Any,
) -> None: ...
def glShaderStorageBlockBinding(
    program: GLuint | int,
    storageBlockIndex: GLuint | int,
    storageBlockBinding: GLuint | int,
) -> None: ...
def glSpecializeShader(
    shader: GLuint | int,
    pEntryPoint: _Pointer[GLchar] | Any,
    numSpecializationConstants: GLuint | int,
    pConstantIndex: _Pointer[GLuint] | Any,
    pConstantValue: _Pointer[GLuint] | Any,
) -> None: ...
def glStencilFunc(func: GLenum | int, ref: GLint | int, mask: GLuint | int) -> None: ...
def glStencilFuncSeparate(
    face: GLenum | int, func: GLenum | int, ref: GLint | int, mask: GLuint | int
) -> None: ...
def glStencilMask(mask: GLuint | int) -> None: ...
def glStencilMaskSeparate(face: GLenum | int, mask: GLuint | int) -> None: ...
def glStencilOp(
    fail: GLenum | int, zfail: GLenum | int, zpass: GLenum | int
) -> None: ...
def glStencilOpSeparate(
    face: GLenum | int, sfail: GLenum | int, dpfail: GLenum | int, dppass: GLenum | int
) -> None: ...
def glTexBuffer(
    target: GLenum | int, internalformat: GLenum | int, buffer: GLuint | int
) -> None: ...
...
def glTexCoord3d(
    s: GLdouble | float, t: GLdouble | float, r: GLdouble | float
) -> None: ...
def glTexCoord3dv(v: _Pointer[GLdouble] | Any) -> None: ...
def glTexCoord3f(
    s: GLfloat | float, t: GLfloat | float, r: GLfloat | float
) -> None: ...
...
def glTexCoord4d(
    s: GLdouble | float, t: GLdouble | float, r: GLdouble | float, q: GLdouble | float
) -> None: ...
def glTexCoord4dv(v: _Pointer[GLdouble] | Any) -> None: ...
def glTexCoord4f(
    s: GLfloat | float, t: GLfloat | float, r: GLfloat | float, q: GLfloat | float
) -> None: ...
def glTexCoord4fv(v: _Pointer[GLfloat] | Any) -> None: ...
def glTexCoord4i(
    s: GLint | int, t: GLint | int, r: GLint | int, q: GLint | int
) -> None: ...
def glTexCoord4iv(v: _Pointer[GLint] | Any) -> None: ...
def glTexCoord4s(
    s: GLshort | int, t: GLshort | int, r: GLshort | int, q: GLshort | int
) -> None: ...
...
def glTexEnvf(
    target: GLenum | int, pname: GLenum | int, param: GLfloat | float
) -> None: ...
def glTexEnvfv(
    target: GLenum | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
...
def glTexGend(
    coord: GLenum | int, pname: GLenum | int, param: GLdouble | float
) -> None: ...
def glTexGendv(
    coord: GLenum | int, pname: GLenum | int, params: _Pointer[GLdouble] | Any
) -> None: ...
def glTexGenf(
    coord: GLenum | int, pname: GLenum | int, param: GLfloat | float
) -> None: ...
def glTexGenfv(
    coord: GLenum | int, pname: GLenum | int, params: _Pointer[GLfloat] | Any
) -> None: ...
...
def glTexImage2DMultisample(
    ...
    width: GLsizei | int,
    height: GLsizei | int,
    fixedsamplelocations: GLboolean | int,
) -> None: ...
def glTexImage3D(
    target: GLenum | int,
    level: GLint | int,
...
def glTextureBuffer(
    texture: GLuint | int, internalformat: GLenum | int, buffer: GLuint | int
) -> None: ...
...
def glTextureParameterf(
    texture: GLuint | int, pname: GLenum | int, param: GLfloat | float
) -> None: ...
def glTextureParameterfv(
    texture: GLuint | int, pname: GLenum | int, param: _Pointer[GLfloat] | Any
) -> None: ...
def glTextureParameteri(
    texture: GLuint | int, pname: GLenum | int, param: GLint | int
) -> None: ...
def glTextureParameteriv(
    texture: GLuint | int, pname: GLenum | int, param: _Pointer[GLint] | Any
) -> None: ...
...
def glTextureView(
    texture: GLuint | int,
    target: GLenum | int,
    origtexture: GLuint | int,
    internalformat: GLenum | int,
    minlevel: GLuint | int,
    numlevels: GLuint | int,
    minlayer: GLuint | int,
    numlayers: GLuint | int,
) -> None: ...
def glTransformFeedbackBufferBase(
    xfb: GLuint | int, index: GLuint | int, buffer: GLuint | int
) -> None: ...
...
def glTransformFeedbackVaryings(
    program: GLuint | int,
    count: GLsizei | int,
    varyings: _Pointer[_Pointer[GLchar]] | Any,
    bufferMode: GLenum | int,
) -> None: ...
def glTranslated(
    x: GLdouble | float, y: GLdouble | float, z: GLdouble | float
) -> None: ...
...
def glUniform1dv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLdouble] | Any
) -> None: ...
def glUniform1f(location: GLint | int, v0: GLfloat | float) -> None: ...
def glUniform1fv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLfloat] | Any
) -> None: ...
def glUniform1i(location: GLint | int, v0: GLint | int) -> None: ...
def glUniform1i64ARB(location: GLint | int, x: GLint64 | int) -> None: ...
def glUniform1i64vARB(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLint64] | Any
) -> None: ...
def glUniform1iv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLint] | Any
) -> None: ...
def glUniform1ui(location: GLint | int, v0: GLuint | int) -> None: ...
def glUniform1ui64ARB(location: GLint | int, x: GLuint64 | int) -> None: ...
def glUniform1ui64vARB(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLuint64] | Any
) -> None: ...
def glUniform1uiv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLuint] | Any
) -> None: ...
def glUniform2d(
    location: GLint | int, x: GLdouble | float, y: GLdouble | float
) -> None: ...
def glUniform2dv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLdouble] | Any
) -> None: ...
def glUniform2f(
    location: GLint | int, v0: GLfloat | float, v1: GLfloat | float
) -> None: ...
def glUniform2fv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLfloat] | Any
) -> None: ...
def glUniform2i(location: GLint | int, v0: GLint | int, v1: GLint | int) -> None: ...
def glUniform2i64ARB(
    location: GLint | int, x: GLint64 | int, y: GLint64 | int
) -> None: ...
...
def glUniform2ui64ARB(
    location: GLint | int, x: GLuint64 | int, y: GLuint64 | int
) -> None: ...
def glUniform2ui64vARB(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLuint64] | Any
) -> None: ...
def glUniform2uiv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLuint] | Any
...
def glUniform3d(
    location: GLint | int, x: GLdouble | float, y: GLdouble | float, z: GLdouble | float
) -> None: ...
def glUniform3dv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLdouble] | Any
) -> None: ...
def glUniform3f(
    location: GLint | int, v0: GLfloat | float, v1: GLfloat | float, v2: GLfloat | float
) -> None: ...
def glUniform3fv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLfloat] | Any
) -> None: ...
def glUniform3i(
    location: GLint | int, v0: GLint | int, v1: GLint | int, v2: GLint | int
) -> None: ...
def glUniform3i64ARB(
    location: GLint | int, x: GLint64 | int, y: GLint64 | int, z: GLint64 | int
) -> None: ...
...
def glUniform3ui(
    location: GLint | int, v0: GLuint | int, v1: GLuint | int, v2: GLuint | int
) -> None: ...
def glUniform3ui64ARB(
    location: GLint | int, x: GLuint64 | int, y: GLuint64 | int, z: GLuint64 | int
) -> None: ...
def glUniform3ui64vARB(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLuint64] | Any
) -> None: ...
def glUniform3uiv(
    location: GLint | int, count: GLsizei | int, value: _Pointer[GLuint] | Any
...
def glUniformSubroutinesuiv(
    shadertype: GLenum | int, count: GLsizei | int, indices: _Pointer[GLuint] | Any
) -> None: ...
...
def glUseProgramStages(
    pipeline: GLuint | int, stages: GLbitfield | int, program: GLuint | int
) -> None: ...
...
def glVertexArrayAttribBinding(
    vaobj: GLuint | int, attribindex: GLuint | int, bindingindex: GLuint | int
) -> None: ...
def glVertexArrayAttribFormat(
    vaobj: GLuint | int,
    attribindex: GLuint | int,
    size: GLint | int,
    type: GLenum | int,
    normalized: GLboolean | int,
    relativeoffset: GLuint | int,
) -> None: ...
...
def glVertexArrayBindingDivisor(
    vaobj: GLuint | int, bindingindex: GLuint | int, divisor: GLuint | int
) -> None: ...
...
def glVertexAttribBinding(
    attribindex: GLuint | int, bindingindex: GLuint | int
) -> None: ...
...
def glVertexAttribI4i(
    index: GLuint | int, x: GLint | int, y: GLint | int, z: GLint | int, w: GLint | int
) -> None: ...
...
def glVertexAttribL1ui64vARB(
    index: GLuint | int, v: _Pointer[GLuint64EXT] | Any
) -> None: ...
...
def glVertexBindingDivisor(
    bindingindex: GLuint | int, divisor: GLuint | int
) -> None: ...
...
def glViewportArrayv(
    first: GLuint | int, count: GLsizei | int, v: _Pointer[GLfloat] | Any
) -> None: ...
