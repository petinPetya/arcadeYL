...
wglUseFontBitmapsA = _link_function(
    "wglUseFontBitmapsA", BOOL, [HDC, DWORD, DWORD, DWORD], None
)
wglUseFontBitmapsW = _link_function(
    "wglUseFontBitmapsW", BOOL, [HDC, DWORD, DWORD, DWORD], None
)
...
wglUseFontOutlinesA = _link_function(
    "wglUseFontOutlinesA",
    BOOL,
    [HDC, DWORD, DWORD, DWORD, FLOAT, FLOAT, c_int, LPGLYPHMETRICSFLOAT],
    None,
)
wglUseFontOutlinesW = _link_function(
    "wglUseFontOutlinesW",
    BOOL,
    [HDC, DWORD, DWORD, DWORD, FLOAT, FLOAT, c_int, LPGLYPHMETRICSFLOAT],
    None,
...
wglDescribeLayerPlane = _link_function(
    "wglDescribeLayerPlane",
    BOOL,
    [HDC, c_int, c_int, UINT, LPLAYERPLANEDESCRIPTOR],
    None,
)
wglSetLayerPaletteEntries = _link_function(
    "wglSetLayerPaletteEntries",
    c_int,
    [HDC, c_int, c_int, c_int, POINTER(COLORREF)],
    None,
)
wglGetLayerPaletteEntries = _link_function(
    "wglGetLayerPaletteEntries",
    c_int,
    [HDC, c_int, c_int, c_int, POINTER(COLORREF)],
    None,
)
wglRealizeLayerPalette = _link_function(
    "wglRealizeLayerPalette", BOOL, [HDC, c_int, BOOL], None
)
...
wglSwapMultipleBuffers = _link_function(
    "wglSwapMultipleBuffers", DWORD, [UINT, POINTER(WGLSWAP)], None
)
