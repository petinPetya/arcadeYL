...
class Cube(Model):
    ...
    def __init__(
        ...
        self._group = pyglet.model.MaterialGroup(
            material=self._material, program=self._program, parent=group
        )
    ...
    def _create_vertexlist(self):
        ...
        vertices = [
            -w,
            -h,
            -d,  # front, bottom-left    0
            w,
            -h,
            -d,  # front, bottom-right   1
            w,
            h,
            -d,  # front, top-right      2         Front
            -w,
            h,
            -d,  # front, top-left       3
            w,
            -h,
            d,  # back, bottom-right    4
            -w,
            -h,
            d,  # back, bottom-left     5
            -w,
            h,
            d,  # back, top-left        6         Back
            w,
            h,
            d,  # back, top-right       7
            w,
            -h,
            -d,  # front, bottom-right   8
            w,
            -h,
            d,  # back, bottom-right    9
            w,
            h,
            d,  # back, top-right      10         Right
            w,
            h,
            -d,  # front, top-right     11
            -w,
            -h,
            d,  # back, bottom-left    12
            -w,
            -h,
            -d,  # front, bottom-left   13
            -w,
            h,
            -d,  # front, top-left      14         Left
            -w,
            h,
            d,  # back, top-left       15
            -w,
            ...
            w,
            h,
            -d,  # front, top-right     17
            w,
            h,
            d,  # back, top-right      18         Top
            -w,
            h,
            d,  # back, top-left       19
            -w,
            -h,
            d,  # back, bottom-left    20
            w,
            -h,
            d,  # back, bottom-right   21
            w,
            -h,
            -d,  # front, bottom-right  22         Bottom
            -w,
            -h,
            -d,  # front, bottom-left   23
        ]
