...
def _new_mesh(name, material):
    ...
    primitive = Primitive(
        attributes=attributes, indices=None, material=material, mode=GL_TRIANGLES
    )
    ...
    def create_models(self, batch: Batch, group: Group | None = None) -> list[Model]:
        ...
        for node in self.nodes:
            for mesh in node.meshes:
                ...
                vertex_lists.append(
                    program.vertex_list(count, GL_TRIANGLES, batch, matgroup, **data)
                )
