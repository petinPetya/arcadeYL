...
mp_events = {
    ...
    "p.P.ut.1.0": {
        ...
        "other_fields": [],
        "test_cases": [
            ("p.P.ut.1.0", 0.02, 2.31, 2.28, 1.21),
...
class CountBads:
    ...
    def preprocessing(self, recorded_events):
        ...
        if (
            len(recorded_events) > 9
            and recorded_events[-2][0] == "p.P.ut.1.7"
            and recorded_events[-6][0] == "p.P.ut.1.7"
            and recorded_events[-10][0] == "p.P.ut.1.7"
        ):
    ...
    def count_bads(self, recorded_events):
        ...
        for st in mp_states:
            ...
            if evname in counters:
                ...
                "p.P.ut.1.9"
                and st["rescheduling_time"] is not None
                and st["rescheduling_time"] < 0
            ):
