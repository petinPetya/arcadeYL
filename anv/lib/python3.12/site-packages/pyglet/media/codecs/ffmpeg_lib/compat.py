...
def add_version_changes(
    library, version, structure, fields, removals, repositions=None
):
    ...
    if structure in _version_changes[library][version]:
        raise Exception(
            "Structure: {} from: {} has already been added for version {}.".format(
                structure, library, version
            )
        )

    _version_changes[library][version][structure] = CustomField(
        fields, removals, repositions
    )
                    ...
                    if cf_data.repositions:
                        for reposition in cf_data.repositions:
                            ...
                            if data and insertId:
                                ...
                                print(
                                    f"Warning: {reposition} for {library} was not able to be processed."
                                )
