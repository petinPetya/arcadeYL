...
class AVPacketSideData(Structure):
    _fields_ = [("data", POINTER(c_uint8)), ("size", c_int), ("type", c_int)]
...
if avcodec_version >= 61:
    AVCodecContext_Fields = [
        ...
        (
            "get_encode_buffer",
            CFUNCTYPE(c_int, POINTER(AVCodecContext), POINTER(AVPacket), c_int),
        ),
        ("frame_num", c_int64),
    ...
    compat.add_version_changes(
        "avcodec", 61, AVCodecContext, AVCodecContext_Fields, removals=None
    )
    ...
    AVCodecContext_Fields = [
        ...
        (
            "get_buffer2",
            CFUNCTYPE(c_int, POINTER(AVCodecContext), POINTER(AVFrame), c_int),
        ),
    ...
    compat.add_version_changes(
        "avcodec", 58, AVCodecContext, AVCodecContext_Fields, removals=None
    )
...
avcodec.avcodec_open2.argtypes = [
    POINTER(AVCodecContext),
    POINTER(AVCodec),
...
avcodec.avcodec_parameters_to_context.argtypes = [
    POINTER(AVCodecContext),
