...
from pyglet.libs.darwin.coreaudio import (
...
class CoreAudioSource(StreamingSource):
    def __init__(self, filename, file=None):
        ...
        if file is None:
            ...
            url_ref = cf.CFURLCreateWithFileSystemPath(
                None, fn_str, kCFURLPOSIXPathStyle, False
            )
            ...
            err_check(
                ca.AudioFileOpenWithCallbacks(
                    None,
                    self.file_obj.read_func,
                    None,
                    self.file_obj.getsize_func,
                    None,
                    0,
                    byref(self._audfile),
                )
            ...
            err_check(
                ca.ExtAudioFileWrapAudioFileID(self._audfile, False, byref(audref))
            )
        ...
        self.audio_format = AudioFormat(
            channels=self.convert_desc.mChannelsPerFrame,
    ...
    def convert_format(original_desc, bitdepth=16):
        ...
        adesc.mBytesPerPacket = (
            original_desc.mChannelsPerFrame * adesc.mBitsPerChannel // 8
        )
