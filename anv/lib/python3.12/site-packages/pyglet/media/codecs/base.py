...
class Source:
    ...
    def save(
        ...
        encoder: Optional["MediaEncoder"] = None,
    ) -> None:
    ...
    def get_audio_data(
        self, num_bytes: int, compensation_time=0.0
    ) -> Optional[AudioData]:
...
class StaticSource(Source):
    ...
    def get_audio_data(
        self, num_bytes: float, compensation_time: float = 0.0
    ) -> Optional[AudioData]:
...
class SourceGroup:
    ...
    def add(self, source: Source) -> None:
        ...
        source = source.get_queue_source()
        assert (
            source.audio_format == self.audio_format
    ...
    def get_audio_data(
        self, num_bytes: float, compensation_time=0.0
    ) -> Optional[AudioData]:
