...
class FlatEnvelope(Envelope):
    ...
    def get_generator(
        self, sample_rate: float = None, duration: float = None
    ) -> Generator[float]:
...
def pulse_generator(
    frequency: float, sample_rate: float, duty_cycle: float = 50.0
) -> Generator[float]:
    period_length = int(sample_rate / frequency)
...
class SynthesisSource(Source):
    ...
    def __init__(
        ...
        self.audio_format = AudioFormat(
            channels=1, sample_size=16, sample_rate=sample_rate
        )
    ...
    def seek(self, timestamp: float) -> None:
        ...
        self._envelope_generator = self._envelope.get_generator(
            self.audio_format.sample_rate, self._duration
        )
...
class Silence(SynthesisSource):
    def __init__(
        ...
        super().__init__(
            silence_generator(frequency, sample_rate), duration, sample_rate, envelope
        )
...
class WhiteNoise(SynthesisSource):
    def __init__(
        ...
        super().__init__(
            noise_generator(frequency, sample_rate), duration, sample_rate, envelope
        )
...
class Sine(SynthesisSource):
    def __init__(
        ...
        super().__init__(
            sine_generator(frequency, sample_rate), duration, sample_rate, envelope
        )
...
class Square(SynthesisSource):
    def __init__(
        ...
        super().__init__(
            pulse_generator(frequency, sample_rate), duration, sample_rate, envelope
        )
...
class Triangle(SynthesisSource):
    def __init__(
        ...
        super().__init__(
            triangle_generator(frequency, sample_rate), duration, sample_rate, envelope
        )
...
class Sawtooth(SynthesisSource):
    def __init__(
        ...
        super().__init__(
            sawtooth_generator(frequency, sample_rate), duration, sample_rate, envelope
        )
