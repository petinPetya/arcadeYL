...
class PygletTextView_Implementation:
    ...
    @PygletTextView.method("v@")
    def scrollToBeginningOfDocument_(
        self, sender: ObjCInstance
    ) -> None:  # Mac OS X 10.6
    ...
    @PygletTextView.method("v@")
    def moveToBeginningOfLineAndModifySelection_(
        self, sender: ObjCInstance
    ) -> None:  # Mac OS X 10.6
        self._window.dispatch_event(
            "on_text_motion_select", key.MOTION_BEGINNING_OF_LINE
        )

    @PygletTextView.method("v@")
    def moveToEndOfLineAndModifySelection_(
        self, sender: ObjCInstance
    ) -> None:  # Mac OS X 10.6
    ...
    @PygletTextView.method("v@")
    def pageDownAndModifySelection_(
        self, sender: ObjCInstance
    ) -> None:  # Mac OS X 10.6
        self._window.dispatch_event("on_text_motion_select", key.MOTION_NEXT_PAGE)

    @PygletTextView.method("v@")
    def moveToBeginningOfDocumentAndModifySelection_(
        self, sender: ObjCInstance
    ) -> None:  # Mac OS X 10.6
        self._window.dispatch_event(
            "on_text_motion_select", key.MOTION_BEGINNING_OF_FILE
        )

    @PygletTextView.method("v@")
    def moveToEndOfDocumentAndModifySelection_(
        self, sender: ObjCInstance
    ) -> None:  # Mac OS X 10.6
