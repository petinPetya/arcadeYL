...
NSBackingPropertyOldScaleFactorKey = c_void_p.in_dll(
    appkit, "NSBackingPropertyOldScaleFactorKey"
)
...
class PygletDelegate_Implementation:
    ...
    def windowDidChangeBackingProperties_(self, notification):
        if not self._window._shadow:
            ...
            old_scale_value = user_info.objectForKey_(
            ...
            if old_scale != new_scale:
                ...
                self._window.dispatch_event(
                    "_on_internal_scale", new_scale, self._window._get_dpi_desc()
                )
