...
def getMousePosition(
    self: PygletView_Implementation | cocoapy.ObjCInstance,
    nsevent: cocoapy.ObjCInstance,
) -> tuple[int, int]:
...
class PygletView_Implementation:
    ...
    def initWithFrame_cocoaWindow_(
        self, frame: cocoapy.NSRect, window: CocoaWindow
    ) -> cocoapy.ObjCInstance | None:
        ...
        self = cocoapy.ObjCInstance(
            cocoapy.send_super(self, "initWithFrame:", frame, argtypes=[cocoapy.NSRect])
        )
    ...
    def updateTrackingAreas(self) -> None:
        ...
        tracking_options = (
            cocoapy.NSTrackingMouseEnteredAndExited
            | cocoapy.NSTrackingActiveInActiveApp
            | cocoapy.NSTrackingCursorUpdate
            | cocoapy.NSTrackingInVisibleRect
        )
        frame = self.frame()
        tracking_area = NSTrackingArea.alloc().initWithRect_options_owner_userInfo_(
            frame, tracking_options, self, None  # rect  # options  # owner
        )  # userInfo
