...
class CocoaWindow(BaseWindow):
    ...
    def _create(self) -> None:
        with AutoReleasePool():
            ...
            self._nswindow = (
                WindowClass.alloc().initWithContentRect_styleMask_backing_defer_(
                    content_rect,  # contentRect
                    style_mask,  # styleMask
    ...
    def _get_dpi_desc(self) -> int:
        if (
            pyglet.options.dpi_scaling in ("scaled", "stretch", "platform")
            and self._nswindow
        ):
    ...
    def _set_nice_window_location(self) -> None:
        ...
        visible_windows = [
            ...
            if win is not self
            and win._nswindow  # noqa: SLF001
            and win._nswindow.isVisible()
        ]  # noqa: SLF001
        ...
        # Otherwise, cascade from last window in list.
            ...
            point = visible_windows[-1]._nswindow.cascadeTopLeftFromPoint_(
                cocoapy.NSZeroPoint
            )  # noqa: SLF001
    ...
    def get_system_mouse_cursor(
        self, name: str
    ) -> DefaultMouseCursor | CocoaMouseCursor:
    ...
    def set_exclusive_keyboard(self, exclusive: bool = True) -> None:
        ...
        if exclusive:
            ...
            options = (
                cocoapy.NSApplicationPresentationHideDock
