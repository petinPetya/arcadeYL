...
class WindowEventLogger:
    ...
    def on_key_press(self, symbol: int, modifiers: int) -> None:
        print(
            f"on_key_press(symbol={key.symbol_string(symbol)}, modifiers={key.modifiers_string(modifiers)})",
            file=self.file,
        )

    def on_key_release(self, symbol: int, modifiers: int) -> None:
        print(
            f"on_key_release(symbol={key.symbol_string(symbol)}, modifiers={key.modifiers_string(modifiers)})",
            file=self.file,
        )
    ...
    def on_text_motion_select(self, motion: int) -> None:
        print(
            f"on_text_motion_select(motion={key.motion_string(motion)})", file=self.file
        )
    ...
    def on_mouse_scroll(self, x: int, y: int, scroll_x: float, scroll_y: float) -> None:
        print(
            f"on_mouse_scroll(x={x}, y={y}, scroll_x={scroll_x}, scroll_y={scroll_y})",
            file=self.file,
        )
