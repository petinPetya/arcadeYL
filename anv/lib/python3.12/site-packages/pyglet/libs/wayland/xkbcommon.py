...
struct_xkb_context._fields_ = [("_opaque_struct", c_int)]
...
struct_xkb_keymap._fields_ = [("_opaque_struct", c_int)]
...
struct_xkb_state._fields_ = [("_opaque_struct", c_int)]
...
struct__IO_FILE._fields_ = [("_opaque_struct", c_int)]
...
xkb_keymap_new_from_names.argtypes = [
    POINTER(struct_xkb_context),
    POINTER(struct_xkb_rule_names),
...
xkb_keymap_new_from_file.argtypes = [
    POINTER(struct_xkb_context),
    POINTER(FILE),
    enum_xkb_keymap_format,
    enum_xkb_keymap_compile_flags,
]
...
xkb_keymap_new_from_string.argtypes = [
    POINTER(struct_xkb_context),
    c_char_p,
    enum_xkb_keymap_format,
    enum_xkb_keymap_compile_flags,
...
xkb_keymap_new_from_buffer.argtypes = [
    POINTER(struct_xkb_context),
    c_char_p,
    c_size_t,
    enum_xkb_keymap_format,
...
xkb_keymap_key_iter_t = CFUNCTYPE(
    None, POINTER(struct_xkb_keymap), xkb_keycode_t, POINTER(None)
)
...
xkb_keymap_key_for_each.argtypes = [
    POINTER(struct_xkb_keymap),
...
xkb_keymap_num_levels_for_key.argtypes = [
    POINTER(struct_xkb_keymap),
    xkb_keycode_t,
    xkb_layout_index_t,
]
...
xkb_keymap_key_get_mods_for_level.argtypes = [
    POINTER(struct_xkb_keymap),
    xkb_keycode_t,
    xkb_layout_index_t,
    xkb_level_index_t,
    POINTER(xkb_mod_mask_t),
    c_size_t,
]
...
xkb_keymap_key_get_syms_by_level.argtypes = [
    POINTER(struct_xkb_keymap),
    xkb_keycode_t,
    xkb_layout_index_t,
    xkb_level_index_t,
...
xkb_state_update_key.argtypes = [
    POINTER(struct_xkb_state),
    xkb_keycode_t,
    enum_xkb_key_direction,
]
...
xkb_state_update_mask.argtypes = [
    POINTER(struct_xkb_state),
    xkb_mod_mask_t,
    xkb_mod_mask_t,
    xkb_mod_mask_t,
...
xkb_state_key_get_syms.argtypes = [
    POINTER(struct_xkb_state),
    xkb_keycode_t,
    POINTER(POINTER(xkb_keysym_t)),
]
...
xkb_state_key_get_utf8.argtypes = [
    POINTER(struct_xkb_state),
    xkb_keycode_t,
    c_char_p,
    c_size_t,
...
xkb_state_key_get_level.argtypes = [
    POINTER(struct_xkb_state),
    xkb_keycode_t,
    xkb_layout_index_t,
]
...
xkb_state_serialize_mods.argtypes = [
    POINTER(struct_xkb_state),
    enum_xkb_state_component,
]
...
xkb_state_serialize_layout.argtypes = [
    POINTER(struct_xkb_state),
    enum_xkb_state_component,
]
...
xkb_state_mod_name_is_active.argtypes = [
    POINTER(struct_xkb_state),
    c_char_p,
    enum_xkb_state_component,
]
...
xkb_state_mod_names_are_active.argtypes = [
    POINTER(struct_xkb_state),
    enum_xkb_state_component,
    enum_xkb_state_match,
]
...
xkb_state_mod_index_is_active.argtypes = [
    POINTER(struct_xkb_state),
    xkb_mod_index_t,
    enum_xkb_state_component,
]
...
xkb_state_mod_indices_are_active.argtypes = [
    POINTER(struct_xkb_state),
    enum_xkb_state_component,
    enum_xkb_state_match,
]
...
xkb_state_key_get_consumed_mods2.argtypes = [
    POINTER(struct_xkb_state),
    xkb_keycode_t,
...
xkb_state_mod_index_is_consumed2.argtypes = [
    POINTER(struct_xkb_state),
    xkb_keycode_t,
    xkb_mod_index_t,
    enum_xkb_consumed_mode,
...
xkb_state_mod_index_is_consumed.argtypes = [
    POINTER(struct_xkb_state),
    xkb_keycode_t,
    xkb_mod_index_t,
]
...
xkb_state_mod_mask_remove_consumed.argtypes = [
    POINTER(struct_xkb_state),
    xkb_keycode_t,
    xkb_mod_mask_t,
]
...
xkb_state_layout_name_is_active.argtypes = [
    POINTER(struct_xkb_state),
    c_char_p,
    enum_xkb_state_component,
]
...
xkb_state_layout_index_is_active.argtypes = [
    POINTER(struct_xkb_state),
    xkb_layout_index_t,
    enum_xkb_state_component,
]
