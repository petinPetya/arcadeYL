...
gbm_device_is_format_supported.argtypes = [
    POINTER(struct_gbm_device),
    c_uint32,
    c_uint32,
]
...
gbm_device_get_format_modifier_plane_count = (
    _lib.gbm_device_get_format_modifier_plane_count
)
gbm_device_get_format_modifier_plane_count.restype = c_int
gbm_device_get_format_modifier_plane_count.argtypes = [
    POINTER(struct_gbm_device),
    c_uint32,
    c_uint64,
]
...
gbm_bo_create_with_modifiers.argtypes = [
    POINTER(struct_gbm_device),
    c_uint32,
    c_uint32,
    c_uint32,
...
gbm_bo_create_with_modifiers2.argtypes = [
    POINTER(struct_gbm_device),
    c_uint32,
    c_uint32,
    c_uint32,
...
gbm_surface_create_with_modifiers.argtypes = [
    POINTER(struct_gbm_device),
    c_uint32,
    c_uint32,
    c_uint32,
...
gbm_surface_create_with_modifiers2.argtypes = [
    POINTER(struct_gbm_device),
    c_uint32,
    c_uint32,
    c_uint32,
...
gbm_surface_release_buffer.argtypes = [
    POINTER(struct_gbm_surface),
    POINTER(struct_gbm_bo),
]
