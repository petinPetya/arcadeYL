...
XF86VidModeGetAllModeLines.argtypes = [
    POINTER(Display),
    c_int,
    POINTER(c_int),
    POINTER(POINTER(POINTER(XF86VidModeModeInfo))),
]
...
XF86VidModeAddModeLine.argtypes = [
    POINTER(Display),
    c_int,
    POINTER(XF86VidModeModeInfo),
    POINTER(XF86VidModeModeInfo),
]
...
XF86VidModeGetDotClocks.argtypes = [
    POINTER(Display),
    c_int,
    POINTER(c_int),
    POINTER(c_int),
...
XF86VidModeSetGammaRamp.argtypes = [
    POINTER(Display),
    c_int,
    c_int,
    POINTER(c_ushort),
...
XF86VidModeGetGammaRamp.argtypes = [
    POINTER(Display),
    c_int,
    c_int,
    POINTER(c_ushort),
