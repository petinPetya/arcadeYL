...
XDeviceButtonPressedEvent = (
    XDeviceButtonEvent  # /usr/include/X11/extensions/XInput.h:5077
)
XDeviceButtonReleasedEvent = (
    XDeviceButtonEvent  # /usr/include/X11/extensions/XInput.h:5078
)
...
XDeviceFocusInEvent = (
    XDeviceFocusChangeEvent  # /usr/include/X11/extensions/XInput.h:5135
)
XDeviceFocusOutEvent = (
    XDeviceFocusChangeEvent  # /usr/include/X11/extensions/XInput.h:5136
)
...
XDevicePresenceNotifyEvent = (
    struct_anon_106  # /usr/include/X11/extensions/XInput.h:5293
)
...
struct__XAnyClassinfo._fields_ = [("_opaque_struct", c_int)]
...
XAnyClassPtr = POINTER(
    struct__XAnyClassinfo
)  # /usr/include/X11/extensions/XInput.h:5564
...
struct__XDeviceInfo._fields_ = [("_opaque_struct", c_int)]
...
XDeviceInfoPtr = POINTER(
    struct__XDeviceInfo
)  # /usr/include/X11/extensions/XInput.h:5575
...
struct__XKeyInfo._fields_ = [("_opaque_struct", c_int)]
...
struct__XButtonInfo._fields_ = [("_opaque_struct", c_int)]
...
XButtonInfoPtr = POINTER(
    struct__XButtonInfo
)  # /usr/include/X11/extensions/XInput.h:5602
...
struct__XAxisInfo._fields_ = [("_opaque_struct", c_int)]
...
struct__XValuatorInfo._fields_ = [("_opaque_struct", c_int)]
...
XValuatorInfoPtr = POINTER(
    struct__XValuatorInfo
)  # /usr/include/X11/extensions/XInput.h:5622
...
XChangeFeedbackControl.argtypes = [
    POINTER(Display),
    POINTER(XDevice),
    c_ulong,
    POINTER(XFeedbackControl),
]
...
XChangeDeviceKeyMapping.argtypes = [
    POINTER(Display),
    POINTER(XDevice),
    c_int,
    c_int,
...
XSetDeviceModifierMapping.argtypes = [
    POINTER(Display),
    POINTER(XDevice),
    POINTER(XModifierKeymap),
]
...
XSetDeviceButtonMapping.argtypes = [
    POINTER(Display),
    POINTER(XDevice),
    POINTER(c_ubyte),
    c_int,
...
XGetDeviceButtonMapping.argtypes = [
    POINTER(Display),
    POINTER(XDevice),
    POINTER(c_ubyte),
    c_uint,
...
XChangeDeviceControl.argtypes = [
    POINTER(Display),
    POINTER(XDevice),
    c_int,
    POINTER(XDeviceControl),
]
...
XGetSelectedExtensionEvents.argtypes = [
    POINTER(Display),
    Window,
    POINTER(c_int),
    POINTER(POINTER(XEventClass)),
    POINTER(c_int),
    POINTER(POINTER(XEventClass)),
]
...
XChangeDeviceDontPropagateList.argtypes = [
    POINTER(Display),
    Window,
    c_int,
    POINTER(XEventClass),
...
XGetDeviceMotionEvents.argtypes = [
    POINTER(Display),
    POINTER(XDevice),
    Time,
    Time,
