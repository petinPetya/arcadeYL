...
struct_funcs._fields_ = [
    ...
    (
        "put_pixel",
        POINTER(CFUNCTYPE(c_int, POINTER(struct__XImage), c_int, c_int, c_ulong)),
    ),
    (
        "sub_image",
        POINTER(
...
XIDProc = CFUNCTYPE(
    None, POINTER(Display), XPointer, XPointer
)  # /usr/include/X11/Xlib.h:1171
...
XIMPreeditStateNotifyCallbackStruct = (
    struct__XIMPreeditStateNotifyCallbackStruct  # /usr/include/X11/Xlib.h:1286
)
...
XIMStringConversionText = (
    struct__XIMStringConversionText  # /usr/include/X11/Xlib.h:1310
)
...
XIMStringConversionCallbackStruct = (
    struct__XIMStringConversionCallbackStruct  # /usr/include/X11/Xlib.h:1342
)
...
XIMPreeditDrawCallbackStruct = (
    struct__XIMPreeditDrawCallbackStruct  # /usr/include/X11/Xlib.h:1349
)
enum_anon_91 = c_int
XIMIsInvisible = 0
XIMIsPrimary = 1
...
XIMPreeditCaretCallbackStruct = (
    struct__XIMPreeditCaretCallbackStruct  # /usr/include/X11/Xlib.h:1361
)
enum_anon_92 = c_int
XIMTextType = 0
XIMBitmapType = 1
...
XIMStatusDrawCallbackStruct = (
    struct__XIMStatusDrawCallbackStruct  # /usr/include/X11/Xlib.h:1374
)
...
class XrmValue(Structure):
    _fields_ = (("size", c_uint), ("addr", c_char_p))
...
XErrorHandler = CFUNCTYPE(
    c_int, POINTER(Display), POINTER(XErrorEvent)
)  # /usr/include/X11/Xlib.h:1853
...
XCheckIfEvent.argtypes = [
    POINTER(Display),
    POINTER(XEvent),
    CFUNCTYPE(c_int, POINTER(Display), POINTER(XEvent), XPointer),
    XPointer,
]
...
XFontsOfFontSet.argtypes = [
    XFontSet,
    POINTER(POINTER(POINTER(XFontStruct))),
    POINTER(POINTER(c_char_p)),
]
...
XRegisterIMInstantiateCallback.argtypes = [
    POINTER(Display),
    POINTER(struct__XrmHashBucketRec),
    c_char_p,
    c_char_p,
...
XUnregisterIMInstantiateCallback.argtypes = [
    POINTER(Display),
    POINTER(struct__XrmHashBucketRec),
    c_char_p,
    c_char_p,
...
XConnectionWatchProc = CFUNCTYPE(
    None, POINTER(Display), XPointer, c_int, c_int, POINTER(XPointer)
)  # /usr/include/X11/Xlib.h:3959
...
XGetRGBColormaps.argtypes = [
    POINTER(Display),
    Window,
    POINTER(POINTER(XStandardColormap)),
    POINTER(c_int),
    Atom,
]
...
XmbTextListToTextProperty.argtypes = [
    POINTER(Display),
    POINTER(c_char_p),
    c_int,
    XICCEncodingStyle,
