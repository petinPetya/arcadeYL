...
PFNEGLCHOOSECONFIGPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, POINTER(EGLint), POINTER(EGLConfig), EGLint, POINTER(EGLint)
...
PFNEGLCOPYBUFFERSPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSurface, EGLNativePixmapType
)  # /usr/include/EGL/egl.h:126
PFNEGLCREATECONTEXTPROC = CFUNCTYPE(
    EGLContext, EGLDisplay, EGLConfig, EGLContext, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:127
PFNEGLCREATEPBUFFERSURFACEPROC = CFUNCTYPE(
    EGLSurface, EGLDisplay, EGLConfig, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:128
PFNEGLCREATEPIXMAPSURFACEPROC = CFUNCTYPE(
    EGLSurface, EGLDisplay, EGLConfig, EGLNativePixmapType, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:129
Window = XID  # /usr/include/X11/X.h:96
EGLNativeWindowType = Window  # /usr/include/EGL/eglplatform.h:133
PFNEGLCREATEWINDOWSURFACEPROC = CFUNCTYPE(
    EGLSurface, EGLDisplay, EGLConfig, EGLNativeWindowType, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:130
PFNEGLDESTROYCONTEXTPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLContext
)  # /usr/include/EGL/egl.h:131
PFNEGLDESTROYSURFACEPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSurface
)  # /usr/include/EGL/egl.h:132
PFNEGLGETCONFIGATTRIBPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLConfig, EGLint, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:133
PFNEGLGETCONFIGSPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, POINTER(EGLConfig), EGLint, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:134
PFNEGLGETCURRENTDISPLAYPROC = CFUNCTYPE(EGLDisplay)  # /usr/include/EGL/egl.h:135
PFNEGLGETCURRENTSURFACEPROC = CFUNCTYPE(
    EGLSurface, EGLint
...
PFNEGLGETDISPLAYPROC = CFUNCTYPE(
    EGLDisplay, EGLNativeDisplayType
)  # /usr/include/EGL/egl.h:137
PFNEGLGETERRORPROC = CFUNCTYPE(EGLint)  # /usr/include/EGL/egl.h:138
PFNEGLGETPROCADDRESSPROC = CFUNCTYPE(
    __eglMustCastToProperFunctionPointerType, c_char_p
)  # /usr/include/EGL/egl.h:139
PFNEGLINITIALIZEPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, POINTER(EGLint), POINTER(EGLint)
)  # /usr/include/EGL/egl.h:140
PFNEGLMAKECURRENTPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSurface, EGLSurface, EGLContext
)  # /usr/include/EGL/egl.h:141
PFNEGLQUERYCONTEXTPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLContext, EGLint, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:142
PFNEGLQUERYSTRINGPROC = CFUNCTYPE(
    c_char_p, EGLDisplay, EGLint
)  # /usr/include/EGL/egl.h:143
PFNEGLQUERYSURFACEPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSurface, EGLint, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:144
PFNEGLSWAPBUFFERSPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSurface
)  # /usr/include/EGL/egl.h:145
...
eglCreatePixmapSurface.argtypes = [
    EGLDisplay,
    EGLConfig,
    EGLNativePixmapType,
    POINTER(EGLint),
...
eglCreateWindowSurface.argtypes = [
    EGLDisplay,
    EGLConfig,
    EGLNativeWindowType,
    POINTER(EGLint),
...
PFNEGLBINDTEXIMAGEPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSurface, EGLint
)  # /usr/include/EGL/egl.h:193
PFNEGLRELEASETEXIMAGEPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSurface, EGLint
)  # /usr/include/EGL/egl.h:194
PFNEGLSURFACEATTRIBPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSurface, EGLint, EGLint
)  # /usr/include/EGL/egl.h:195
PFNEGLSWAPINTERVALPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLint
)  # /usr/include/EGL/egl.h:196
...
PFNEGLCREATEPBUFFERFROMCLIENTBUFFERPROC = CFUNCTYPE(
    EGLSurface, EGLDisplay, EGLenum, EGLClientBuffer, EGLConfig, POINTER(EGLint)
)  # /usr/include/EGL/egl.h:240
...
eglCreatePbufferFromClientBuffer.argtypes = [
    EGLDisplay,
    EGLenum,
    EGLClientBuffer,
    EGLConfig,
...
PFNEGLCREATESYNCPROC = CFUNCTYPE(
    EGLSync, EGLDisplay, EGLenum, POINTER(EGLAttrib)
)  # /usr/include/EGL/egl.h:333
PFNEGLDESTROYSYNCPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSync
)  # /usr/include/EGL/egl.h:334
PFNEGLCLIENTWAITSYNCPROC = CFUNCTYPE(
    EGLint, EGLDisplay, EGLSync, EGLint, EGLTime
)  # /usr/include/EGL/egl.h:335
PFNEGLGETSYNCATTRIBPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSync, EGLint, POINTER(EGLAttrib)
)  # /usr/include/EGL/egl.h:336
PFNEGLCREATEIMAGEPROC = CFUNCTYPE(
    EGLImage, EGLDisplay, EGLContext, EGLenum, EGLClientBuffer, POINTER(EGLAttrib)
)  # /usr/include/EGL/egl.h:337
PFNEGLDESTROYIMAGEPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLImage
)  # /usr/include/EGL/egl.h:338
PFNEGLGETPLATFORMDISPLAYPROC = CFUNCTYPE(
    EGLDisplay, EGLenum, POINTER(None), POINTER(EGLAttrib)
)  # /usr/include/EGL/egl.h:339
PFNEGLCREATEPLATFORMWINDOWSURFACEPROC = CFUNCTYPE(
    EGLSurface, EGLDisplay, EGLConfig, POINTER(None), POINTER(EGLAttrib)
)  # /usr/include/EGL/egl.h:340
PFNEGLCREATEPLATFORMPIXMAPSURFACEPROC = CFUNCTYPE(
    EGLSurface, EGLDisplay, EGLConfig, POINTER(None), POINTER(EGLAttrib)
)  # /usr/include/EGL/egl.h:341
PFNEGLWAITSYNCPROC = CFUNCTYPE(
    EGLBoolean, EGLDisplay, EGLSync, EGLint
)  # /usr/include/EGL/egl.h:342
...
eglCreatePlatformWindowSurface.argtypes = [
    EGLDisplay,
    EGLConfig,
    POINTER(None),
    POINTER(EGLAttrib),
...
eglCreatePlatformPixmapSurface.argtypes = [
    EGLDisplay,
    EGLConfig,
    POINTER(None),
    POINTER(EGLAttrib),
