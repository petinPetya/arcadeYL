...
class ABC(Structure):
    _fields_ = [("abcA", c_int), ("abcB", c_uint), ("abcC", c_int)]
    __slots__ = [f[0] for f in _fields_]
...
class IStream(com.pIUnknown):
    _methods_ = [
        ("Read", com.STDMETHOD(c_void_p, ULONG, POINTER(ULONG))),
        ("Write", com.STDMETHOD()),
        ("Seek", com.STDMETHOD(LARGE_INTEGER, DWORD, POINTER(ULARGE_INTEGER))),
        ...
        ("Stat", com.STDMETHOD(POINTER(STATSTG), UINT)),
        ("Clone", com.STDMETHOD()),
    ]
