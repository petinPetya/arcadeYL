...
class AudioStreamBasicDescription(Structure):
    ...
    def __repr__(self):
        return (
            f"AudioStreamBasicDescription(sample_rate={self.mSampleRate}, channels={self.mChannelsPerFrame}, "
...
ca.ExtAudioFileGetProperty.argtypes = [
    ExtAudioFileRef,
...
ca.ExtAudioFileSetProperty.argtypes = [
    ExtAudioFileRef,
    ExtAudioFilePropertyID,
    c_uint32,
    c_void_p,
...
AudioFile_ReadProc = CFUNCTYPE(
    c_int, c_void_p, c_int64, c_uint32, c_void_p, POINTER(c_uint32)
)
AudioFile_GetSizeProc = CFUNCTYPE(c_int64, c_void_p)

ca.AudioFileOpenWithCallbacks.restype = OSStatus
ca.AudioFileOpenWithCallbacks.argtypes = [
    c_void_p,
    AudioFile_ReadProc,
    c_void_p,
...
ca.ExtAudioFileWrapAudioFileID.argtypes = [
    AudioFileID,
    c_bool,
    POINTER(ExtAudioFileRef),
]

ca.ExtAudioFileRead.restype = OSStatus
ca.ExtAudioFileRead.argtypes = [
    ExtAudioFileRef,
    POINTER(c_uint32),
