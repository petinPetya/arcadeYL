...
class DWRITE_GLYPH_METRICS(Structure):
    ...
    def __repr__(self):
        return (
            f"DWRITE_GLYPH_METRICS(leftSideBearing={self.leftSideBearing}, advanceWidth={self.advanceWidth}, "
...
class IDWriteFontFileStream(com.IUnknown):
    _methods_ = [
        ...
        ("ReleaseFileFragment", com.STDMETHOD(c_void_p)),
        ("GetFileSize", com.STDMETHOD(POINTER(UINT64))),
        ("GetLastWriteTime", com.STDMETHOD(POINTER(UINT64))),
    ]
...
class IDWriteLocalFontFileLoader(IDWriteFontFileLoader, com.pIUnknown):
    _methods_ = [
        ("GetFilePathLengthFromKey", com.STDMETHOD(c_void_p, UINT32, POINTER(UINT32))),
        ("GetFilePathFromKey", com.STDMETHOD(c_void_p, UINT32, c_wchar_p, UINT32)),
        ("GetLastWriteTimeFromKey", com.STDMETHOD()),
    ]


IID_IDWriteLocalFontFileLoader = com.GUID(
...
class IDWriteLocalizedStrings(com.pIUnknown):
    _methods_ = [
        ("GetCount", com.METHOD(UINT32)),
        ("FindLocaleName", com.STDMETHOD(c_wchar_p, POINTER(UINT32), POINTER(BOOL))),
        ("GetLocaleNameLength", com.STDMETHOD(UINT32, POINTER(UINT32))),
        ("GetLocaleName", com.STDMETHOD(UINT32, c_wchar_p, UINT32)),
        ("GetStringLength", com.STDMETHOD(UINT32, POINTER(UINT32))),
        ("GetString", com.STDMETHOD(UINT32, c_wchar_p, UINT32)),
    ]


class IDWriteFontFile(com.pIUnknown):
    _methods_ = [
        ("GetReferenceKey", com.STDMETHOD(POINTER(c_void_p), POINTER(UINT32))),
        ("GetLoader", com.STDMETHOD(POINTER(IDWriteFontFileLoader))),
        ("Analyze", com.STDMETHOD()),
    ]


class IDWriteFontFace(com.pIUnknown):
    _methods_ = [
        ("GetType", com.METHOD(DWRITE_FONT_FACE_TYPE)),
        ("GetFiles", com.STDMETHOD(POINTER(UINT32), POINTER(IDWriteFontFile))),
        ("GetIndex", com.METHOD(UINT32)),
        ("GetSimulations", com.STDMETHOD()),
        ("IsSymbolFont", com.METHOD(BOOL)),
        ("GetMetrics", com.METHOD(c_void, POINTER(DWRITE_FONT_METRICS))),
        ("GetGlyphCount", com.METHOD(UINT16)),
        (
            "GetDesignGlyphMetrics",
            com.STDMETHOD(POINTER(UINT16), UINT32, POINTER(DWRITE_GLYPH_METRICS), BOOL),
        ),
        ("GetGlyphIndices", com.STDMETHOD(POINTER(UINT32), UINT32, POINTER(UINT16))),
        (
            "TryGetFontTable",
            com.STDMETHOD(UINT32, c_void_p, POINTER(UINT32), c_void_p, POINTER(BOOL)),
        ),
        ("ReleaseFontTable", com.METHOD(c_void)),
        ("GetGlyphRunOutline", com.STDMETHOD()),
        ("GetRecommendedRenderingMode", com.STDMETHOD()),
        ("GetGdiCompatibleMetrics", com.STDMETHOD()),
        ("GetGdiCompatibleGlyphMetrics", com.STDMETHOD()),
    ]


IID_IDWriteFontFace1 = com.GUID(
...
class IDWriteFontFace1(IDWriteFontFace):
    _methods_ = [
        ("GetMetrics1", com.STDMETHOD(POINTER(DWRITE_FONT_METRICS1))),
        ("GetGdiCompatibleMetrics1", com.STDMETHOD()),
        ("GetCaretMetrics", com.STDMETHOD(POINTER(DWRITE_CARET_METRICS))),
        ("GetUnicodeRanges", com.STDMETHOD()),
        ("IsMonospacedFont", com.METHOD(BOOL)),
        ("GetDesignGlyphAdvances", com.METHOD(c_void, POINTER(DWRITE_FONT_METRICS))),
        ("GetGdiCompatibleGlyphAdvances", com.STDMETHOD()),
        (
            "GetKerningPairAdjustments",
            com.STDMETHOD(UINT32, POINTER(UINT16), POINTER(INT32)),
        ),
        ("HasKerningPairs", com.METHOD(BOOL)),
        ("GetRecommendedRenderingMode1", com.STDMETHOD()),
        ("GetVerticalGlyphVariants", com.STDMETHOD()),
        ("HasVerticalGlyphVariants", com.METHOD(BOOL)),
    ]


IID_IDWriteFontFace2 = com.GUID(
...
class IDWriteFontFace2(IDWriteFontFace1):
    _methods_ = [
        ("IsColorFont", com.METHOD(BOOL)),
        ("GetColorPaletteCount", com.METHOD(UINT32)),
        ("GetPaletteEntryCount", com.METHOD(UINT32)),
        ("GetPaletteEntries", com.STDMETHOD()),
        ("GetRecommendedRenderingMode2", com.STDMETHOD()),
    ]


IID_IDWriteFontFace3 = com.GUID(
...
class IDWriteFontFace3(IDWriteFontFace2):
    _methods_ = [
        ("GetFontFaceReference", com.STDMETHOD()),
        ("GetPanose", com.STDMETHOD()),
        ("GetWeight", com.METHOD(DWRITE_FONT_WEIGHT)),
        ("GetStretch", com.METHOD(DWRITE_FONT_STRETCH)),
        ("GetStyle", com.METHOD(DWRITE_FONT_STYLE)),
        ("GetFamilyNames", com.STDMETHOD(POINTER(IDWriteLocalizedStrings))),
        ("GetFaceNames", com.STDMETHOD(POINTER(IDWriteLocalizedStrings))),
        ("GetInformationalStrings", com.STDMETHOD()),
        ("HasCharacter", com.METHOD(BOOL, UINT32)),
        ("GetRecommendedRenderingMode3", com.STDMETHOD()),
        ("IsCharacterLocal", com.STDMETHOD()),
        ("IsGlyphLocal", com.STDMETHOD()),
        ("AreCharactersLocal", com.STDMETHOD()),
        ("AreGlyphsLocal", com.STDMETHOD()),
    ]
...
class IDWriteFontFace4(IDWriteFontFace3):
    _methods_ = [
        ...
        ("GetGlyphImageFormats", com.METHOD(DWRITE_GLYPH_IMAGE_FORMATS)),
        (
            "GetGlyphImageData",
            com.STDMETHOD(
                UINT16,
                ...
                POINTER(DWRITE_GLYPH_IMAGE_DATA),
                POINTER(c_void_p),
            ),
        ),
        ("ReleaseGlyphImageData", com.METHOD(None, c_void_p)),
    ]
...
class DWRITE_GLYPH_RUN(Structure):
    ...
    def get_info(self):
        print(
            f"DWRITE_GLYPH_RUN(face: {self.fontFace}, fontEmSize: {self.fontEmSize}, count: {self.glyphCount}"
        )
        for i in range(self.glyphCount):
            print(
                f"glyph: {i}, indice: {self.glyphIndices[i]}, advance: {self.glyphAdvances[i]}, offset: {self.glyphOffsets[i]}"
            )
...
class IDWriteTextAnalysisSource(com.IUnknown):
    _methods_ = [
        ...
        ("GetParagraphReadingDirection", com.METHOD(DWRITE_READING_DIRECTION)),
        ("GetLocaleName", com.STDMETHOD(UINT32, POINTER(UINT32), POINTER(c_wchar_p))),
        ("GetNumberSubstitution", com.STDMETHOD(UINT32, POINTER(UINT32), c_void_p)),
    ]
...
class IDWriteTextAnalysisSink(com.IUnknown):
    _methods_ = [
        ...
        ("SetLineBreakpoints", com.STDMETHOD(UINT32, UINT32, c_void_p)),
        ("SetBidiLevel", com.STDMETHOD(UINT32, UINT32, UINT8, UINT8)),
        ("SetNumberSubstitution", com.STDMETHOD(UINT32, UINT32, c_void_p)),
    ]
...
class IDWriteTextAnalyzer(com.pIUnknown):
    _methods_ = [
        (
            "AnalyzeScript",
            com.STDMETHOD(
                POINTER(IDWriteTextAnalysisSource),
                UINT32,
                UINT32,
                POINTER(IDWriteTextAnalysisSink),
            ),
        ),
        ("AnalyzeBidi", com.STDMETHOD()),
        ("AnalyzeNumberSubstitution", com.STDMETHOD()),
        ("AnalyzeLineBreakpoints", com.STDMETHOD()),
        (
            "GetGlyphs",
            com.STDMETHOD(
                c_wchar_p,
                ...
                UINT32,
                POINTER(UINT16),
                POINTER(DWRITE_SHAPING_TEXT_PROPERTIES),
                POINTER(UINT16),
        ...
        (
            ...
            com.STDMETHOD(
                ...
                POINTER(DWRITE_SCRIPT_ANALYSIS),
                c_wchar_p,
                POINTER(DWRITE_TYPOGRAPHIC_FEATURES),
                POINTER(UINT32),
                UINT32,
                POINTER(FLOAT),
        ...
        ("GetGdiCompatibleGlyphPlacements", com.STDMETHOD()),
    ]


class IDWriteFontList(com.pIUnknown):
    _methods_ = [
        ("GetFontCollection", com.STDMETHOD()),
        ("GetFontCount", com.METHOD(UINT32)),
        (
            "GetFont",
            com.STDMETHOD(UINT32, c_void_p),
        ),  # IDWriteFont, use void because of forward ref.
    ]
...
class IDWriteFontFamily(IDWriteFontList, com.pIUnknown):
    _methods_ = [
        ...
        (
            ...
            com.STDMETHOD(
                DWRITE_FONT_WEIGHT, DWRITE_FONT_STRETCH, DWRITE_FONT_STYLE, c_void_p
            ),
        ),
        ("GetMatchingFonts", com.STDMETHOD()),
    ]


class IDWriteFontFamily1(IDWriteFontFamily, IDWriteFontList, com.pIUnknown):
    _methods_ = [
        ("GetFontLocality", com.STDMETHOD()),
        ("GetFont1", com.STDMETHOD()),
        ("GetFontFaceReference", com.STDMETHOD()),
    ]
...
class IDWriteFont(com.pIUnknown):
    _methods_ = [
        ("GetFontFamily", com.STDMETHOD(POINTER(IDWriteFontFamily))),
        ("GetWeight", com.METHOD(DWRITE_FONT_WEIGHT)),
        ("GetStretch", com.METHOD(DWRITE_FONT_STRETCH)),
        ("GetStyle", com.METHOD(DWRITE_FONT_STYLE)),
        ("IsSymbolFont", com.METHOD(BOOL)),
        ...
        (
            ...
            com.STDMETHOD(
                ...
                POINTER(IDWriteLocalizedStrings),
                POINTER(BOOL),
            ),
        ),
        ("GetSimulations", com.STDMETHOD()),
        ("GetMetrics", com.STDMETHOD()),
        ("HasCharacter", com.STDMETHOD(UINT32, POINTER(BOOL))),
        ("CreateFontFace", com.STDMETHOD(POINTER(IDWriteFontFace))),
    ]


class IDWriteFont1(IDWriteFont, com.pIUnknown):
    _methods_ = [
        ("GetMetrics1", com.STDMETHOD()),
        ("GetPanose", com.STDMETHOD()),
        ("GetUnicodeRanges", com.STDMETHOD()),
        ("IsMonospacedFont", com.STDMETHOD()),
    ]


class IDWriteFontCollection(com.pIUnknown):
    _methods_ = [
        ("GetFontFamilyCount", com.METHOD(UINT32)),
        ("GetFontFamily", com.STDMETHOD(UINT32, POINTER(IDWriteFontFamily))),
        ("FindFamilyName", com.STDMETHOD(c_wchar_p, POINTER(UINT), POINTER(BOOL))),
        ("GetFontFromFontFace", com.STDMETHOD()),
    ]


class IDWriteFontCollection1(IDWriteFontCollection, com.pIUnknown):
    _methods_ = [
        ("GetFontSet", com.STDMETHOD()),
        ("GetFontFamily1", com.STDMETHOD(POINTER(IDWriteFontFamily1))),
    ]
...
class IDWriteGdiInterop(com.pIUnknown):
    _methods_ = [
        ...
        ("ConvertFontToLOGFONT", com.STDMETHOD()),
        ("ConvertFontFaceToLOGFONT", com.STDMETHOD()),
        ("CreateFontFaceFromHdc", com.STDMETHOD(HDC, POINTER(IDWriteFontFace))),
        ("CreateBitmapRenderTarget", com.STDMETHOD()),
    ]


class IDWriteTextFormat(com.pIUnknown):
    _methods_ = [
        ("SetTextAlignment", com.STDMETHOD(DWRITE_TEXT_ALIGNMENT)),
        ("SetParagraphAlignment", com.STDMETHOD()),
        ("SetWordWrapping", com.STDMETHOD()),
        ("SetReadingDirection", com.STDMETHOD()),
        ("SetFlowDirection", com.STDMETHOD()),
        ("SetIncrementalTabStop", com.STDMETHOD()),
        ("SetTrimming", com.STDMETHOD()),
        ("SetLineSpacing", com.STDMETHOD()),
        ("GetTextAlignment", com.STDMETHOD()),
        ("GetParagraphAlignment", com.STDMETHOD()),
        ("GetWordWrapping", com.STDMETHOD()),
        ("GetReadingDirection", com.STDMETHOD()),
        ("GetFlowDirection", com.STDMETHOD()),
        ("GetIncrementalTabStop", com.STDMETHOD()),
        ("GetTrimming", com.STDMETHOD()),
        ("GetLineSpacing", com.STDMETHOD()),
        ("GetFontCollection", com.STDMETHOD()),
        ("GetFontFamilyNameLength", com.STDMETHOD(UINT32, POINTER(UINT32))),
        ("GetFontFamilyName", com.STDMETHOD(UINT32, c_wchar_p, UINT32)),
        ("GetFontWeight", com.STDMETHOD()),
        ("GetFontStyle", com.STDMETHOD()),
        ("GetFontStretch", com.STDMETHOD()),
        ("GetFontSize", com.STDMETHOD()),
        ("GetLocaleNameLength", com.STDMETHOD()),
        ("GetLocaleName", com.STDMETHOD()),
    ]


class IDWriteTypography(com.pIUnknown):
    _methods_ = [
        ("AddFontFeature", com.STDMETHOD(DWRITE_FONT_FEATURE)),
        ("GetFontFeatureCount", com.METHOD(UINT32)),
        ("GetFontFeature", com.STDMETHOD()),
    ]
...
class IDWriteTextRenderer(IDWritePixelSnapping):
    _methods_ = [
        ...
        ("DrawUnderline", com.STDMETHOD(c_void_p, FLOAT, FLOAT, c_void_p, c_void_p)),
        (
            "DrawStrikethrough",
...
class IDWriteTextLayout(IDWriteTextFormat):
    _methods_ = [
        ("SetMaxWidth", com.STDMETHOD()),
        ("SetMaxHeight", com.STDMETHOD()),
        ("SetFontCollection", com.STDMETHOD()),
        ("SetFontFamilyName", com.STDMETHOD()),
        ("SetFontWeight", com.STDMETHOD()),  # 30
        ("SetFontStyle", com.STDMETHOD()),
        ("SetFontStretch", com.STDMETHOD()),
        ("SetFontSize", com.STDMETHOD()),
        ("SetUnderline", com.STDMETHOD()),
        ("SetStrikethrough", com.STDMETHOD()),
        ("SetDrawingEffect", com.STDMETHOD()),
        ("SetInlineObject", com.STDMETHOD()),
        ("SetTypography", com.STDMETHOD(IDWriteTypography, DWRITE_TEXT_RANGE)),
        ("SetLocaleName", com.STDMETHOD()),
        ("GetMaxWidth", com.METHOD(FLOAT)),  # 40
        ("GetMaxHeight", com.METHOD(FLOAT)),
        (
            "GetFontCollection2",
            com.STDMETHOD(
                UINT32, POINTER(IDWriteFontCollection), POINTER(DWRITE_TEXT_RANGE)
            ),
        ),
        ("GetFontFamilyNameLength2", com.STDMETHOD(UINT32, POINTER(UINT32), c_void_p)),
        (
            "GetFontFamilyName2",
        ...
        (
            "GetFontWeight2",
            com.STDMETHOD(
                UINT32, POINTER(DWRITE_FONT_WEIGHT), POINTER(DWRITE_TEXT_RANGE)
            ),
        ),
        ("GetFontStyle2", com.STDMETHOD()),
        ("GetFontStretch2", com.STDMETHOD()),
        ("GetFontSize2", com.STDMETHOD()),
        ("GetUnderline", com.STDMETHOD()),
        (
            "GetStrikethrough",
            com.STDMETHOD(UINT32, POINTER(BOOL), POINTER(DWRITE_TEXT_RANGE)),
        ),
        ("GetDrawingEffect", com.STDMETHOD()),
        ("GetInlineObject", com.STDMETHOD()),
        (
            "GetTypography",  # Always returns NULL without SetTypography being called.
            com.STDMETHOD(
                UINT32, POINTER(IDWriteTypography), POINTER(DWRITE_TEXT_RANGE)
            ),
        ),
        ("GetLocaleNameLength1", com.STDMETHOD()),
        ("GetLocaleName1", com.STDMETHOD()),
        ("Draw", com.STDMETHOD(c_void_p, POINTER(IDWriteTextRenderer), FLOAT, FLOAT)),
        ("GetLineMetrics", com.STDMETHOD()),
        ("GetMetrics", com.STDMETHOD(POINTER(DWRITE_TEXT_METRICS))),
        ("GetOverhangMetrics", com.STDMETHOD(POINTER(DWRITE_OVERHANG_METRICS))),
        (
            "GetClusterMetrics",
            com.STDMETHOD(POINTER(DWRITE_CLUSTER_METRICS), UINT32, POINTER(UINT32)),
        ),
        ("DetermineMinWidth", com.STDMETHOD(POINTER(FLOAT))),
        ("HitTestPoint", com.STDMETHOD()),
        ("HitTestTextPosition", com.STDMETHOD()),
        ("HitTestTextRange", com.STDMETHOD()),
    ]


class IDWriteTextLayout1(IDWriteTextLayout, IDWriteTextFormat, com.pIUnknown):
    _methods_ = [
        ("SetPairKerning", com.STDMETHOD()),
        ("GetPairKerning", com.STDMETHOD()),
        ("SetCharacterSpacing", com.STDMETHOD()),
        (
            "GetCharacterSpacing",
            com.STDMETHOD(
                UINT32,
...
class IDWriteFontFileEnumerator(com.IUnknown):
    _methods_ = [
        ("MoveNext", com.STDMETHOD(POINTER(BOOL))),
        ("GetCurrentFontFile", com.STDMETHOD(c_void_p)),
    ]
...
class IDWriteFontCollectionLoader(com.IUnknown):
    _methods_ = [
        (
            ...
            com.STDMETHOD(
                c_void_p, c_void_p, UINT32, POINTER(POINTER(IDWriteFontFileEnumerator))
            ),
        ),
    ]
...
class IDWriteRenderingParams(com.pIUnknown):
    _methods_ = [
        ("GetGamma", com.METHOD(FLOAT)),
        ("GetEnhancedContrast", com.METHOD(FLOAT)),
        ("GetClearTypeLevel", com.METHOD(FLOAT)),
        ("GetPixelGeometry", com.METHOD(UINT)),
        ("GetRenderingMode", com.METHOD(UINT)),
    ]
...
class IDWriteFactory(com.pIUnknown):
    _methods_ = [
        ...
        (
            ...
            com.STDMETHOD(
                POINTER(IDWriteFontCollectionLoader),
                c_void_p,
                UINT32,
        ...
        (
            ...
            com.STDMETHOD(
                c_void_p,
                UINT32,
                POINTER(IDWriteFontFileLoader_LI),
                POINTER(IDWriteFontFile),
            ),
        ),
        ("CreateFontFace", com.STDMETHOD()),
        ("CreateRenderingParams", com.STDMETHOD(POINTER(IDWriteRenderingParams))),
        ("CreateMonitorRenderingParams", com.STDMETHOD()),
        (
            "CreateCustomRenderingParams",
            com.STDMETHOD(
                FLOAT, FLOAT, FLOAT, UINT, UINT, POINTER(IDWriteRenderingParams)
            ),
        ),
        (
            "RegisterFontFileLoader",
            com.STDMETHOD(c_void_p),
        ),  # Ambiguous as newer is a pIUnknown and legacy is IUnknown.
        ("UnregisterFontFileLoader", com.STDMETHOD(POINTER(IDWriteFontFileLoader_LI))),
        (
            "CreateTextFormat",
            com.STDMETHOD(
                c_wchar_p,
        ...
        ("CreateTypography", com.STDMETHOD(POINTER(IDWriteTypography))),
        ("GetGdiInterop", com.STDMETHOD(POINTER(IDWriteGdiInterop))),
        (
            "CreateTextLayout",
            com.STDMETHOD(
                c_wchar_p,
                ...
                FLOAT,
                FLOAT,
                POINTER(IDWriteTextLayout),
            ),
        ),
        ("CreateGdiCompatibleTextLayout", com.STDMETHOD()),
        ("CreateEllipsisTrimmingSign", com.STDMETHOD()),
        ("CreateTextAnalyzer", com.STDMETHOD(POINTER(IDWriteTextAnalyzer))),
        ("CreateNumberSubstitution", com.STDMETHOD()),
        ("CreateGlyphRunAnalysis", com.STDMETHOD()),
    ]


# Windows 8
IID_IDWriteFactory1 = com.GUID(
...
class IDWriteFactory1(IDWriteFactory, com.pIUnknown):
    _methods_ = [
        ("GetEudcFontCollection", com.STDMETHOD()),
        ("CreateCustomRenderingParams1", com.STDMETHOD()),
    ]


class DWRITE_UNICODE_RANGE(Structure):
    _fields_ = [("first", UINT32), ("last", UINT32)]
...
class IDWriteFontFallbackBuilder(com.pIUnknown):
    _methods_ = [
        ...
        ("AddMappings", com.STDMETHOD(IDWriteFontFallback)),
        ("CreateFontFallback", com.STDMETHOD(POINTER(IDWriteFontFallback))),
    ]
...
class IDWriteColorGlyphRunEnumerator(com.pIUnknown):
    _methods_ = [
        ("MoveNext", com.STDMETHOD(POINTER(BOOL))),
        ("GetCurrentRun", com.STDMETHOD(POINTER(POINTER(DWRITE_COLOR_GLYPH_RUN)))),
    ]


class IDWriteFactory2(IDWriteFactory1, IDWriteFactory, com.pIUnknown):
    _methods_ = [
        ("GetSystemFontFallback", com.STDMETHOD(POINTER(IDWriteFontFallback))),
        (
        ...
        ("CreateCustomRenderingParams2", com.STDMETHOD()),
        ("CreateGlyphRunAnalysis2", com.STDMETHOD()),
    ]


# Windows 8.1
IID_IDWriteFactory2 = com.GUID(
...
class IDWriteFontSet(com.pIUnknown):
    _methods_ = [
        ("GetFontCount", com.STDMETHOD()),
        ("GetFontFaceReference", com.STDMETHOD()),
        ("FindFontFaceReference", com.STDMETHOD()),
        ("FindFontFace", com.STDMETHOD()),
        ("GetPropertyValues__", com.STDMETHOD()),
        ("GetPropertyValues_", com.STDMETHOD()),
        ("GetPropertyValues", com.STDMETHOD()),
        ("GetPropertyOccurrenceCount", com.STDMETHOD()),
        ("GetMatchingFonts_", com.STDMETHOD()),
        ("GetMatchingFonts", com.STDMETHOD()),
    ]
...
class IDWriteFontSetBuilder(com.pIUnknown):
    _methods_ = [
        ("AddFontFaceReference_", com.STDMETHOD()),
        ("AddFontFaceReference", com.STDMETHOD()),
        ("AddFontSet", com.STDMETHOD()),
        ("CreateFontSet", com.STDMETHOD(POINTER(IDWriteFontSet))),
    ]


class IDWriteFontSetBuilder1(IDWriteFontSetBuilder, com.pIUnknown):
    _methods_ = [
        ("AddFontFile", com.STDMETHOD(IDWriteFontFile)),
    ]


class IDWriteFactory3(IDWriteFactory2, com.pIUnknown):
    _methods_ = [
        ("CreateGlyphRunAnalysis3", com.STDMETHOD()),
        ("CreateCustomRenderingParams3", com.STDMETHOD()),
        ("CreateFontFaceReference_", com.STDMETHOD()),
        ("CreateFontFaceReference", com.STDMETHOD()),
        ("GetSystemFontSet", com.STDMETHOD()),
        ("CreateFontSetBuilder", com.STDMETHOD(POINTER(IDWriteFontSetBuilder))),
        (
            "CreateFontCollectionFromFontSet",
            com.STDMETHOD(IDWriteFontSet, POINTER(IDWriteFontCollection1)),
        ),
        ("GetSystemFontCollection3", com.STDMETHOD()),
        ("GetFontDownloadQueue", com.STDMETHOD()),
        # ('GetSystemFontSet',
        # com.STDMETHOD()),
    ]
...
class IDWriteColorGlyphRunEnumerator1(IDWriteColorGlyphRunEnumerator):
    _methods_ = [
        ("GetCurrentRun1", com.STDMETHOD(POINTER(POINTER(DWRITE_COLOR_GLYPH_RUN1)))),
    ]


IID_IDWriteColorGlyphRunEnumerator1 = com.GUID(
    ...
    _methods_ = [
        (
            ...
            com.STDMETHOD(
                ...
                c_void_p,
                UINT32,
                POINTER(IDWriteColorGlyphRunEnumerator1),
            ),
        ),
        ("ComputeGlyphOrigins_", com.STDMETHOD()),
        ("ComputeGlyphOrigins", com.STDMETHOD()),
    ]


class IDWriteInMemoryFontFileLoader(com.pIUnknown):
    _methods_ = [
        ("CreateStreamFromKey", com.STDMETHOD()),
        (
            "CreateInMemoryFontFileReference",
            com.STDMETHOD(
                IDWriteFactory, c_void_p, UINT, c_void_p, POINTER(IDWriteFontFile)
            ),
        ),
        ("GetFileCount", com.STDMETHOD()),
    ]


# Windows 10 - Creators
IID_IDWriteFactory5 = com.GUID(
    0x958DB99A, 0xBE2A, 0x4F09, 0xAF, 0x7D, 0x65, 0x18, 0x98, 0x03, 0xD1, 0xD3
)


class IDWriteFactory5(
    IDWriteFactory4,
    IDWriteFactory3,
    IDWriteFactory2,
    IDWriteFactory1,
    ...
    _methods_ = [
        ("CreateFontSetBuilder5", com.STDMETHOD(POINTER(IDWriteFontSetBuilder1))),
        (
            "CreateInMemoryFontFileLoader",
            com.STDMETHOD(POINTER(IDWriteInMemoryFontFileLoader)),
        ),
        ("CreateHttpFontFileLoader", com.STDMETHOD()),
        ("AnalyzeContainerType", com.STDMETHOD()),
        ("UnpackFontFile", com.STDMETHOD()),
    ]


ID_IDWriteFactory6 = com.GUID(
    0xF3744D80, 0x21F7, 0x42EB, 0xB3, 0x5D, 0x99, 0x5B, 0xC7, 0x2F, 0xC2, 0x23
)


class IDWriteFactory6(
    IDWriteFactory5,
    IDWriteFactory4,
    IDWriteFactory3,
    IDWriteFactory2,
    ...
    _methods_ = [
        ("CreateFontFaceReference6", com.STDMETHOD()),
        ("CreateFontResource", com.STDMETHOD()),
        ("GetSystemFontSet6", com.STDMETHOD()),
        ("GetSystemFontCollection6", com.STDMETHOD()),
        ("CreateFontCollectionFromFontSet6", com.STDMETHOD()),
        ("CreateFontSetBuilder6", com.STDMETHOD()),
        ("CreateTextFormat6", com.STDMETHOD()),
    ]


class IDWriteFactory7(
    IDWriteFactory6,
    IDWriteFactory5,
    IDWriteFactory4,
    IDWriteFactory3,
    ...
    _methods_ = [
        ("GetSystemFontSet7", com.STDMETHOD()),
        ("GetSystemFontCollection7", com.STDMETHOD()),
    ]


IID_IDWriteFactory7 = com.GUID(
...
class Run:
    ...
    def ContainsTextPosition(self, textPosition: int) -> bool:
        return (
            textPosition >= self.text_start
            and textPosition < self.text_start + self.text_length
        )
...
class TextAnalysis(com.COMObject):
    ...
    def GenerateResults(
        self, analyzer: IDWriteTextAnalyzer, text: c_wchar_p, text_length: int
    ) -> None:
        self._text = text
        self._textstart = 0
    ...
    def SetScriptAnalysis(
        self,
        textPosition: UINT32,
        textLength: UINT32,
        scriptAnalysis: POINTER(DWRITE_SCRIPT_ANALYSIS),
    ) -> int:
    ...
    def GetTextBeforePosition(
        self,
        textPosition: UINT32,
        textString: POINTER(POINTER(WCHAR)),
        textLength: POINTER(UINT32),
    ) -> NoReturn:
        msg = "Currently not implemented."
        raise Exception(msg)

    def GetTextAtPosition(
        self, textPosition: UINT32, textString: c_wchar_p, textLength: POINTER(UINT32)
    ) -> int:
    ...
    def GetLocaleName(
        ...
        textPosition: UINT32,
        textLength: POINTER(UINT32),
        localeName: POINTER(POINTER(WCHAR)),
    ) -> int:
...
class MyFontFileStream(com.COMObject):
    ...
    def ReadFileFragment(
        self,
        fragmentStart: POINTER(c_void_p),
        fileOffset: UINT64,
        fragmentSize: UINT64,
        fragmentContext: POINTER(c_void_p),
    ) -> int:
...
class LegacyFontFileLoader(com.COMObject):
    ...
    def CreateStreamFromKey(
        self,
        fontfileReferenceKey: c_void_p,
        fontFileReferenceKeySize: UINT32,
        fontFileStream: POINTER(IDWriteFontFileStream),
    ) -> int:
        convert_index = cast(fontfileReferenceKey, POINTER(c_uint32))

        self._ptr = cast(
            self._streams[convert_index.contents.value].as_interface(
...
class MyEnumerator(com.COMObject):
    ...
    def MoveNext(self, hasCurrentFile: BOOL) -> None:
        ...
        if self.current_index != len(self._font_data):
            ...
            self._file_loader.SetCurrentFont(
                self.current_index, self._font_data[self.current_index]
            )
...
class LegacyCollectionLoader(com.COMObject):
    ...
    def CreateEnumeratorFromKey(
        ...
        self._ptr = cast(
            self._enumerator.as_interface(IDWriteFontFileEnumerator),
