...
class ID2D1Resource(com.pIUnknown):
    _methods_ = [
        ("GetFactory", com.STDMETHOD()),
    ]


class ID2D1Brush(ID2D1Resource):
    _methods_ = [
        ("SetOpacity", com.STDMETHOD()),
        ("SetTransform", com.STDMETHOD()),
        ("GetOpacity", com.STDMETHOD()),
        ("GetTransform", com.STDMETHOD()),
    ]


class ID2D1SolidColorBrush(ID2D1Brush):
    _methods_ = [
        ("SetColor", com.METHOD(None, POINTER(D2D1_COLOR_F))),
        ("GetColor", com.STDMETHOD()),
    ]
...
class ID2D1Bitmap(ID2D1Image):
    _methods_ = [
        ("GetSize", com.METHOD(D2D1_SIZE_F)),
        ("GetPixelSize", com.METHOD(D2D1_SIZE_U)),
        ("GetPixelFormat", com.METHOD(D2D1_PIXEL_FORMAT)),
        ("GetDpi", com.METHOD(c_void, POINTER(FLOAT), POINTER(FLOAT))),
        ("CopyFromBitmap", com.STDMETHOD()),
        ("CopyFromRenderTarget", com.STDMETHOD()),
        ("CopyFromMemory", com.STDMETHOD()),
    ]
...
class ID2D1Bitmap1(ID2D1Bitmap):
    _methods_ = [
        ...
        ("GetOptions", com.METHOD(D2D1_BITMAP_OPTIONS)),
        ("GetSurface", com.STDMETHOD()),
        ("Map", com.STDMETHOD(D2D1_MAP_OPTIONS, POINTER(D2D1_MAPPED_RECT))),
        ("Unmap", com.STDMETHOD()),
    ]
...
class ID2D1RenderTarget(ID2D1Resource):
    _methods_ = [
        ...
        (
            ...
            com.STDMETHOD(
                IWICBitmapSource, POINTER(D2D1_BITMAP_PROPERTIES), POINTER(ID2D1Bitmap)
            ),
        ),
        ("CreateSharedBitmap", com.STDMETHOD()),
        ("CreateBitmapBrush", com.STDMETHOD()),
        (
            "CreateSolidColorBrush",
            com.STDMETHOD(
                POINTER(D2D1_COLOR_F), c_void_p, POINTER(ID2D1SolidColorBrush)
            ),
        ),
        ("CreateGradientStopCollection", com.STDMETHOD()),
        ("CreateLinearGradientBrush", com.STDMETHOD()),
        ("CreateRadialGradientBrush", com.STDMETHOD()),
        ("CreateCompatibleRenderTarget", com.STDMETHOD()),
        ("CreateLayer", com.STDMETHOD()),
        ("CreateMesh", com.STDMETHOD()),
        ("DrawLine", com.STDMETHOD()),
        ("DrawRectangle", com.STDMETHOD()),
        ("FillRectangle", com.STDMETHOD()),
        ("DrawRoundedRectangle", com.STDMETHOD()),
        ("FillRoundedRectangle", com.STDMETHOD()),
        ("DrawEllipse", com.STDMETHOD()),
        ("FillEllipse", com.STDMETHOD()),
        ("DrawGeometry", com.STDMETHOD()),
        ("FillGeometry", com.STDMETHOD()),
        ("FillMesh", com.STDMETHOD()),
        (
            "FillOpacityMask",
            com.METHOD(
                None,
        ...
        (
            "DrawGlyphRun",
            com.METHOD(
                c_void, D2D_POINT_2F, POINTER(DWRITE_GLYPH_RUN), ID2D1Brush, UINT32
            ),
        ),
        ("SetTransform", com.METHOD(c_void)),
        ("GetTransform", com.STDMETHOD()),
        ("SetAntialiasMode", com.METHOD(c_void, D2D1_TEXT_ANTIALIAS_MODE)),
        ("GetAntialiasMode", com.STDMETHOD()),
        ("SetTextAntialiasMode", com.METHOD(c_void, D2D1_TEXT_ANTIALIAS_MODE)),
        ("GetTextAntialiasMode", com.STDMETHOD()),
        ("SetTextRenderingParams", com.STDMETHOD()),
        ("GetTextRenderingParams", com.STDMETHOD()),
        ("SetTags", com.STDMETHOD()),
        ("GetTags", com.STDMETHOD()),
        ("PushLayer", com.STDMETHOD()),
        ("PopLayer", com.STDMETHOD()),
        ("Flush", com.STDMETHOD(POINTER(D2D1_TAG), POINTER(D2D1_TAG))),
        ("SaveDrawingState", com.STDMETHOD()),
        ("RestoreDrawingState", com.STDMETHOD()),
        ("PushAxisAlignedClip", com.STDMETHOD()),
        ("PopAxisAlignedClip", com.STDMETHOD()),
        ("Clear", com.METHOD(c_void, POINTER(D2D1_COLOR_F))),
        ("BeginDraw", com.METHOD(c_void)),
        ("EndDraw", com.STDMETHOD(POINTER(D2D1_TAG), POINTER(D2D1_TAG))),
        ("GetPixelFormat", com.STDMETHOD()),
        ("SetDpi", com.STDMETHOD(FLOAT, FLOAT)),
        ("GetDpi", com.STDMETHOD()),
        ("GetSize", com.STDMETHOD()),
        ("GetPixelSize", com.STDMETHOD()),
        ("GetMaximumBitmapSize", com.STDMETHOD()),
        ("IsSupported", com.METHOD(BOOL, POINTER(D2D1_RENDER_TARGET_PROPERTIES))),
    ]
    ...
    _methods_ = [
        (
            ...
            com.STDMETHOD(
                ...
                c_void_p,
                UINT32,
                POINTER(D2D1_BITMAP_PROPERTIES1),
                POINTER(ID2D1Bitmap1),
            ),
        ),
        (
        ...
        ("CreateColorContextFromFilename", com.STDMETHOD()),
        ("CreateColorContextFromWicColorContext", com.STDMETHOD()),
        (
            "CreateBitmapFromDxgiSurface",
            com.STDMETHOD(
                IDXGISurface, POINTER(D2D1_BITMAP_PROPERTIES1), POINTER(ID2D1Bitmap1)
            ),
        ),
        ("CreateEffect", com.STDMETHOD()),
        ("CreateGradientStopCollection_Context", com.STDMETHOD()),
        ("CreateImageBrush", com.STDMETHOD()),
        ("CreateBitmapBrush_Context", com.STDMETHOD()),
        ("CreateCommandList", com.STDMETHOD()),
        ("IsDxgiFormatSupported", com.STDMETHOD()),
        ("IsBufferPrecisionSupported", com.STDMETHOD()),
        ("GetImageLocalBounds", com.STDMETHOD()),
        ("GetImageWorldBounds", com.STDMETHOD()),
        ("GetGlyphRunWorldBounds", com.STDMETHOD()),
        ("GetDevice", com.STDMETHOD()),
        ("SetTarget", com.STDMETHOD(c_void_p)),
        ("GetTarget", com.METHOD(c_void, POINTER(c_void_p))),
        ("SetRenderingControls", com.STDMETHOD()),
        ("GetRenderingControls", com.STDMETHOD()),
        ("SetPrimitiveBlend", com.STDMETHOD()),
        ("GetPrimitiveBlend", com.STDMETHOD()),
        ("SetUnitMode", com.STDMETHOD()),
        ("GetUnitMode", com.STDMETHOD()),
        (
        ...
        ("DrawImage", com.STDMETHOD()),
        ("DrawGdiMetafile", com.STDMETHOD()),
        ("DrawBitmap_Context", com.STDMETHOD()),
        ("PushLayer_Context", com.STDMETHOD()),
        ("InvalidateEffectInputRectangle", com.STDMETHOD()),
        ("GetEffectInvalidRectangleCount", com.STDMETHOD()),
        ("GetEffectInvalidRectangles", com.STDMETHOD()),
        ("GetEffectRequiredInputRectangles", com.STDMETHOD()),
        (
...
class ID2D1DeviceContext1(ID2D1DeviceContext):
    _methods_ = [
        ("CreateFilledGeometryRealization", com.STDMETHOD()),
        ("CreateStrokedGeometryRealization", com.STDMETHOD()),
        ("DrawGeometryRealization", com.STDMETHOD()),
    ]


class ID2D1DeviceContext2(ID2D1DeviceContext1):
    _methods_ = [
        ("CreateInk", com.STDMETHOD()),
        ("CreateInkStyle", com.STDMETHOD()),
        ("CreateGradientMesh", com.STDMETHOD()),
        ("CreateImageSourceFromWic", com.STDMETHOD()),
        ("CreateLookupTable3D", com.STDMETHOD()),
        ("CreateImageSourceFromDxgi", com.STDMETHOD()),
        ("GetGradientMeshWorldBounds", com.STDMETHOD()),
        ("DrawInk", com.STDMETHOD()),
        ("DrawGradientMesh", com.STDMETHOD()),
        ("DrawGdiMetafile2", com.STDMETHOD()),
        ("CreateTransformedImageSource", com.STDMETHOD()),
    ]


class ID2D1DeviceContext3(ID2D1DeviceContext2):
    _methods_ = [
        ("CreateSpriteBatch", com.STDMETHOD()),
        ("DrawSpriteBatch", com.STDMETHOD()),
    ]
...
class ID2D1DeviceContext4(ID2D1DeviceContext3):
    _methods_ = [
        ("CreateSvgGlyphStyle", com.STDMETHOD()),
        (
            "DrawText4",
            com.STDMETHOD(
                c_wchar_p,
        ...
        ("GetColorBitmapGlyphImage", com.STDMETHOD()),
        ("GetSvgGlyphImage", com.STDMETHOD()),
    ]
...
class ID2D1Device(ID2D1Resource):
    _methods_ = [
        (
            "CreateDeviceContext",
            com.STDMETHOD(D2D1_DEVICE_CONTEXT_OPTIONS, POINTER(ID2D1DeviceContext)),
        ),
...
class ID2D1Device1(ID2D1Device):
    _methods_ = [
        ...
        (
            ...
            com.STDMETHOD(D2D1_DEVICE_CONTEXT_OPTIONS, POINTER(ID2D1DeviceContext1)),
        ),
    ]
...
class ID2D1Device4(ID2D1Device3):
    _methods_ = [
        (
            "CreateDeviceContext4",
            com.STDMETHOD(D2D1_DEVICE_CONTEXT_OPTIONS, POINTER(ID2D1DeviceContext4)),
        ),
...
class ID2D1Factory(com.pIUnknown):
    _methods_ = [
        ("ReloadSystemMetrics", com.STDMETHOD()),
        ("GetDesktopDpi", com.STDMETHOD()),
        ("CreateRectangleGeometry", com.STDMETHOD()),
        ("CreateRoundedRectangleGeometry", com.STDMETHOD()),
        ("CreateEllipseGeometry", com.STDMETHOD()),
        ("CreateGeometryGroup", com.STDMETHOD()),
        ("CreateTransformedGeometry", com.STDMETHOD()),
        ("CreatePathGeometry", com.STDMETHOD()),
        ("CreateStrokeStyle", com.STDMETHOD()),
        ("CreateDrawingStateBlock", com.STDMETHOD()),
        (
            "CreateWicBitmapRenderTarget",
            com.STDMETHOD(
                IWICBitmap,
                POINTER(D2D1_RENDER_TARGET_PROPERTIES),
                POINTER(ID2D1RenderTarget),
            ),
        ),
        ("CreateHwndRenderTarget", com.STDMETHOD()),
        ("CreateDxgiSurfaceRenderTarget", com.STDMETHOD()),
        ("CreateDCRenderTarget", com.STDMETHOD()),
    ]
...
class ID2D1Factory5(ID2D1Factory4):
    _methods_ = [
        ("CreateDevice5", com.STDMETHOD(c_void_p, POINTER(ID2D1Device4))),
    ]


IID_ID2D1Factory = com.GUID(
    0x06152247, 0x6F50, 0x465A, 0x92, 0x45, 0x11, 0x8B, 0xFD, 0x3B, 0x60, 0x07
)
IID_ID2D1Factory1 = com.GUID(
...
IID_ID2D1DeviceContext = com.GUID(
