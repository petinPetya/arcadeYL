...
class UIManager(EventDispatcher):
        ...
        for layer in layers:
            ...
            for child in self.children[layer]:
                ...
                if child.size_hint:
                    ...
                    child.rect = child.rect.resize(
                        nw, nh, anchor=AnchorPoint.BOTTOM_LEFT
                    )
                ...
                if child.size_hint_max:
                    ...
                    child.rect = child.rect.max_size(
                        shm_w or child.width,
                        shm_h or child.height,
    ...
    def on_mouse_motion(self, x: int, y: int, dx: int, dy: int):
        ...
        return self.dispatch_ui_event(
            UIMouseMovementEvent(self, round(x_), round(y_), dx, dy)
        )
    ...
    def on_button_release(self, controller: Controller, button: str):
        return self.dispatch_ui_event(
            UIControllerButtonReleaseEvent(controller, button)
        )
