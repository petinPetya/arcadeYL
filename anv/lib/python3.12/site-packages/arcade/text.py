...
class Text:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if align not in ("left", "center", "right"):
            raise ValueError(
                "The 'align' parameter must be equal to 'left', 'right', or 'center'."
            )
    ...
    def bold(self, bold: bool | str):
        self.label.weight = (
            pyglet.text.Weight.BOLD if bold else pyglet.text.Weight.NORMAL
        )
    ...
    def draw_debug(
        ...
        arcade.draw_lrbt_rectangle_filled(
            left, right, bottom, top, color=background_color
        )

        # Draw outline
        arcade.draw_lrbt_rectangle_outline(
            left, right, bottom, top, color=outline_color
        )
