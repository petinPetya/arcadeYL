...
class RenderIndirect(arcade.Window):
    ...
    def __init__(self):
        super().__init__(
            WINDOW_WIDTH, WINDOW_HEIGHT, "Render Indirect", gl_version=(4, 3)
        )
        ...
        self.draw_command_array_buffer = self.ctx.buffer(
            data=array("I", array_draw_commands)
        )
        self.draw_command_indexed_buffer = self.ctx.buffer(
            data=array("I", indexed_draw_commands)
        )
