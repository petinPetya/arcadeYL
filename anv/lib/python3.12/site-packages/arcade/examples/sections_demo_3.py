...
class InfoBar(Section):
    ...
    def on_draw(self):
        # draw game info
        arcade.draw_lrbt_rectangle_filled(
            self.left, self.right, self.bottom, self.top, COLOR_DARK
        )
        arcade.draw_lrbt_rectangle_outline(
...
class GameView(arcade.View):
    ...
    def __init__(self):
        ...
        self.map = Map(
            0, 0, self.window.width - PANEL_WIDTH, self.window.height - INFO_BAR_HEIGHT
        )
