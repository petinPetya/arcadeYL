...
class LayoutView(arcade.gui.UIView):
    ...
    def __init__(self):
        ...
        text_area.with_background(
            color=arcade.uicolor.DARK_BLUE_MIDNIGHT_BLUE.replace(a=125)
        )
        ...
        self.anchor.add(
            self.grid, anchor_x="left", anchor_y="top", align_x=10, align_y=-10
        )
        self.grid.add(
        ...
        def _(event):
            self.anchor.remove(self.grid)
            self.anchor.add(
                self.grid, anchor_x="right", anchor_y="top", align_x=-10, align_y=-10
            )
