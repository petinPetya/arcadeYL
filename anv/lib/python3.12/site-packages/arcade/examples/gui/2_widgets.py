...
TEX_SCROLL_DOWN = arcade.load_texture(
    ":resources:gui_basic_assets/scroll/indicator_down.png"
)
TEX_SCROLL_UP = arcade.load_texture(
    ":resources:gui_basic_assets/scroll/indicator_up.png"
)
...
TEX_RED_BUTTON_DISABLE = arcade.load_texture(
...
TEX_CHECKBOX_CHECKED = arcade.load_texture(
    ":resources:gui_basic_assets/checkbox/blue_check.png"
)
TEX_CHECKBOX_UNCHECKED = arcade.load_texture(
    ":resources:gui_basic_assets/checkbox/empty.png"
)

TEX_SLIDER_THUMB_BLUE = arcade.load_texture(
    ":resources:gui_basic_assets/slider/thumb_blue.png"
)
TEX_SLIDER_TRACK_BLUE = arcade.load_texture(
    ":resources:gui_basic_assets/slider/track_blue.png"
)
TEX_SLIDER_THUMB_RED = arcade.load_texture(
    ":resources:gui_basic_assets/slider/thumb_red.png"
)
TEX_SLIDER_TRACK_RED = arcade.load_texture(
    ":resources:gui_basic_assets/slider/track_red.png"
)
TEX_SLIDER_THUMB_GREEN = arcade.load_texture(
    ":resources:gui_basic_assets/slider/thumb_green.png"
)
TEX_SLIDER_TRACK_GREEN = arcade.load_texture(
    ":resources:gui_basic_assets/slider/track_green.png"
)

TEX_NINEPATCH_BASE = arcade.load_texture(
...
class GalleryView(UIView):
    def __init__(self):
        ...
        nav_side.add(
            UISpace(size_hint=(1, 0.01), color=arcade.uicolor.DARK_BLUE_MIDNIGHT_BLUE)
        )
        ...
        nav_side.add_button(
            "Interactive", style=UIFlatButton.STYLE_BLUE, size_hint=(1, 0.1)
        )
        nav_side.add_button(
            "Constructs", style=UIFlatButton.STYLE_BLUE, size_hint=(1, 0.1)
        )
    ...
    def _show_interactive_widgets(self):
        ...
        flat_row.add(
            UIFlatButton(
                text="disabled", style=UIFlatButton.STYLE_BLUE, size_hint=(0.3, 1)
            )
        ).disabled = True
        ...
        dropdown_row.add(
            UILabel(
                "UIDropdown", font_name=DETAILS_FONT, font_size=16, size_hint=(0.3, 0)
            )
        )
        dropdown_row.add(
            UIDropdown(
        ...
        s1 = slider_row.add(
            UISlider(size_hint=(0.3, 1), step=1, style=UISlider.NO_STEP_STYLE)
        )
        s2 = slider_row.add(
            UISlider(
                size_hint=(0.3, 1),
    ...
    def _show_construct_widgets(self):
        ...
        buttons.add_button(
            "Red Style", style=UIFlatButton.STYLE_RED, size_hint=(1, None)
        )
        buttons.add_button(
            "Blue Style", style=UIFlatButton.STYLE_BLUE, size_hint=(1, None)
        )
    ...
    def _show_other_widgets(self):
        ...
        sprite_row.add(
            UISpriteWidget(sprite=sprite, width=sprite.width, height=sprite.height)
        )
