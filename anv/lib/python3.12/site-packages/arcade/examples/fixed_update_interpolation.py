...
class GameView(arcade.View):
    ...
    def __init__(self):
        super().__init__()
        self.unfixed_sprite = arcade.SpriteCircle(
            CIRCLE_RADIUS, arcade.color.RADICAL_RED
        )
        self.interpolated_sprite = arcade.SpriteCircle(
            CIRCLE_RADIUS, arcade.color.ORANGE
        )
        ...
        self.sprites.extend(
            (self.unfixed_sprite, self.fixed_sprite, self.interpolated_sprite)
        )
    ...
    def setup(self):
        ...
        self.interpolated_sprite.position = (
            2.0 * WINDOW_WIDTH / 4.0,
            WINDOW_HEIGHT / 2.0,
        )
