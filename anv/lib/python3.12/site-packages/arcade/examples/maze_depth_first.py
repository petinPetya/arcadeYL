...
WINDOW_WIDTH = 1000
WINDOW_HEIGHT = 700
WINDOW_TITLE = "Maze Depth First Example"
...
# he camera we use a constraint to move the camera
...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(
            output, left + 20, WINDOW_HEIGHT - 20 + bottom, arcade.color.WHITE, 16
        )

        output = f"Drawing time: {self.draw_time:.3f}"
        arcade.draw_text(
            output, left + 20, WINDOW_HEIGHT - 40 + bottom, arcade.color.WHITE, 16
        )

        output = f"Processing time: {self.processing_time:.3f}"
        arcade.draw_text(
            output, left + 20, WINDOW_HEIGHT - 60 + bottom, arcade.color.WHITE, 16
        )
