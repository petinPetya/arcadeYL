...
def create_grids(
    cell_size: tuple[int, int] = (CELL_WIDTH, CELL_HEIGHT),
...
class GameView(arcade.View):
    ...
    def __init__(self):
        ...
        self.layers_grid_sprites_one_dim = [
            grid_sprites_one_dim1,
            grid_sprites_one_dim2,
        ]
        self.layers_grid_sprites_two_dim = [
            grid_sprites_two_dim1,
            grid_sprites_two_dim2,
        ]
    ...
    def on_update(self, delta_time: float):
        ...
        for row in range(ROW_COUNT):
            for column in range(COLUMN_COUNT):
                ...
                if l1_sprite.alpha == ALPHA_ON and (
