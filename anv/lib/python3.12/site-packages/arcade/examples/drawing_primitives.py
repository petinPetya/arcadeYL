...
arcade.draw_rect_outline(
    arcade.rect.XYWH(295, 160, 20, 45), arcade.color.BRITISH_RACING_GREEN, 3, 45
)
...
arcade.draw_texture_rect(
    texture, arcade.XYWH(540, 120, texture.width, texture.height).scale(scale)
)
arcade.draw_texture_rect(
    texture,
    arcade.XYWH(540, 60, texture.width, texture.height).scale(scale),
    angle=45,
)
