...
def _wiggle_until_free(
    colliding: Sprite, walls: Iterable[SpriteSequence[BasicSprite]]
) -> None:
...
class PhysicsEngineSimple:
    ...
    * You don't need anything else
    ...
    def __init__(
        ...
        walls: (
            SpriteSequence[BasicSprite] | Iterable[SpriteSequence[BasicSprite]] | None
        ) = None,
    ) -> None:
...
class PhysicsEnginePlatformer:
    ...
    def __init__(
        ...
        player_sprite: Sprite,
        platforms: (
            SpriteSequence[Sprite] | Iterable[SpriteSequence[Sprite]] | None
        ) = None,
    ...
    def can_jump(self, y_distance: float = 5) -> bool:
        ...
        hit_list = check_for_collision_with_lists(
            self.player_sprite, self._all_obstacles
        )
        self.player_sprite.center_y += y_distance
