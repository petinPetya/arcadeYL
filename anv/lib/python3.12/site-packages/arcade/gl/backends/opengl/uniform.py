...
class Uniform:
    ...
    _uniform_setters = {
        ...
        gl.GL_INT64_ARB: (
            gl.GLint64,
            gl.glProgramUniform1i64vARB,
            gl.glUniform1i64vARB,
            1,
            1,
        ),
        gl.GL_INT64_VEC2_ARB: (
            gl.GLint64,
            gl.glProgramUniform2i64vARB,
            gl.glUniform2i64vARB,
            2,
            1,
        ),
        gl.GL_INT64_VEC3_ARB: (
            gl.GLint64,
            gl.glProgramUniform3i64vARB,
            gl.glUniform3i64vARB,
            3,
            1,
        ),
        gl.GL_INT64_VEC4_ARB: (
            gl.GLint64,
            gl.glProgramUniform4i64vARB,
            gl.glUniform4i64vARB,
            4,
            1,
        ),
    ...
    def _setup_getters_and_setters(self):
        ...
        try:
            gl_type, gl_program_setter, gl_setter, length, count = (
                self._uniform_setters[self._data_type]
            )
            ...
            if ctx._ext_separate_shader_objects_enabled:
                ...
                def setter_func(value):  # type: ignore #conditional function variants must have identical signature
                    ...
                    try:
                        ...
                        c_array[:] = value
                    gl_program_setter(
                        program_id, location, array_length, gl.GL_FALSE, ptr
                    )
