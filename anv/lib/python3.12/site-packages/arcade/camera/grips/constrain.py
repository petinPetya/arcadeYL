...
def constrain_boundary_x(
    data: CameraData, left: float, right: float, target_x: float
) -> Point3:
    """
...
def constrain_boundary_y(
    data: CameraData, bottom: float, top: float, target_y: float
) -> Point3:
    """
...
def constrain_boundary_z(
    data: CameraData, left: float, right: float, target_z: float
) -> Point3:
    """
