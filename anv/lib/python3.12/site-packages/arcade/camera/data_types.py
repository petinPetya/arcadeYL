...
class CameraData:
    ...
    def __str__(self):
        return (
            f"CameraData<{self.position=}, {self.up=}, {self.forward=}, {self.zoom=}>"
        )
...
class OrthographicProjectionData:
    ...
    def __str__(self):
        return (
            f"OrthographicProjection<LRBT={self.rect.lrbt}, {self.near=}, {self.far=}>"
        )
...
def orthographic_from_rect(
    rect: Rect, near: float, far: float
) -> OrthographicProjectionData:
    """
