...
class Shape:
    ...
    def __init__(
        ...
        self.data = array(
            "f", [c for a in zip(self.points, self.colors) for b in a for c in b]
        )
...
def create_line_strip(
    point_list: PointList, color: RGBA255, line_width: float = 1
) -> Shape:
    """
    ...
    return create_triangles_strip_filled_with_colors(
...
def create_rectangle(
    ...
    if filled:
        ...
        if tilt_angle != 0:
            ...
            for point in data:
                new_point = rotate_point(
                    point[0], point[1], center_x, center_y, tilt_angle
                )
...
def create_rectangles_filled_with_colors(
    point_list, color_list: Sequence[RGBA255]
) -> Shape:
    """
