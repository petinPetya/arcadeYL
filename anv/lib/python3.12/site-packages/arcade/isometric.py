...
def isometric_grid_to_screen(
    ...
    """
    screen_x = (
        tile_width * tile_x // 2 + height * tile_width // 2 - tile_y * tile_width // 2
    )
    screen_y = (
...
def screen_to_isometric_grid(
    ...
    """
    x2 = (
        1 / tile_width * screen_x / 2 - 1 / tile_height * screen_y / 2 + width / 2
    ) * 2 - (width / 2 + 0.5)
    y2 = (height - 1) - (
        (1 / tile_width * screen_x / 2 + 1 / tile_height * screen_y / 2) * 2
        - (width / 2 + 0.5)
    )
    x2 = round(x2)
    y2 = round(y2)
