...
class Section:
    ...
    def __init__(
        ...
        *,
        ...
        self.prevent_dispatch: Iterable = (
            {True} if prevent_dispatch is None else prevent_dispatch
        )
...
class SectionManager:
    ...
    def enable(self) -> None:
        ...
        section_handlers = {
            ...
            for event_type in self.managed_events
        }
        if section_handlers:
    ...
    def add_section(
        ...
        if at_draw_order is None:
            ...
            section._draw_order = (
                at_draw_order  # this will trigger self.sort_section_draw_order
            )
            self.sort_sections_draw_order()
        ...
        **kwargs,
        ...
        for section in sections:
            ...
            if mouse_events_allowed is False:
                continue
            if (
                mouse_events_allowed is True or event in mouse_events_allowed
            ):  # event allowed
                ...
                if method:
                    ...
                    prevent_dispatch = (
                        EVENT_HANDLED if section.modal else prevent_dispatch
                    )
    ...
    def dispatch_mouse_enter_leave_events(
        ...
        prevent_dispatch_origin = (
            EVENT_UNHANDLED  # prevent dispatch for the origin mouse event
        )
    ...
    def on_mouse_motion(self, x: int, y: int, *args, **kwargs) -> bool | None:
        ...
        Returns:
            ``EVENT_HANDLED`` or ``EVENT_UNHANDLED``, or whatever the dispatched method returns
        """
        return self.dispatch_mouse_enter_leave_events(
            "on_mouse_motion", x, y, *args, **kwargs
        )
