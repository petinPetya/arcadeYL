...
class ShadertoyBase:
    ...
    def render(
        ...
        *,
        ...
        self._mouse_pos = (
            mouse_position if mouse_position is not None else self._mouse_pos
        )
    ...
    def _set_uniforms(self):
        ...
        self._program.set_uniform_safe(
            "iMouse", (*self._mouse_pos, *self._mouse_buttons)
        )
        self._program.set_uniform_safe("iResolution", (*self._size, 1.0))
        self._program.set_uniform_array_safe(
            "iChannelResolution", self._channel_resolution
        )
